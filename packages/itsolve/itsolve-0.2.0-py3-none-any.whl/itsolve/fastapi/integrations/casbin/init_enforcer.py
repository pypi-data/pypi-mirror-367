...
from settings.permissions_settings import PermissionsSettings
...
def sync_init_enforcer(settings_dict: dict) -> Enforcer:
    settings = PermissionsSettings.model_validate(settings_dict)
