...
from core.observability import setting_otlp
...
class AppBuilder:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        self.enforcer: Resource[Enforcer] | None = None
    ...
    def collect_routers(self) -> AppBuilder:
        ...
        for file in routers:
            ...
            if "router" in module.__dict__:
                ...
                self.app.include_router(
                    router, prefix=self.settings.server.prefix
                )
        logger.info(
            "Routers collected",
    ...
    def configure_enforcer(self, enforcer: Resource[Enforcer]) -> AppBuilder:
    ...
    async def lifespan(self, _: FastAPI) -> AsyncGenerator[None]:  # noqa: ARG001
        ...
        if self.enforcer and self.settings.permissions.enabled:
            self.enforcer.init()
