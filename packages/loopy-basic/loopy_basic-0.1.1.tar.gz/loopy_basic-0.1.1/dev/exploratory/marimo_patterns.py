...
# PATTERN 2: Single Cell with Connection Management
@app.cell
...
def connection_state():
    ...
    return ConnectionState, conn_state
...
# PATTERN 4: Error-Safe Data Fetching Function
@app.cell
...
@app.cell
def use_safe_fetcher(fetch_cgm_data, datetime, timedelta):
    ...
    return df_custom, df_day, df_week
