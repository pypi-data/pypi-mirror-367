...
class VRINClient:
    ...
    def __init__(self, api_key: str, base_url: str = "https://v6kkzi6x1b.execute-api.us-east-1.amazonaws.com/dev"):
        """
        Initialize the VRIN client.
        
        Args:
            api_key: Your VRIN API key
            base_url: Base URL for the VRIN API (defaults to production)
        """
    ...
    def insert(self, 
        ...
        try:
            response = self.session.post(f"{self.base_url}/job", json=payload)
    ...
    def query(self, 
              ...
              user_id: Optional[str] = None,
              max_results: int = 10,
              search_type: str = "hybrid") -> List[QueryResult]:
        """
    ...
    def insert_text(self, text: str, user_id: Optional[str] = None) -> JobStatus:
        """
