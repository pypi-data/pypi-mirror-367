...
import pyconverters_newsml


# -- Project information -----------------------------------------------------

project = "pyconverters_newsml"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_newsml.__version__
release = pyconverters_newsml.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_newsml.__file__)
