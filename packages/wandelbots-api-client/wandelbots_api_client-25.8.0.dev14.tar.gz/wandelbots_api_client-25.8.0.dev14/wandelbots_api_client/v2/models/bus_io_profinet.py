...
class BusIOProfinet(BaseModel):
    ...
    config_file_content: Optional[StrictStr] = Field(default=None, description="Path to the configuration file.")
    network_config: Optional[BusIOProfinetNetwork] = None
    mac: StrictStr = Field(description="MAC address for the PROFINET port, should be get from another NOVA API endpoind?")
