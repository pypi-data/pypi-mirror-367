...
def translate_batch(
    ...
    if fallback_provider and fallback_provider != provider:
        print(
            f"⚠️ Primary provider '{provider}' returned incorrect size. Trying fallback provider '{fallback_provider}'"
        )
        ...
        if _is_response_valid(fallback_translation_array, expected_length):
            ...
            return fallback_translation_array
        else:
            print(
    ...
    return _handle_invalid_response(translation_array, expected_length)
