...
def get_all_template_images_and_vms_stats(org: dict, edge: dict, edge_stats: dict, verbose: bool):
    ...
    for template_stats in all_template_stats:
        ...
        ) or ("all_vms_on_valid_agent_version" in template_stats.keys() and template_stats.get("all_vms_on_valid_agent_version") == False):
...
def get_edge_stats(edge: dict, verbose: bool):
    ...
    edge_migrated = False
    if (
        (edge_fqdn_auto_generated == False or (edge_fqdn_auto_generated == True and edge_mqtt_url and ".omnissa." in edge_mqtt_url))
    ...
    while True:
        ...
        for vm in vms:
            ...
            if (
                ...
                and (
                    ("edge_fqdn_auto_generated" in template_stats and template_stats["edge_fqdn_auto_generated"] == False)
