...
class TestBagManager:
    ...
    def test_get_topic_summary(self, demo_bag_path):
        ...
        bag = manager.bags[demo_bag_path]
        for topic_name in bag.info.get_topic_names():
            assert topic_name in summary
            assert summary[topic_name] == 1  # Single bag, each topic appears once
    ...
    def test_bag_info_integrity(self, demo_bag_path):
        ...
        # Verify topics are TopicInfo objects with valid names
