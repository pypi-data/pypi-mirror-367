...
def get_labels(
    ...
    """
    return registry.call_handler(get_labels.__name__, cursor, page_size)
...
def get_inventory(
    ...
    """
    return registry.call_handler(get_inventory.__name__, cursor, page_size)
...
def push_inventory_of_type(
    ...
    return registry.call_handler(
        push_inventory_of_type.__name__, id, asset_type, revision, reporter, body
    )
...
def get_asset_id(body: LookupRequest) -> InventoryItem:
    ...
    """
    return registry.call_handler(get_asset_id.__name__, body)
...
def get_network_topology(
    ...
    """
    return registry.call_handler(get_network_topology.__name__, cursor, page_size)
