...
class CustomJsonFormatter(JsonFormatter):
    ...
    def add_fields(
        ...
        log_record["service.version"] = get_environment_metadata().version
        log_record["deployment.environment"] = get_environment_metadata().environment
        log_record["service.name"] = f"{get_environment_metadata().product_id}" + (
