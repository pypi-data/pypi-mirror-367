...
import pyprocessors_tag2segment


# -- Project information -----------------------------------------------------

project = "pyprocessors_tag2segment"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_tag2segment.__version__
release = pyprocessors_tag2segment.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_tag2segment.__file__)
