...
__version__ = (0, 0, 3)
__all__ = [
    "headers_get", "get_filename", "get_charset", "get_content_length", 
    "get_length", "get_total_length", "get_range", "is_chunked", 
    "is_range_request", 
]
...
CRE_CHARSET_search = re_compile(r"\bcharset=(?P<charset>[^ ;]+)", IGNORECASE).search
