...
The latest released version of :obj:`tabura` can be installed from `PyPI <https://pypi.org/project/tabura/>`_ using `pip`.

.. code-block:: console

   $ python3 -m pip install tabura
...
.. code-block:: console
   ...
   $ python3 -m pip install git+https://github.com/bernardodionisi/tabura.git

Or from a specific branch.

.. code-block:: console

   $ python3 -m pip install git+https://github.com/bernardodionisi/tabura.git@branch
...
fashion from a local folder. This allows any changes in the current directory to be immediately seen upon the next `import tabura`.

Clone the repo wherever you'd like.

.. code-block:: console

    $ git clone https://github.com/bernardodionisi/tabura.git

Install the local folder using the `-e` or `--editable` flag.

.. code-block:: console

    $ python3 -m pip install -e tabura/
...
.. code-block:: console
   ...
   $ python3 -m pip install tabura[dev]
