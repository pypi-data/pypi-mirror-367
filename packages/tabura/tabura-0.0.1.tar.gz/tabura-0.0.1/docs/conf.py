...
# confuses Sphinx when parsing overloaded functions. When not building the documentation, the @set_module("tabura")
...
html_title = "tabura"
# html_favicon = "../logo/tabura-favicon-color.png"
# html_logo = "../logo/tabura-favicon-white.png"
...
html_theme_options = {
    ...
    "site_url": "https://tabura.readthedocs.io/",  # todo: <---- no read the docs?
    "repo_url": "https://github.com/bernardodionisi/tabura",
    "repo_name": "bernardodionisi/tabura",
    "social": [
        {
            "icon": "fontawesome/brands/github",
            "link": "https://github.com/bernardodionisi/tabura",
        },
        {
            "icon": "fontawesome/brands/python",
            "link": "https://pypi.org/project/tabura/",
        },
    ],
    "edit_uri": "",
...
ipython_execlines = ["import tabura"]
...
#     member for member in dir(tabura.Array) if inspect.isdatadescriptor(getattr(type(tabura.Array), member, None))
# ]
# for p in ArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     ArrayMeta_property = getattr(tabura._domains._meta.ArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     delattr(tabura._domains._meta.ArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(tabura.Array, p, classproperty(ArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     setattr(tabura._domains._meta.ArrayMeta, p, ArrayMeta_property)
# 
# 
# FieldArrayMeta_properties = [
#     member
#     for member in dir(tabura.FieldArray)
#     if inspect.isdatadescriptor(getattr(type(tabura.FieldArray), member, None))
# ]
# for p in FieldArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         ArrayMeta_property = getattr(tabura._domains._meta.ArrayMeta, p)
#     FieldArrayMeta_property = getattr(tabura._fields._meta.FieldArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         delattr(tabura._domains._meta.ArrayMeta, p)
#     delattr(tabura._fields._meta.FieldArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(tabura.FieldArray, p, classproperty(FieldArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     if p in ArrayMeta_properties:
#         setattr(tabura._domains._meta.ArrayMeta, p, ArrayMeta_property)
#     setattr(tabura._fields._meta.FieldArrayMeta, p, FieldArrayMeta_property)
