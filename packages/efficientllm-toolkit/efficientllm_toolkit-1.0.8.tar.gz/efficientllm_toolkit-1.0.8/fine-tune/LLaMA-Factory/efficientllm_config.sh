...
# EfficientLLM Metrics Configuration for LLaMA-Factory
...
# Metrics logging interval (default: log every 10 steps)
export EFFICIENTLLM_LOG_INTERVAL=${EFFICIENTLLM_LOG_INTERVAL:-10}

echo "EfficientLLM Metrics Configuration for LLaMA-Factory:"
