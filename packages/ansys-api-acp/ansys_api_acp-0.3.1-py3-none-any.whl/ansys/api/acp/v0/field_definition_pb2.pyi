...
class Properties(google.protobuf.message.Message):
    ...
    FIELD_VARIABLE_NAME_FIELD_NUMBER: builtins.int
    SCOPE_ENTITIES_FIELD_NUMBER: builtins.int
    SCALAR_FIELD_FIELD_NUMBER: builtins.int
    FULL_MAPPING_FIELD_NUMBER: builtins.int
    status: ansys.api.acp.v0.enum_types_pb2.StatusType.ValueType = ...
    locked: builtins.bool = ...
    active: builtins.bool = ...
    field_variable_name: typing.Text = ...
    @property
    def scope_entities(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[ansys.api.acp.v0.base_pb2.ResourcePath]: ...
    @property
    def scalar_field(self) -> ansys.api.acp.v0.base_pb2.ResourcePath: ...
    full_mapping: builtins.bool = ...
    def __init__(self,
        *,
        status : ansys.api.acp.v0.enum_types_pb2.StatusType.ValueType = ...,
        locked : builtins.bool = ...,
        active : builtins.bool = ...,
        field_variable_name : typing.Text = ...,
        scope_entities : typing.Optional[typing.Iterable[ansys.api.acp.v0.base_pb2.ResourcePath]] = ...,
        scalar_field : typing.Optional[ansys.api.acp.v0.base_pb2.ResourcePath] = ...,
        full_mapping : builtins.bool = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["scalar_field",b"scalar_field"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["active",b"active","field_variable_name",b"field_variable_name","full_mapping",b"full_mapping","locked",b"locked","scalar_field",b"scalar_field","scope_entities",b"scope_entities","status",b"status"]) -> None: ...
