...
import ansys.api.acp.v0.lookup_table_column_type_pb2
...
class Properties(google.protobuf.message.Message):
    ...
    value_type: ansys.api.acp.v0.lookup_table_column_type_pb2.ValueType.ValueType = ...
    dimension_type: ansys.api.acp.v0.unit_system_pb2.DimensionType.ValueType = ...
    @property
    def data(self) -> ansys.api.acp.v0.array_types_pb2.DoubleArray: ...
    def __init__(self,
        *,
        value_type : ansys.api.acp.v0.lookup_table_column_type_pb2.ValueType.ValueType = ...,
        dimension_type : ansys.api.acp.v0.unit_system_pb2.DimensionType.ValueType = ...,
        data : typing.Optional[ansys.api.acp.v0.array_types_pb2.DoubleArray] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["data",b"data"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data",b"data","dimension_type",b"dimension_type","value_type",b"value_type"]) -> None: ...
