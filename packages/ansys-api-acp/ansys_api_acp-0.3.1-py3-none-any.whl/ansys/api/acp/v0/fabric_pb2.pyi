...
class Properties(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cut_off_material",b"cut_off_material","drop_off_material",b"drop_off_material","material",b"material"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["area_price",b"area_price","area_weight",b"area_weight","cut_off_material",b"cut_off_material","cut_off_material_handling",b"cut_off_material_handling","draping_material_model",b"draping_material_model","draping_ud_coefficient",b"draping_ud_coefficient","drop_off_material",b"drop_off_material","drop_off_material_handling",b"drop_off_material_handling","ignore_for_postprocessing",b"ignore_for_postprocessing","material",b"material","status",b"status","thickness",b"thickness"]) -> None: ...
