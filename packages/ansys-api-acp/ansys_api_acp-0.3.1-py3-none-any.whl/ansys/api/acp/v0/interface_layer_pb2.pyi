...
class Properties(google.protobuf.message.Message):
    ...
    OPEN_AREA_SETS_FIELD_NUMBER: builtins.int
    ...
    @property
    def open_area_sets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[ansys.api.acp.v0.base_pb2.ResourcePath]: ...
    def __init__(self,
        *,
        status : ansys.api.acp.v0.enum_types_pb2.StatusType.ValueType = ...,
        global_ply_nr : builtins.int = ...,
        ...
        open_area_sets : typing.Optional[typing.Iterable[ansys.api.acp.v0.base_pb2.ResourcePath]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["active",b"active","global_ply_nr",b"global_ply_nr","open_area_sets",b"open_area_sets","oriented_selection_sets",b"oriented_selection_sets","status",b"status"]) -> None: ...
