...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'ZHgithub.com/ansys/ansys-api-acp/ansys/api/acp/v0/spherical_selection_rule'
