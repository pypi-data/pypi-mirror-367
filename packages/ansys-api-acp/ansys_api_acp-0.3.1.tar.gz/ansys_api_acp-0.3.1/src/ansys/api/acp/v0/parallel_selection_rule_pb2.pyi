...
class Properties(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["direction",b"direction","include_rule_type",b"include_rule_type","lower_limit",b"lower_limit","origin",b"origin","relative_rule_type",b"relative_rule_type","rosette",b"rosette","status",b"status","upper_limit",b"upper_limit","use_global_coordinate_system",b"use_global_coordinate_system"]) -> None: ...
