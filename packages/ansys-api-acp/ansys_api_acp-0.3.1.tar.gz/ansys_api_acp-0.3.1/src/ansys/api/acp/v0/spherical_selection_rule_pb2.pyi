...
class Properties(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["origin",b"origin","rosette",b"rosette"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["include_rule_type",b"include_rule_type","origin",b"origin","radius",b"radius","relative_rule_type",b"relative_rule_type","rosette",b"rosette","status",b"status","use_global_coordinate_system",b"use_global_coordinate_system"]) -> None: ...
