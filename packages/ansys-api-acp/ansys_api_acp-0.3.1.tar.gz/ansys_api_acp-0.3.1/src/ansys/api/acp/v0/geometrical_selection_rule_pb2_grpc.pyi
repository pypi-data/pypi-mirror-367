...
import ansys.api.acp.v0.geometrical_selection_rule_pb2
import grpc
...
class ObjectServiceStub:
    ...
    List: grpc.UnaryUnaryMultiCallable[
        ...
        ansys.api.acp.v0.geometrical_selection_rule_pb2.ListReply] = ...

    Get: grpc.UnaryUnaryMultiCallable[
        ansys.api.acp.v0.base_pb2.GetRequest,
        ansys.api.acp.v0.geometrical_selection_rule_pb2.ObjectInfo] = ...
    ...
    Create: grpc.UnaryUnaryMultiCallable[
        ansys.api.acp.v0.geometrical_selection_rule_pb2.CreateRequest,
        ansys.api.acp.v0.geometrical_selection_rule_pb2.ObjectInfo] = ...
...
class ObjectServiceServicer(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def Put(self,
        request: ansys.api.acp.v0.geometrical_selection_rule_pb2.ObjectInfo,
        context: grpc.ServicerContext,
    ) -> ansys.api.acp.v0.geometrical_selection_rule_pb2.ObjectInfo: ...
    ...
    @abc.abstractmethod
    def Create(self,
        request: ansys.api.acp.v0.geometrical_selection_rule_pb2.CreateRequest,
        context: grpc.ServicerContext,
    ) -> ansys.api.acp.v0.geometrical_selection_rule_pb2.ObjectInfo: ...
