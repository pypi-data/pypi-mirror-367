...
class _OrientationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_OrientationType.ValueType], builtins.type):
    ...
    UP: OrientationType.ValueType = ...  # 0
    DOWN: OrientationType.ValueType = ...  # 1
...
class Properties(google.protobuf.message.Message):
    ...
    RELATIVE_MERGE_TOLERANCE_FIELD_NUMBER: builtins.int
    ...
    orientation: global___OrientationType.ValueType = ...
    relative_merge_tolerance: builtins.float = ...
    def __init__(self,
        *,
        status : ansys.api.acp.v0.enum_types_pb2.StatusType.ValueType = ...,
        active : builtins.bool = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["active",b"active","cad_geometry",b"cad_geometry","orientation",b"orientation","relative_merge_tolerance",b"relative_merge_tolerance","status",b"status"]) -> None: ...
