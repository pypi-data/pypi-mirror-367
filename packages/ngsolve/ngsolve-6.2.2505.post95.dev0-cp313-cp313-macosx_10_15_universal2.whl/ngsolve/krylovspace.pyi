...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('mat', 'maxiter', 'fig', 'ax', 'plotrates', 'callback_sol', '_final_residual', 'atol', 'ress', 'display', 'iterations', 'its', 'printrates', 'callback', 'tol', 'clear_output', 'pre', 'plt', 'residuals', 'sol')
