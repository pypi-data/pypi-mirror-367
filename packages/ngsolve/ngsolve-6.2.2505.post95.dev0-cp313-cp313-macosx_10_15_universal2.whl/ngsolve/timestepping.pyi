...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('c', 'gfu_old', 'bfmstar', '_lin_solver_cls', 'dt', 'time', '_lin_solver_args')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('c', 'gfa_old', 'gfu_old', 'bfmstar', 'gfv_old', '_lin_solver_cls', 'dt', 'time', '_lin_solver_args')
