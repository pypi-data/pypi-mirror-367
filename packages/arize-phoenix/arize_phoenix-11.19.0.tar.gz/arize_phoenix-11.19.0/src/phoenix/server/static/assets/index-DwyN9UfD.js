import{U as g,j as o,cY as h,eB as v,eC as y,eD as x,l as r,cl as z,eE as a,r as w,o as P,eF as k}from"./vendor-BbqekBfb.js";import{r as S,s as L}from"./vendor-arizeai-CEwHhYfL.js";import{L as C,g as R,r as j,h as I,i as E,F as D,j as A,P as F,k as T,M as t,l as M,D as _,n as G,E as O,o as N,p as q,q as B,s as V,t as d,v as W,w as U,x as $,y as H,z as J,B as K,C as X,G as Y,H as Q,I as Z,J as oo,K as ao,N as lo,O as ro,Q as co,U as go,V as eo,W as m,X as p,Y as u,Z as bo,_ as no,$ as io,a0 as so,a1 as to,a2 as mo,a3 as po,a4 as uo,a5 as fo,a6 as ho,a7 as vo,a8 as yo,a9 as xo,aa as zo,ab as wo,ac as Po,ad as ko,ae as So,af as Lo,ag as Co,ah as Ro,ai as jo,aj as Io,ak as Eo,al as Do,am as Ao,an as Fo,ao as To,ap as Mo,aq as _o,ar as Go,as as Oo,at as No,au as qo,av as Bo,aw as Vo,ax as n,ay as Wo,az as Uo,aA as $o,aB as Ho,aC as Jo,aD as Ko,aE as Xo}from"./pages-B1S5DLvL.js";import{fH as Yo,cX as Qo,U as Zo,fI as oa,fJ as aa}from"./components-C4HZjMqd.js";import"./vendor-three-BLWp5bic.js";import"./vendor-codemirror-CHApHLLJ.js";import"./vendor-shiki-BQ88Q1b1.js";import"./vendor-recharts-Bqf7C6Cm.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))s(c);new MutationObserver(c=>{for(const e of c)if(e.type==="childList")for(const i of e.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function f(c){const e={};return c.integrity&&(e.integrity=c.integrity),c.referrerPolicy&&(e.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?e.credentials="include":c.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function s(c){if(c.ep)return;c.ep=!0;const e=f(c);fetch(c.href,e)}})();const la=g`
  :root,
  .ac-theme {
...
`;function ma(){const{theme:l="dark"}=S();return o(h,{styles:g(ca,ra,l==="dark"?ga:ea,ba(l),la,na,ia,sa,ta,da)})}const pa=v(y(r(a,{path:"/",errorElement:o(n,{}),children:[o(a,{path:"/v1/*",element:o(z,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(C,{})}),o(a,{path:"/logout",element:o(R,{})}),o(a,{path:"/reset-password",element:o(I,{}),loader:j}),o(a,{path:"/reset-password-with-token",element:o(E,{})}),o(a,{path:"/forgot-password",element:o(D,{})}),o(a,{element:o(Ho,{}),loader:A,children:r(a,{element:o($o,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(F,{})}),o(a,{index:!0,loader:T}),r(a,{path:"/model",handle:{crumb:()=>"model"},element:o(N,{}),children:[o(a,{index:!0,element:o(t,{})}),o(a,{element:o(t,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(_,{}),loader:M})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(O,{}),loader:G,handle:{crumb:l=>l.embedding.name}})})]}),r(a,{path:"/projects",handle:{crumb:()=>"Projects"},element:o(Z,{}),children:[o(a,{index:!0,element:o(q,{})}),r(a,{path:":projectId",loader:B,handle:{crumb:l=>l.project.name},element:o(Q,{}),children:[o(a,{index:!0,element:o(V,{})}),r(a,{element:o(Y,{}),children:[o(a,{path:"traces",element:o(W,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"spans",element:o(U,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"sessions",element:o(J,{}),children:o(a,{path:":sessionId",element:o(H,{}),loader:$})}),o(a,{path:"config",element:o(K,{})}),o(a,{path:"metrics",element:o(X,{})})]})]})]}),r(a,{path:"/dashboards",handle:{crumb:()=>"Dashboards"},element:o(go,{}),children:[o(a,{index:!0,element:o(ao,{}),loader:oo}),o(a,{path:"projects/:projectId",element:o(ro,{}),loader:lo,handle:{crumb:l=>l.project.name}}),o(a,{path:":dashboardId",handle:{crumb:()=>"dashboard"},element:o(co,{})})]}),r(a,{path:"/datasets",handle:{crumb:()=>"Datasets"},children:[o(a,{index:!0,element:o(eo,{})}),r(a,{path:":datasetId",loader:m,handle:{crumb:l=>l.dataset.name},children:[r(a,{element:o(so,{}),loader:m,children:[o(a,{index:!0,element:o(u,{}),loader:p}),o(a,{path:"experiments",element:o(u,{}),loader:p}),o(a,{path:"examples",element:o(io,{}),loader:bo,children:o(a,{path:":exampleId",element:o(no,{})})})]}),o(a,{path:"compare",element:o(mo,{}),loader:to,handle:{crumb:()=>"compare"}})]})]}),r(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(po,{})}),o(a,{path:"spans/:spanId",element:o(fo,{}),loader:uo,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),r(a,{path:"/prompts",handle:{crumb:()=>"Prompts"},children:[o(a,{index:!0,element:o(vo,{}),loader:ho}),r(a,{path:":promptId",loader:yo,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[r(a,{element:o(Co,{}),children:[o(a,{index:!0,element:o(xo,{})}),o(a,{path:"versions",loader:zo,element:o(ko,{}),children:o(a,{path:":versionId",loader:wo,element:o(Po,{})})}),o(a,{path:"config",element:o(Lo,{}),loader:So})]}),o(a,{path:"playground",element:o(jo,{}),loader:Ro,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(Io,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(Eo,{}),handle:{crumb:()=>"Support"}}),r(a,{path:"/settings",element:o(Bo,{}),handle:{crumb:()=>"Settings"},children:[o(a,{path:"general",loader:Do,element:o(Ao,{}),handle:{crumb:()=>"General"}}),o(a,{path:"providers",loader:Fo,element:o(To,{}),handle:{crumb:()=>"AI Providers"}}),o(a,{path:"models",loader:Mo,element:o(_o,{}),handle:{crumb:()=>"Models"}}),o(a,{path:"annotations",loader:Go,element:o(Oo,{}),handle:{crumb:()=>"Annotations"}}),o(a,{path:"data",element:o(qo,{}),handle:{crumb:()=>"Data Retention"},loader:No})]}),o(a,{path:"/redirects/spans/:span_otel_id",loader:Vo,errorElement:o(n,{})}),o(a,{path:"/redirects/traces/:trace_otel_id",loader:Wo,errorElement:o(n,{})}),o(a,{path:"/redirects/sessions/:session_otel_id",loader:Uo,errorElement:o(n,{})})]})})]})),{basename:window.Config.basename});function ua(){return o(x,{router:pa})}function fa(){return o(Jo,{children:o(Yo,{children:o(ha,{})})})}function ha(){const{theme:l}=Qo();return o(L,{theme:l,mountGlobalStyles:!1,children:r(P.RelayEnvironmentProvider,{environment:Zo,children:[o(ma,{}),o(Ko,{children:o(oa,{children:o(Xo,{children:o(w.Suspense,{children:o(aa,{children:o(ua,{})})})})})})]})})}const va=document.getElementById("root"),ya=k.createRoot(va);ya.render(o(fa,{}));
