...
class NavigateTestingFolderTest(BaseTest):
    ...
    async def run(self) -> TestResult:
        ...
        # Step 2: Wait for terminal to appear and focus on it
        terminal = page.locator(".xterm, .terminal, [class*='xterm']")
        await terminal.wait_for(timeout=10000)
        await terminal.click()  # Focus the terminal
