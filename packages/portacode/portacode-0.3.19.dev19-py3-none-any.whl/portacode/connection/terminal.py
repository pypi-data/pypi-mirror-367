...
class ClientSessionManager:
    ...
    async def _manage_project_states_for_session_changes(self, newly_added_sessions: List[str], all_sessions: List[Dict]):
        ...
        try:
            ...
            # First, clean up project states for sessions that are no longer project type or don't exist
            ...
            for session in all_sessions:
                ...
                if channel_name and project_folder_path and connection_type == 'project':
                    current_project_sessions.add(channel_name)
                    logger.debug(f"Active project session: {channel_name} -> {project_folder_path}")
            ...
            for session_name in newly_added_sessions:
                ...
                if project_folder_path and connection_type == 'project':
