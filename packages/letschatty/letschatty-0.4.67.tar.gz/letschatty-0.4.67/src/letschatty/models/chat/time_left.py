...
class TimeLeft(BaseModel):
    ...
    def get_time_left(cls, time_left_for_free_conversation_seconds: float, time_left_for_free_template_window_seconds: float) -> "TimeLeft":
        logger.info(f"get_time_left: time_left_for_free_conversation_seconds: {time_left_for_free_conversation_seconds} | time_left_for_free_template_window_seconds: {time_left_for_free_template_window_seconds}")
