...
Report bugs at https://github.com/pcdshub/krtc/issues.
...
krtc could always use more documentation, whether
as part of the official krtc docs, in docstrings,
or even on the web in blog posts, articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/pcdshub/krtc/issues.
...
Ready to contribute? Here's how to set up `krtc` for local development.

1. Fork the `krtc` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/krtc.git
...
3. Install your local copy into a new conda environment. Assuming you have conda installed, this is how you set up your fork for local development::
    ...
    $ conda create -n krtc python=3.9 pip
    $ cd krtc/
    $ pip install -e .
