...
## 5.3.5.0ed at private expense and is in all respects the proprietary
## information of 60East Technologies Inc.; (b) was not 5.3.5.0ed with
...
if module_version.startswith('@'):
    ...
    try:
        ...
        if module_version == "5.3.5.0" or module_version[:5] == "auto-":
