...
class Structure(SimulationObject, StructureInterface, ABC):
    ...
    @property
    def material_index(self) -> str:
        """Returns the constant refractive index of the material if set to
        <Object defined dielectric>. If not, returns 'None'."""
        if self._get("material", str) == "<Object defined dielectric>":
            return self._get("index", str)
        else:
            return "None"
