...
class StructureGroup(Structure):
    ...
    def material(self) -> str:
        """Returns the material of the structure. Always 'None' for structure groups."""
        return "None"

    @property
    def material_index(self) -> str:
        """Returns the constant refractive index of the material. Always 'None' for structure groups."""
        return "None"
