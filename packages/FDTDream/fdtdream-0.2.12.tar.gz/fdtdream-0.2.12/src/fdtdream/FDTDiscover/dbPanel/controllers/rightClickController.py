...
class RightClickController(QObject):
    ...
    def __init__(self):
        ...
        dbRightClickMenuSignalBus.exportToPythonRequested.connect(self._on_export_clicked)
    ...
    @pyqtSlot(list)
    def _on_export_clicked(self, monitors: DBObjects) -> None:
        for monitor in monitors:
            print(f"Database: {monitor['dbHandler'].path}\nId: {monitor['id']}")
