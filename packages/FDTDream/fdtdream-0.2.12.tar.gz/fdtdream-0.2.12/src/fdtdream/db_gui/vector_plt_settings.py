...
class VectorSettings(QWidget):
    ...
    def _create_widgets(self) -> None:
        ...
        # Sampling rate
        self.sampling_combo = LabeledDropdown(self, "Sampling rate:")
        self.sampling_combo.set_dropdown_items([str(i) for i in self.SAMPLING_FACTORS])
        self.sampling_combo.dropdown.setCurrentIndex(0)
        self.sampling_combo.dropdown.currentTextChanged.connect(  # type: ignore
            self.on_sampling_rate_change
        )
        self._layout.addWidget(self.sampling_combo)
    ...
    def on_sampling_rate_change(self, sampling: str) -> None:
    ...
    def sampling_rate(self) -> int:
        return int(self.sampling_combo.get_selected())
