...
enum cpuinfo_uarch {
	...
	/** Apple M4 Pro/Max process (performance cores). */
	cpuinfo_uarch_brava_pcore = 0x00700208,
	/** Apple M4 Pro/Max process (efficiency cores). */
	cpuinfo_uarch_brava_ecore = 0x00700209,
...
/**
 * Convenience wrappers for converting enums to human-readable strings.
 */
