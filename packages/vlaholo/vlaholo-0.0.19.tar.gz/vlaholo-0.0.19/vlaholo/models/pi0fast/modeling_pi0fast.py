...
from .configuration_pi0fast import PI0FASTConfig
from ..pretrained import PreTrainedPolicy
...
class PI0FAST(nn.Module):
    def __init__(self, config: PI0FASTConfig):
        ...
        print(self.pi0_paligemma.language_model)
        ...
        self.ignore_index = self.pi0_paligemma.config.ignore_index if hasattr(self.pi0_paligemma.config, 'ignore_index') else -100
    ...
    def embed_tokens(self, tokens: torch.Tensor):
        if hasattr(self.pi0_paligemma.language_model, 'embed_tokens'):
