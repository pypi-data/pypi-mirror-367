...
# 714 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef void (*flux_watcher_f)(flux_reactor_t *r,
                               flux_watcher_t *w,
                               int revents,
                               void *arg);
# 726 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_stat_watcher_get_rstat (flux_watcher_t *w,
                                 struct stat *stat,
                                 struct stat *prev);
# 848 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 928 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1012 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_msglist_pollevents (struct flux_msglist *l);
int flux_msglist_pollfd (struct flux_msglist *l);
# 1047 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data,
                                     size_t len);
# 1118 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg,
                          const char **topic,
                          const char **s);
# 1130 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1329 "/__w/flux-python/flux-python/src/_core_clean.h"
enum event_flags {
...
# 1449 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1521 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1573 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1611 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1856 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1971 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2023 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2060 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2147 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args,
                             ...
                             const char *fmt,
                             va_list ap);
# 2223 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p,
                      const char *name,
                      flux_plugin_arg_t *args);
# 2234 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_load_dso (flux_plugin_t *p, const char *path);
# 2266 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_sync_create (flux_t *h, double minimum);
# 2297 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_msglist_cancel (flux_t *h,
                         ...
                         const flux_msg_t *msg);
# 2365 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2448 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2463 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2538 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2592 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2601 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2633 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2732 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2803 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2826 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2848 "/__w/flux-python/flux-python/src/_core_clean.h"
