...
def review(
    ...
    hide_info: bool = typer.Option(False, "--hide-info", "-hi", help="Hide informational messages (negated terms)")
):
    """\n\n ------ \n\n
    ⚠️  LEGAL DISCLAIMER: This software is provided for informational and compliance assistance purposes only. \n\nIt is not legal advice and should not be relied upon as such. \n\nUsers are responsible for ensuring their documentation meets all applicable legal requirements and should consult with qualified legal professionals for compliance matters. \n\nThe authors disclaim any liability for damages arising from the use of this software.\n\n\n🔒 DATA PROTECTION: All processing occurs locally on your machine. No data leaves your system."""
