...
class RemoteQueueClient:
    """Client for interacting with remote PyNotiQ server"""
    ...
    def __init__(self, server_url: str, queue_name: str = "default", timeout: int = 30):
        ...
        Args:
            server_url: Base URL of the PyNotiQ server (e.g., 'http://localhost:8000')
    ...
    def _make_request(self, method: str, endpoint: str, data: Optional[Dict] = None) -> Dict:
        ...
        try:
            ...
            raise ConnectionError(f"Failed to connect to PyNotiQ server: {e}")
