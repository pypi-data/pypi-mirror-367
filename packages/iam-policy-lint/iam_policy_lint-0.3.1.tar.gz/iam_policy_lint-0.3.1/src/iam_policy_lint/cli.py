...
def lint_embedded(file_paths: tuple[Path, ...], key_paths: tuple[str, ...], output_format: str, severity: Optional[str]):
        ...
        if output_format == "json":
            ...
            for file_path in file_paths:
                ...
                file_findings = [
                    ...
                    if f.get("location", {}).get("filepath", "").startswith(str(file_path))
                ]
