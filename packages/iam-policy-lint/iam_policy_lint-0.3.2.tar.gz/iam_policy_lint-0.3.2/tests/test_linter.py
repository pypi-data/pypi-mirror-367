...
from src.iam_policy_lint.linter import IAMLinter
...
class TestIAMLinter:
    ...
    @patch("src.iam_policy_lint.linter.parliament")
    def test_lint_policy(self, mock_parliament):
        ...
        # Mock Parliament result object
        mock_result = MagicMock()
        mock_result.findings = [mock_finding]
        mock_parliament.analyze_policy_string.return_value = mock_result
        mock_parliament.enhance_finding.return_value = mock_finding
