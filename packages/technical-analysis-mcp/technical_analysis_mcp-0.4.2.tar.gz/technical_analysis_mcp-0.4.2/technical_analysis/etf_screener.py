...
def screen_etf_anomaly(etf_codes=None, end_date = datetime.now(), lookback_days=60, 
    ...
    for etf_code in etf_codes:
        try:
            ...
            # 计算ATR/MA比率
            df['atr_ma_ratio'] = df['atr'] / df['ma_10']
...
def get_top_anomaly_etfs(top_n=10, **kwargs):
    ...
    :return: DataFrame
    """
    results = screen_etf_anomaly(**kwargs)
