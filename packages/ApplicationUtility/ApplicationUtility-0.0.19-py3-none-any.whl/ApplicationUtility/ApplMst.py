        ...
        if missing_keys:
            ...
            if row_exists:
                ...
                if con_type == 'Oracle':
                    ...
                    deployment_log(f"APPL_MST table insert query for Oracle database ::: {update_query}")
                    ...
                    logger.log(f"\n--- Class ApplMst ---\n")
                    logger.log(f"insert_query values :: {values}")
                    deployment_log(f"APPL_MST table insert query for Other database ::: {update_query}")
