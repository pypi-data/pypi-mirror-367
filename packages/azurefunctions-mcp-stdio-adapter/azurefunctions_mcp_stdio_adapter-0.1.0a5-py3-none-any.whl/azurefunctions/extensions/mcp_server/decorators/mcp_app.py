...
class MCPFunctionApp(TriggerApi, FunctionRegister):
    ...
    def _initialize_authentication(self) -> None:
        ...
        logger.info(f"Server config auth method: {self.current_server_config.auth.method}")
        logger.info(f"Auth configuration: {self.current_server_config.auth}")
        ...
        try:
            ...
            logger.info(f"Auth provider type: {type(provider)}")
        except Exception as e:
