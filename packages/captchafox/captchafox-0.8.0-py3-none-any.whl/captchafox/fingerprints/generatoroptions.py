...
class GeneratorOptions:
    ...
    def generate(self, launch_options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        launch_options.headless = 'virtual' if launch_options.headless else False
        launch_options.locale = launch_options.locale  # Список локалей-языков, например ["en-US", "fr-FR", "de-DE"]
    ...
    @staticmethod
    def _exclude_ublock(launch_options: Dict[str, Any]) -> Dict[str, Any]:
        if random.choice() < 0.6:
