...
import pyconverters_whisperx


# -- Project information -----------------------------------------------------

project = "pyconverters_whisperx"
copyright = "2022, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_whisperx.__version__
release = pyconverters_whisperx.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_whisperx.__file__)
