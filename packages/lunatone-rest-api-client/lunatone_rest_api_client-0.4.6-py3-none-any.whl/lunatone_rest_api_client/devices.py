...
from lunatone_rest_api_client.models.control import ColorRGBData, ColorWAFData
...
class Device:
    ...
    async def fade_to_rgbw_color(self, rgb_color: tuple[float, float, float], white: float = None) -> None:
        """Fade to RGBW color."""
