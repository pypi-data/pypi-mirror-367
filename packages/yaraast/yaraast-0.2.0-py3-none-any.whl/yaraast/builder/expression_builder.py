...
class ExpressionBuilder:
    ...
    def any_of(*strings: str) -> OfExpression:
        ...
        return OfExpression(
            quantifier=StringLiteral(value="any"), string_set=string_set
        )
    ...
    def all_of(*strings: str) -> OfExpression:
        ...
        string_set = ExpressionBuilder.string_set(*strings)
        return OfExpression(
            quantifier=StringLiteral(value="all"), string_set=string_set
        )
    ...
    def at(string_id: str, offset: int | Expression) -> AtExpression:
        ...
        offset_expr = (
            IntegerLiteral(value=offset) if isinstance(offset, int) else offset
        )
        return AtExpression(string_id=string_id, offset=offset_expr)

    @staticmethod
    def in_(
        string_id: str, start: int | Expression, end: int | Expression
    ) -> InExpression:
    ...
    def for_any(var: str, iterable: Expression, body: Expression) -> ForExpression:
        ...
        return ForExpression(
            quantifier="any", variable=var, iterable=iterable, body=body
        )
    ...
    def for_all(var: str, iterable: Expression, body: Expression) -> ForExpression:
        ...
        return ForExpression(
            quantifier="all", variable=var, iterable=iterable, body=body
        )
