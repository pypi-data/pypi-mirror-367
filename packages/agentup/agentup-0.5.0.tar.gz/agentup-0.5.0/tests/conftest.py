...
def minimal_agent_config() -> dict[str, Any]:
    return {
        "agent": {"name": "minimal-test", "description": "Minimal Test Agent", "version": "0.5.0"},
        "plugins": [
            {
                "plugin_id": "echo",
                "name": "Echo",
...
def ollama_agent_config() -> dict[str, Any]:
    return {
        "agent": {"name": "ollama-test", "description": "Ollama Test Agent", "version": "0.5.0"},
        "ai_provider": {
            "provider": "ollama",
            "model": "qwen3:0.6b",
...
def anthropic_agent_config() -> dict[str, Any]:
    return {
        "agent": {"name": "anthropic-test", "description": "Anthropic Test Agent", "version": "0.5.0"},
        "ai_provider": {
            "provider": "anthropic",
