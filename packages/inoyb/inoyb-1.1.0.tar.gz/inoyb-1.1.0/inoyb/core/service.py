    ...
    def _model_execution_wrapper(
        ...
        def wrapper(*input_values):
            ...
            try:
                    ...
                    if (
                        ...
                        if output and os.path.exists(str(output)):
                            ...
                            if field_info.get("type") == "geodata":
                                ...
                                preview_path = self.preview_generator.generate_preview(str(output), bands_config=bands_config)
                ...
                success_msg = "✅ 模型运行完成！"
                return processed_outputs + preview_updates + [gr.update(value=success_msg, visible=True)]
