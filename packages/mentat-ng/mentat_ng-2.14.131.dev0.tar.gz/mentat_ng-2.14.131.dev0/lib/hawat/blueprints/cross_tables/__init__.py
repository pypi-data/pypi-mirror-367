...
from .forms import SimpleCrossTablesSearchForm
...
def _get_search_form(request_args: Any = None) -> SimpleCrossTablesSearchForm:
    ...
    form = SimpleCrossTablesSearchForm(
        request_args,
        meta={"csrf": False},
...
class AbstractSearchView(PsycopgMixin, BaseSearchView):
    ...
    def get_view_title(cls, **kwargs: Any) -> str | LazyString:
        return lazy_gettext("Calculate event cross tables")
    ...
    def get_menu_title(cls, **kwargs: Any) -> str | LazyString:
        return lazy_gettext("Cross tables")

    @staticmethod
    def get_search_form(request_args: Any) -> SimpleCrossTablesSearchForm:
...
class CrossTablesBlueprint(HawatBlueprint):
    """
    Blueprint for the cross tables module.
    """

    @classmethod
    def get_module_title(cls) -> str | LazyString:
        return lazy_gettext("Event cross tables")
...
def get_blueprint() -> CrossTablesBlueprint:
    """
