...
class NebulaClient:
    ...
    def delete(self, memory_id: str) -> bool:
        ...
        Note: This endpoint may not be supported by the backend API.
        ...
        try:
            ...
            # If the backend doesn't support individual document deletion,
            # we'll raise a more informative error
            if "404" in str(e) or "not found" in str(e).lower():
                raise NebulaException(
                    f"Document deletion not supported or document not found: {memory_id}",
                    404,
                    {"error": "Document deletion endpoint not available"}
                )
            raise
