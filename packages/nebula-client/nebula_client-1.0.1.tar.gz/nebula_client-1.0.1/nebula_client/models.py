...
class Memory:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Memory":
        ...
        # API returns 'owner_id', SDK expects 'agent_id'
        agent_id = data.get("agent_id") or data.get("owner_id", "")
        
        # API returns 'collection_ids', add to metadata
        metadata = data.get("metadata", {})
        if data.get("collection_ids"):
            metadata["collection_ids"] = data["collection_ids"]
...
@dataclass
class Cluster:
    """A cluster of memories in Nebula"""
