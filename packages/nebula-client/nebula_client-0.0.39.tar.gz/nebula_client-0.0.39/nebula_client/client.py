...
class NebulaClient:
    ...
    def list_memories(
        ...
        for doc in documents:
            # Get content from document directly
            content = doc.get("summary", "") or doc.get("content", "") or "No content available"
    ...
    def get_memory(self, memory_id: str) -> Memory:
        ...
        # Get content from document directly
        content = response.get("summary", "") or response.get("content", "") or "No content available"
