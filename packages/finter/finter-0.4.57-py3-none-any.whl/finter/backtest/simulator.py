...
class Simulator:
    ...
    def get_cached_instance(
        ...
        """Get or create a cached Simulator instance with replace strategy."""
        # Create instance (caching logic is handled in __init__)
        instance = cls(
        ...
        # For single market case, store in cache
        if not isinstance(market_type, list):
            cache_key = (market_type, start, end, _handler_cls)
