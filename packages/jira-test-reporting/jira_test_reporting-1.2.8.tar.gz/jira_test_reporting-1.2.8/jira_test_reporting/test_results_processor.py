...
from .test_results_to_jira import clean_up_all_test_comments
...
def get_args():
    ...
    parser.add_argument('--comments-cleanup', default="no",
                        help='example: --comments-cleanup=yes or no')
    return parser.parse_args()


def main():
    args = get_args()
    if args.comments_cleanup.lower() == 'yes':
        clean_up_all_test_comments()
        return
