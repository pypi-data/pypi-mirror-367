...
__date__      = '2025-August-6'   
__url__       = 'https://engineering.purdue.edu/kak/distGPT/babyGPT-1.0.9.html'
...
@title
QUICKEST WAY TO START USING babyGPT:

    1.  Download and unpack the "Athlete News" training corpus from the module website 
        at Purdue.  See the Section "Training Datasets Provided" for further details.

    2.  Enter the pathname to the training data in the script 
    ...
    3.  Now execute the script named above.  That's all!
...
THE MAJOR COMPONENTS of babyGPT:
    ...
    The module comes with a pre-trained tokenizer with a vocab size of around 50,000
    ...
    directory is: "109_babygpt_tokenizer_49275.json".  The prefix "109" says that the
    JSON was created with the tokenization code in version 1.0.9 of babyGPT.  And
    "49270" is the actual size of the token vocab.
...
THE TRAINING DATASETS PROVIDED:
    ...
    While you are in the Examples directory of the distribution, click on the link 

                    "Download the text datasets for babyGPT" 

    at the Purdue webpage for babyGPT.  That will deposit the following archive in
    the Examples directory:
    ...
    56 Million multi-byte characters.
...
ACKNOWLEDGMENTS:
    ...
    computing.  As previously mentioned in this page, Adrien is also the creator of 
    the "Athlete News" dataset that I provide through the module webpage at Purdue.
