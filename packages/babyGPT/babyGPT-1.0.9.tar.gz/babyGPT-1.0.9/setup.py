...
setup(name='babyGPT',
      ...
      url='https://engineering.purdue.edu/kak/distBabyGPT/babyGPT-1.0.9.html',
      download_url='https://engineering.purdue.edu/kak/distBabyGPT/babyGPT-1.0.9.tar.gz',
      description='An educational module for experimenting with unsupervised learning in large language modeling',
      long_description='''

Consult the module API page at

      https://engineering.purdue.edu/kak/distBabyGPT/babyGPT-1.0.9.html
