...
import pyprocessors_capitalizer


# -- Project information -----------------------------------------------------

project = "pyprocessors_capitalizer"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_capitalizer.__version__
release = pyprocessors_capitalizer.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_capitalizer.__file__)
