...
The Gooder AI package provides a `ModelWrapper` abstract base class that allows you to create PyTorch models compatible with scikit-learn and XGBoost models in the `valuate_model` function. This enables seamless integration of different machine learning frameworks.
...
[Sample Workbook: Using `valuate_model` with Torch Models](https://drive.google.com/file/d/1uny8_Bqj5YphCuXoi34hIl4xI6kleLa9/view?usp=drive_link)
