...
from vihi_nova_act.impl.extension import DEFAULT_ENDPOINT_NAME, ExtensionDispatcher
...
from vihi_nova_act.impl.telemetry import send_act_telemetry
from vihi_nova_act.preview.custom_actuation.custom_dispatcher import CustomActDispatcher
from vihi_nova_act.preview.custom_actuation.interface.browser import BrowserActuatorBase
from vihi_nova_act.preview.custom_actuation.playwright.default_nova_local_browser_actuator import (
...
class NovaAct:
    ...
    def __init__(
        ...
        *,
        ...
        """
        # _LOGGER.info(f"Initializing NovaAct with {starting_page=}")
        ...
        # _LOGGER.info(f"Extension path: {extension_path}")
        self._starting_page = starting_page or "https://www.google.com"
        # _LOGGER.info(f"Starting page: {self._starting_page}")
    ...
    def act(
        ...
        *,
        ...
        # _LOGGER.info(f"Acting on {prompt}")
        ...
        # creating central data structure for task execution
        act = Act(
            prompt,
        ...
        # _TRACE_LOGGER.info(f"This is my Act: {act}")
        ...
        try:
            # _TRACE_LOGGER.info(f"Dispatching and waiting for prompt completion")
            if self._stream:
