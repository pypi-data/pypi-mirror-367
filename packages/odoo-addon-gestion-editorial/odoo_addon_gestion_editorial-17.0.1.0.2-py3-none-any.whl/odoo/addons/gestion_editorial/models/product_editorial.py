...
class EditorialTemplateProducts(models.Model):
    ...
    def update_or_create_ddaa_purchase_orders(self, ddaa_qty):
        ...
        for authorship in authorships:
            ...
            self.update_or_create_ddaa_purchase_order_lines(authorship_ddaa_order, authorship, ddaa_qty)
        
        return authorship_ddaa_order

    def update_or_create_ddaa_purchase_order_lines(self, purchase_order, authorship, ddaa_qty):
        ...
        book_ddaa_lines = self.update_or_create_book_ddaa_lines(purchase_order, section_id, authorship, ddaa_qty, sequence)
    ...
    def update_or_create_book_ddaa_lines(self, purchase_order, section_id, authorship, ddaa_qty, sequence):
        ...
        _logger.debug(f"authorship.price: {authorship.price}")

        if book_ddaa_line and book_ddaa_line.price_unit == authorship.price:
            ...
            _logger.debug(f"\tPrice: {authorship.price}")
            ...
            if book_ddaa_line:
                ...
                ).format(product_name=self.name, currency=currency.symbol, previous_qty=book_ddaa_line.price_unit, new_qty=authorship.price)
    ...
    def generate_ddaa(self, ddaa_qty):
        ...
        return self.update_or_create_ddaa_purchase_orders(ddaa_qty)
