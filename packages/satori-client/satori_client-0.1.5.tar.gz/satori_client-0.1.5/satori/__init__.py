...
class Satori:
    ...
    def run(username=None, password=None, port=None):
        if username != None and password != None:
            if port != None:
                subprocess.call("satori -h -a "+username+" "+password+" -p "+port)
            else:
                subprocess.call("satori -h -a "+username+" "+password)
        else:
            if port!=None:
                subprocess.call("satori -h -p "+port)
            else:
                subprocess.call("satori -h")
    
    def update():
        subprocess.run("satoridb update")
