...
:::"""
        ...
        # Format response
        if raw_directive:
            # Return instruction for AI to output the directive exactly
            instruction = f"""Please output the following Lightdash embed directive EXACTLY as shown, with no additional text or explanation:
