...
class AIDocumentationEnhancer:
    ...
    def _build_function_prompt(self, func_data: Dict[str, Any], context: str) -> str:
        ...
        prompt = f"""You are a technical documentation expert. Generate comprehensive, professional documentation for this function.
...
1. A clear one-line summary (max 80 chars)
2. A detailed description explaining what the function does and when to use it
3. Parameter descriptions with types and what they represent
4. Return value description with type and meaning
5. A practical code example showing typical usage
6. Any important notes, warnings, or edge cases
...
{{
    ...
    "params": [
        {{"name": "param1", "type": "str", "description": "What this parameter does"}}
    ],
    "returns": {{"type": "ReturnType", "description": "What the return value represents"}},
    "example": "# Example code\\nresult = {func_name}(...)",
    "notes": ["Important note 1", "Edge case to watch for"]
}}"""
    ...
    def _build_class_prompt(self, class_data: Dict[str, Any], context: str) -> str:
        ...
        prompt = f"""You are a technical documentation expert. Generate comprehensive, professional documentation for this class.
...
Generate documentation with:
1. A clear one-line summary (max 80 chars)
2. A detailed description explaining the class's purpose and responsibility
3. Common use cases and when to use this class
4. A practical code example showing typical usage
5. Any important notes about the class design or usage patterns
...
{{
    ...
    "example": "# Example code\\ninstance = {class_name}(...)\\ninstance.method()",
    "notes": ["Design pattern used", "Important consideration"]
}}"""
