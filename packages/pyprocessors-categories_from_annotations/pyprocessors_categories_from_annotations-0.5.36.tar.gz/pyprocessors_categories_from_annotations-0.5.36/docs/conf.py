...
import pyprocessors_categories_from_annotations


# -- Project information -----------------------------------------------------

project = "pyprocessors_categories_from_annotations"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_categories_from_annotations.__version__
release = pyprocessors_categories_from_annotations.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_categories_from_annotations.__file__)
