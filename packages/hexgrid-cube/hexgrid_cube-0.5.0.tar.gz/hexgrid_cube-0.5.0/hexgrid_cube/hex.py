...
class Hex:
    ...
    def yield_line(self, target: "Hex", *, include_target: bool = False, include_self: bool = True) -> Iterator["Hex"]:
        """
        ...
        include_self: bool
            flag indicating whether to yield self or not.
        ...
        step = 1.0 / max(n, 1)
        for i in range(0 if include_self else 1, n):
