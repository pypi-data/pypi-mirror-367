...
def execute_agent_run(agent_id: str, api_key: str, input_args: list, output_path: str = None):
    """
    ...
    print(f"▶️  Fetching configuration for agent '{agent_id}'...")
    try:
    ...
    # 2. Process and validate the input arguments (reusing logic from test_run.py)
    inputs_payload = {}
    ...
    for arg in input_args:
        ...
        inputs_payload[key] = {
            "Name": value, # We still send the original name for context
    ...
    # 4. Prepare and make the API call to the run endpoint
    ...
    try:
        ...
        # 5. Handle successful response (reusing logic from test_run.py)
