...
from svc_order_zxw.异常代码 import 商品_异常代码, 支付_异常代码
...
async def func0_查询或创建订单_仅限IAP(
    ...
    logger.info(f"查询或创建订单_仅限IAP: {product_id}, {payment_price}, {quantity}, {transactionIdentifier}, {original_transaction_id}, {subscription_expire_date}, {payment_status}")
    # 0. 查询支付单是否存在
