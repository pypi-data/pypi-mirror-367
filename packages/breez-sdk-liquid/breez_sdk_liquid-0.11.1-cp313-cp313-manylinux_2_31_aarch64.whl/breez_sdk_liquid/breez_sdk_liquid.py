...
class PayAmount:
    ...
    class ASSET:
        ...
        pay_with_bitcoin: "typing.Optional[bool]"

        def __init__(self,asset_id: "str", receiver_amount: "float", estimate_asset_fees: "typing.Optional[bool]", pay_with_bitcoin: "typing.Optional[bool]"):
            self.asset_id = asset_id
            self.receiver_amount = receiver_amount
            self.estimate_asset_fees = estimate_asset_fees
            self.pay_with_bitcoin = pay_with_bitcoin

        def __str__(self):
            return "PayAmount.ASSET(asset_id={}, receiver_amount={}, estimate_asset_fees={}, pay_with_bitcoin={})".format(self.asset_id, self.receiver_amount, self.estimate_asset_fees, self.pay_with_bitcoin)
        ...
        def __eq__(self, other):
            ...
            if self.estimate_asset_fees != other.estimate_asset_fees:
                return False
            if self.pay_with_bitcoin != other.pay_with_bitcoin:
                return False
            return True
...
class _UniffiConverterTypePayAmount(_UniffiConverterRustBuffer):
    ...
    def check_lower(value):
        ...
        if value.is_asset():
            ...
            _UniffiConverterOptionalBool.check_lower(value.pay_with_bitcoin)
            return
        if value.is_drain():
            return
        raise ValueError(value)
    ...
    def write(value, buf):
        ...
        if value.is_asset():
            ...
            _UniffiConverterOptionalBool.write(value.pay_with_bitcoin, buf)
        if value.is_drain():
            buf.write_i32(3)
