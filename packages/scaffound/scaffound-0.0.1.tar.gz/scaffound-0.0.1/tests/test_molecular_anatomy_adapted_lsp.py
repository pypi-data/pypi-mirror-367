...
class ImprovedMolecularAnatomyTestCase(unittest.TestCase):

    def setUp(self):
        from .constants import COX2_SCAFFOLDS_EXT, NEW_SCAFFFOLDS
        from rdkit import Chem
        with BlockLogs():
            self.cox2 = COX2_SCAFFOLDS_EXT.assign(mol=COX2_SCAFFOLDS_EXT.molecule_smiles.apply(Chem.MolFromSmiles))
