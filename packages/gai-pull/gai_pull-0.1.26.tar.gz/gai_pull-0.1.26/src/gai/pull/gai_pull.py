...
def pull(model_name, dry_run=False):
    ...
    if not models:
        console.print(
            "[red]No models found in gai.yml. Make sure you have ran the latest gai-pull and try again.[/]"
        )
        return False
    ...
    if not model:
        console.print(
            f"[red]Model {model_name} not found. Make sure you have ran the latest gai-pull and try again.[/]"
        )
        return False
