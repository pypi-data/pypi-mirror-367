...
class ModelBridge:
    ...
    def _setup_default_aliases(self):
        ...
        self.model_aliases = {
            "fastest": [
                # 🚀 WORLD'S FASTEST: Groq Mixtral at 500+ tokens/second!
                ModelAlias("fastest", "groq", "mixtral-8x7b-32768", 1),
                # 276 tokens/second - Latest Meta model
                ModelAlias("fastest", "groq", "llama-3.3-70b-versatile", 2), 
                # 250+ tokens/second with thinking capabilities
                ModelAlias("fastest", "google", "gemini-2.5-flash", 3),
                # 150 tokens/second, 40x cheaper than old gpt-3.5-turbo!
                ModelAlias("fastest", "openai", "gpt-5-nano-2025-08-07", 4),
            ],
            "cheapest": [
                # 💰 ULTRA-CHEAP: GPT-5 Nano at $0.05/1M (40x cheaper than old routing!)
                ModelAlias("cheapest", "openai", "gpt-5-nano-2025-08-07", 1),
                # Groq's cheapest at $0.05/1M input, lightning fast
                ModelAlias("cheapest", "groq", "llama-3.1-8b-instant", 2),
                # Google's ultra-cheap option with 1M context
                ModelAlias("cheapest", "google", "gemini-2.5-flash-lite", 3),
                # Groq's balanced cheap option
                ModelAlias("cheapest", "groq", "llama3-8b-8192", 4),
            ],
            "best": [
                # 🏆 TOP QUALITY: GPT-5 at 94.6% AIME, 74.9% SWE-bench, 84.2% MMMU
                ModelAlias("best", "openai", "gpt-5-2025-08-07", 1),
                # Claude 4.1 Opus: 74.5% SWE-bench, enhanced reasoning
                ModelAlias("best", "anthropic", "claude-4.1-opus", 2),
                # Gemini 2.5 Pro: 86.7% AIME, 1M+ context, multimodal leader
                ModelAlias("best", "google", "gemini-2.5-pro", 3),
                # Claude 4 Opus: World-class reasoning and coding
                ModelAlias("best", "anthropic", "claude-4-opus", 4),
            ],
            "balanced": [
                # ⚖️ PERFECT BALANCE: GPT-5 Mini - great performance, reasonable cost
                ModelAlias("balanced", "openai", "gpt-5-mini-2025-08-07", 1),
                # Claude 4 Sonnet: 72.7% SWE-bench at $3/15, high output capacity
                ModelAlias("balanced", "anthropic", "claude-4-sonnet", 2),
                # Gemini 2.5 Flash: 250+ tokens/sec with thinking, well-rounded
                ModelAlias("balanced", "google", "gemini-2.5-flash", 3),
                # Groq Llama 3.3: 276 tokens/sec at $0.59/0.79, excellent value
                ModelAlias("balanced", "groq", "llama-3.3-70b-versatile", 4),
            ],
        }
