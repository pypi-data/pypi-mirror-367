    ...
    def _get_default_models(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "gpt-5-2025-08-07": {
                ...
                "performance": {
                    "aime_2025": 94.6,  # 94.6% on AIME 2025 (math)
                    "swe_bench_verified": 74.9,  # 74.9% on SWE-bench Verified (coding)
                    "aider_polyglot": 88.0,  # 88% on Aider Polyglot (real-world coding)
                    "mmmu": 84.2,  # 84.2% on MMMU (multimodal understanding)
                    "health_bench_hard": 46.2,  # 46.2% on HealthBench Hard
                    "description": "State-of-the-art performance across all benchmarks"
                },
                "features": ["4_reasoning_levels", "multimodal", "state_of_the_art", "enterprise_grade"]
            },
            "gpt-5-mini-2025-08-07": {
                "context_length": 272000,
                "cost_per_1k_tokens": 0.25,  # Estimated input cost
                "cost_per_1k_tokens_output": 2.00,  # Estimated output cost  
                "max_output_tokens": 128000,
                "category": "balanced",
                "speed": "fast",
                "reasoning": "excellent",
                ...
                "knowledge_cutoff": "2025-06",
                "performance": {
                    "description": "Smaller, faster variant with excellent performance"
                },
                "features": ["4_reasoning_levels", "cost_effective", "fast_execution"]
            },
            "gpt-5-nano-2025-08-07": {
                "context_length": 272000,
                "cost_per_1k_tokens": 0.05,   # Ultra-low cost input
                "cost_per_1k_tokens_output": 0.40,  # Ultra-low cost output
                "max_output_tokens": 128000,
                "category": "fast",
                "speed": "fastest",
                "reasoning": "good", 
                ...
                "knowledge_cutoff": "2025-06",
                "performance": {
                    "description": "Optimized for ultra-low latency and instant responses"
                },
                "features": ["ultra_fast", "ultra_cheap", "real_time_applications", "instant_responses"]
            },
