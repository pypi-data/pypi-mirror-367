...
class AnthropicProvider(BaseModelProvider):
    ...
    def _get_default_models(self) -> Dict[str, Any]:
        ...
        return {
            # Claude 4 Family (LATEST - Released May-August 2025) 🚀
            "claude-4.1-opus": {
                "context_length": 200000,
                "cost_per_1k_tokens": 15.00,  # Input cost
                "cost_per_1k_tokens_output": 75.00,  # Output cost
                "max_output_tokens": 32768,
                "category": "flagship",
                "speed": "slow",
                "reasoning": "exceptional",
                "capabilities": ["text", "vision", "advanced_reasoning", "coding", "mathematics", "tool_use", "extended_thinking"],
                "knowledge_cutoff": "2025-03",
                "performance": {
                    "swe_bench": 74.5,  # 74.5% SWE-bench Verified
                    "aime_2025": 90.0,  # 90% on AIME 2025 (high-compute mode)
                    "description": "Enhanced version of Claude 4 Opus with improved reasoning"
                },
                "features": ["extended_thinking", "hybrid_instant_thinking_modes", "parallel_tool_use", "enhanced_memory"]
            },
            "claude-4-opus": {
                "context_length": 200000,
                "cost_per_1k_tokens": 15.00,  # Input cost
                ...
                "knowledge_cutoff": "2025-03",
                "performance": {
                    "description": "Flagship model for complex reasoning and analysis tasks"
                },
                "features": ["extended_thinking", "superior_instruction_following", "world_class_reasoning"]
            },
            "claude-4-sonnet": {
                "context_length": 200000,
                "cost_per_1k_tokens": 3.00,   # Input cost
                "cost_per_1k_tokens_output": 15.00,  # Output cost
                "max_output_tokens": 64000,   # Higher output limit than Opus
                "category": "balanced",
                "speed": "medium",
                "reasoning": "excellent",
                ...
                "knowledge_cutoff": "2025-03",
                "performance": {
                    "swe_bench": 72.7,  # 72.7% SWE-bench Verified
                    "description": "Balanced performance model with excellent coding capabilities"
                },
