    ...
    def _get_default_models(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "gpt-5": {
                ...
                "cost_per_1k_tokens_output": 10.00,  # Output cost
                ...
                "performance": {
                    "swe_bench": 74.9,  # 74.9% on SWE-bench Verified
                    "aider_polyglot": 88.0,  # 88% on Aider polyglot
                    "factual_accuracy": "45% fewer errors than GPT-4o"
                },
                "features": ["thinking_modes", "4_reasoning_levels", "state_of_the_art_coding"]
            },
            "gpt-5-mini": {
                "context_length": 272000,
                "cost_per_1k_tokens": 0.25,  # Input cost
                "cost_per_1k_tokens_output": 2.00,  # Output cost  
                "max_output_tokens": 128000,
                "category": "balanced",
                "speed": "fast",
                "reasoning": "excellent",
                ...
                "knowledge_cutoff": "2025-06",
                "performance": {
                    "description": "Balanced performance and cost optimization"
                },
                "features": ["thinking_modes", "cost_effective", "strong_performance"]
            },
            "gpt-5-nano": {
                "context_length": 272000,
                "cost_per_1k_tokens": 0.05,   # Input cost - 40x CHEAPER than old gpt-3.5-turbo!
                "cost_per_1k_tokens_output": 0.40,  # Output cost
                "max_output_tokens": 128000,
                "category": "fast",
                "speed": "fastest",
                "reasoning": "good", 
                ...
                "knowledge_cutoff": "2025-06",
                "performance": {
                    "tokens_per_second": 150,  # 130-150 tokens/second
                    "description": "Ultra-fast and ultra-cost-effective"
                },
                "features": ["ultra_fast", "ultra_cheap", "real_time_applications"]
            },
