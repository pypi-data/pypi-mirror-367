...
function K(r, e, s, o) {
  ...
  if (e === !0) return " " + (r + '="' + r + '"');
  var u = typeof e;
  return u !== "object" && u !== "function" || typeof e.toJSON != "function" || (e = e.toJSON()), typeof e == "string" || (e = JSON.stringify(e), s || e.indexOf('"') === -1) ? (s && (e = X(e)), " " + r + '="' + e + '"') : " " + r + "='" + e.replace(/'/g, "&#39;") + "'";
}
function X(r) {
  var e = "" + r, s = Y.exec(e);
  if (!s) return r;
...
function a(r, e, s, o) {
  ...
  if (e === !0) return " " + (r + '="' + r + '"');
  var u = typeof e;
  return u !== "object" && u !== "function" || typeof e.toJSON != "function" || (e = e.toJSON()), typeof e == "string" || (e = JSON.stringify(e), s || e.indexOf('"') === -1) ? (s && (e = h(e)), " " + r + '="' + e + '"') : " " + r + "='" + e.replace(/'/g, "&#39;") + "'";
}
function h(r) {
  var e = "" + r, s = i0.exec(e);
  if (!s) return r;
...
function l(r, e, s, o) {
  ...
  if (e === !0) return " " + (r + '="' + r + '"');
  var u = typeof e;
  return u !== "object" && u !== "function" || typeof e.toJSON != "function" || (e = e.toJSON()), typeof e == "string" || (e = JSON.stringify(e), s || e.indexOf('"') === -1) ? (s && (e = j(e)), " " + r + '="' + e + '"') : " " + r + "='" + e.replace(/'/g, "&#39;") + "'";
}
function j(r) {
  var e = "" + r, s = n0.exec(e);
  if (!s) return r;
