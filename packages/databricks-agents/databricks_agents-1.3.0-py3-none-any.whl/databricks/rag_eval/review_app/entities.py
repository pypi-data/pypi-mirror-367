...
class LabelingSession:
    ...
    def add_dataset(
        ...
        record_ids_to_add = (
            set(record_ids or dataset_records.keys()) - existing_record_ids
        )
        if record_ids_to_add:
            if self.agent:
                ...
                for record_id in record_ids_to_add:
                    ...
                    if (
                        not record.source
                        or not record.source.trace
                        or not record.source.trace.trace_id
                    ):
                        raise ValueError(
    ...
    def add_traces(
        ...
        for trace in traces:
            ...
            # Log the trace to this experiment and associate it with this run.
