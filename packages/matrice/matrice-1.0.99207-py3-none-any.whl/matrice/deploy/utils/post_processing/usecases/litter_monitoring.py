...
class LitterDetectionConfig(BaseConfig):
    ...
    usecase_categories: List[str] = field(
        default_factory=lambda: [
            'aluminium_foil', 'bottle_cap', 'bottle', 'broken_glass', 'can', 'carton',
            'cigarette', 'cup', 'lid', 'other_litter', 'other_plastic', 'paper',
            'plastic_bag_wrapper', 'plastic_container', 'pop_tab', 'straw', 'styrofoam_piece', 'unlabeled_litter'
        ]
    )
    ...
    index_to_category: Optional[Dict[int, str]] = field(
        default_factory=lambda: {
            ...
            10: "other_plastic",
            11: "paper",
            12: "plastic_bag_wrapper",
            13: "plastic_container",
            14: "pop_tab",
            15: "straw",
            16: "styrofoam_piece",
            17: "unlabeled_litter"
...
class LitterDetectionUseCase(BaseProcessor):
    ...
    CATEGORY_DISPLAY = {
        ...
        "paper": "Paper",
        "plastic_bag_wrapper": "Plastic Bag/Wrapper",
        "plastic_container": "Plastic Container",
        "pop_tab": "Pop Tab",
        "straw": "Straw",
        "styrofoam_piece": "Styrofoam Piece",
