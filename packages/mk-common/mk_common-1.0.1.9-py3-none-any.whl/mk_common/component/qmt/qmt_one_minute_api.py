...
if __name__ == '__main__':
    ...
    test_df = get_one_minute_data_by_symbol_list(['300085.SZ', '000001.SZ'],
                                                 date_handle_util.no_slash_date('2025-08-05'),
                                                 date_handle_util.no_slash_date('2025-08-05'), '1m', True)
    print(test_df)
