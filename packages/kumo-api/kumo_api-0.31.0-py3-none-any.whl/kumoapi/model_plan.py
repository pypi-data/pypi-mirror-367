...
class HopConfig:
    ...
    def __setitem__(
        ...
        if key != 'default':
            value = HopConfig._validate_extra_item(key, value)
    ...
    def __post_init__(self):
        for k, v in self.__pydantic_extra__.items():
            setattr(self, k, HopConfig._validate_extra_item(k, v))
    ...
    @staticmethod
    def _validate_extra_item(key: str, value) -> Union[int, InferredType]:
        if '->' not in key:
