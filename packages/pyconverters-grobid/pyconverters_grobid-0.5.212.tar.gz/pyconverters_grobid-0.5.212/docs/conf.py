...
import pyconverters_grobid


# -- Project information -----------------------------------------------------

project = "pyconverters_grobid"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_grobid.__version__
release = pyconverters_grobid.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_grobid.__file__)
