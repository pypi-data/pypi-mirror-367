...
def getshow_config(mode: int=1) -> dict: # pyright: ignore[reportReturnType]
    """
    文档:
    ...
    def do_nothing(*args, **kwargs) -> None:
        pass
    if mode == 1:
        use_print_1 = do_nothing
        use_print_2 = do_nothing
    elif mode == 2:
        use_print_1 = do_nothing
        use_print_2 = print
    else:
...
def demo():
    ...
    for _ in range(10):
        ...
        print(("@" + str(style_id_1) + "{0}@" + str(style_id_2) + "{1}").cformat("Hello ", " World!")) # pyright: ignore[reportAttributeAccessIssue]
...
def demoid():
    ...
    for _ in range(10):
        style_id_1 = random.randrange(0, 70943)
        style_id_2 = random.randrange(0, 70943)
        print(("@" + str(style_id_1) + "{0}@" + str(style_id_2) + "{1} {2:>6} {3:>6}").cformat( # pyright: ignore[reportAttributeAccessIssue]
