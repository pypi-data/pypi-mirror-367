...
class DBInstance(TagsDictMixin, PrimaryBoto3Model):
    ...
    with read replicas for Amazon RDS for Db2 <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-replication.html>`_
    and `Working with read replicas for Amazon RDS for
    Oracle <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/oracle-read-replicas.html>`_ in the *Amazon RDS User
    Guide*.
    """
    LicenseModel: str | None = None
    """
