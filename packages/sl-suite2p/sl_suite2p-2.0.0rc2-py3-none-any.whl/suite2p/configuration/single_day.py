...
class SingleDayS2PConfiguration(YamlConfig):
    ...
    def from_ops(cls, ops_dict: dict[str, Any]) -> "SingleDayS2PConfiguration":
        """Creates a SingleDayS2PConfiguration instance from the input ops.npy dictionary.
        ...
        Returns:
            SingleDayS2PConfiguration instance with parameters from ops_dict, using configuration defaults for any
            missing parameters.
        """
...
def generate_default_ops(as_dict: bool = True) -> dict[str, Any] | SingleDayS2PConfiguration:
    ...
    Args:
        as_dict: If True, the function converts the class to dictionary format, which is the format used by the suite2p
            under-the-hood. Otherwise, returns the class as the 'SingleDayS2PConfiguration' dataclass instance, which
