...
class AIEvaluator:
    ...
    def evaluate(self, question_data, transcript, vim_log=None):
        ...
        """
        # Preprocess transcript to expand common alias 'k' to 'kubectl' at line starts
        try:
            import re as _re
...
If the provided expected answers appear to be syntactically invalid or not valid kubectl commands, IGNORE those expected answers and evaluate the user's answer based on known kubectl syntax equivalence and best practices.
"""
        elif quiz_type == 'vim':
            return base_prompt + """
