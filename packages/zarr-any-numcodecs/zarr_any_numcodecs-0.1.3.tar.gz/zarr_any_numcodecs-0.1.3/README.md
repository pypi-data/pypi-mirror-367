[![image](https://img.shields.io/github/actions/workflow/status/juntyr/zarr-any-numcodecs/ci.yml?branch=main)](https://github.com/juntyr/zarr-any-numcodecs/actions/workflows/ci.yml?query=branch%3Amain)
