 ...
 */
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_kp_u_The_cuda_nvrtc_module_is_depreca, __pyx_builtin_FutureWarning); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 21, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_cuda_bindings_nvrtc, __pyx_t_2, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 6, __pyx_L1_error)
