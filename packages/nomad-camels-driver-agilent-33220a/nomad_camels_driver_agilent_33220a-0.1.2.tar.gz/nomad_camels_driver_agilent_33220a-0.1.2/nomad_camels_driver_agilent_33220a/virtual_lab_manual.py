...
class Run_Thread(QThread):
    ...
    def update_settings(self):
        ...
        if "running" in self.current_settings and self.current_settings["running"]:
            params = []
            if (
                "coffee machine" in self.current_settings
                and self.current_settings["coffee machine"]
            ):
                params.append({"frequency": 50, "amplitude": 2, "phase": 0})
            if (
                "computer" in self.current_settings
                and self.current_settings["computer"]
            ):
                params.append(
                    {
                        "frequency": 53910,
            ...
            if (
                "oscilloscope" in self.current_settings
                and self.current_settings["oscilloscope"]
            ):
                params.append(
                    {
                        "frequency": 81600,
            ...
            if (
                "function generator" in self.current_settings
                and self.current_settings["function generator"]
            ):
                params.append(
                    {
                        "frequency": 45800,
