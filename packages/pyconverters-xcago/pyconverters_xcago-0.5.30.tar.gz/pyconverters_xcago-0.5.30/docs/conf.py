...
import pyconverters_xcago


# -- Project information -----------------------------------------------------

project = "pyconverters_xcago"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_xcago.__version__
release = pyconverters_xcago.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_xcago.__file__)
