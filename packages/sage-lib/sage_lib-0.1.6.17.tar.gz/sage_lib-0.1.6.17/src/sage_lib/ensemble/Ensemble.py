...
class Ensemble:
    ...
    def estimate_metrics(self, freqs_A, freqs_B, energies_A, energies_B, energies_all, LA, LB,
        ...
        #plt.plot(massA, alpha=.2)
        #plt.plot(massB, alpha=.2)
        #plt.show()
...
'''
ens = Ensemble( weights_mode='boltzmann' ) # weights_mode='uniform'
...
#pb = '/Users/dimitry/Documents/Data/GA/CuO/alpha1/config_01.xyz'
ens.read_ensembles(pa)
