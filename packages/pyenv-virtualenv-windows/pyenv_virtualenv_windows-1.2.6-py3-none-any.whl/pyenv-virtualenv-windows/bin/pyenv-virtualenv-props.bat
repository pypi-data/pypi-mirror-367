@echo off
setlocal
REM Windows Command Line Script (Batch) to launch "pyenv-virtualenv-props.py".
REM
REM Dependencies:
REM   * pyenv
...
call python "%~dp0pyenv-virtualenv-props.py" %*
set /a RC=%ERRORLEVEL%
...
:error1
echo.
echo [91mERROR    Failed to manage project properties (RC = %RC%).[0m
