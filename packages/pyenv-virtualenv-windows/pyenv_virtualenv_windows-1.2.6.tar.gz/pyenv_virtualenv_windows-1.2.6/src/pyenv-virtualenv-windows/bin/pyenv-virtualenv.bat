@echo off
setlocal
REM Windows Command Line Script (Batch) to launch "pyenv-virtualenv.py".
REM
REM Dependencies:
REM   * pyenv
...
call python "%~dp0pyenv-virtualenv.py" %*
set /a RC=%ERRORLEVEL%
...
:error1
echo.
echo [91mERROR    Failed to create Python virtual environment (RC = %RC%).[0m
