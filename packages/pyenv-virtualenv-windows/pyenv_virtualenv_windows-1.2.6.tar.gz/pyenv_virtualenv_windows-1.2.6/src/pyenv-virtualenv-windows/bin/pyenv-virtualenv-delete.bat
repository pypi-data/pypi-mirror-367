@echo off
setlocal
REM Windows Command Line Script (Batch) to launch "pyenv-virtualenv-delete.py".
REM
REM Dependencies:
REM   * pyenv
...
call python "%~dp0pyenv-virtualenv-delete.py" %*
set /a RC=%ERRORLEVEL%
...
:error1
echo.
echo [91mERROR    Failed to delete Python virtual environment (RC = %RC%).[0m
