...
def _get_kwargs(
  ...
  *,
  ...
  _kwargs: dict[str, Any] = {
    "method": "get",
    "url": f"/v1/{graph_id}/company/{company_id}",
    "cookies": cookies,
  }
...
def sync_detailed(
  ...
  *,
  ...
  """Get Company
   ...
   Retrieve a specific company by its identifier.

  This endpoint returns detailed information about a single company.

  Credit consumption:
  - Base cost: 0.1 credit
  - Multiplied by graph tier (standard=1x, enterprise=2x, premium=4x)
  - Cached results: Free

  Args:
      graph_id (str): Graph database identifier (e.g., 'company_123')
      company_id (str): Unique company identifier within the graph
