...
def sync_detailed(
  ...
  *,
  ...
  """List MCP Tools
   ...
   Get available Model Context Protocol tools for financial analysis.

  This endpoint returns a comprehensive list of MCP tools that can be used for:
  - Financial data analysis and reporting
  - SEC filing exploration
  - QuickBooks integration queries
  - Graph data exploration
  - Schema inspection

  Each tool includes detailed documentation about its capabilities and usage.
