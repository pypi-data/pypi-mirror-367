...
class InputstreamClient:
    ...
    async def __get_data(self, ikey:str, query:str | dict, mode:str, cache:bool, retries:int, retry_type: TYPE_OF_RETRY) -> list[dict]:
        try:
    ...
    async def find_external(self, ikey:str, dynamic_values:str | dict = {}, cache:bool=True, retries: int = 3, retry_type: TYPE_OF_RETRY = TYPE_OF_RETRY.RETRY_FROM_BEGINNING):
        """
        return data from inputstream
        params:
            ...
            retry_type: TYPE_OF_RETRY = TYPE_OF_RETRY.RETRY_FROM_BEGINNING -> type of retry to get data (from beginning or from last point of error)
        """
        mode = "find_singlethread"
