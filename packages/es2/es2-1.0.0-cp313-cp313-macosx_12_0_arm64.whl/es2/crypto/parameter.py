...
class ContextParameter:
    ...
    @eval_mode.setter
    def eval_mode(self, mode: Optional[Union[str, evi.EvalMode]] = None):
        """
        ...
        """
        if mode is None:
            mode = "RHOMBUS"  # Default to RHOMBUS if not provided
...
class IndexParameter:
    ...
    Attributes:
        index_encryption: (bool): Indicates if the encryption type is for database.
        query_encryption: (bool): Indicates if the encryption type is for query.
    """
    ...
    def encryption_type(self):
        ...
        Returns:
            evi.CipherEncryptionType: The encryption type.
        """
        if self.index_encryption and self.query_encryption:
            return "CC"
        elif self.index_encryption:
            return "PC"
        elif self.query_encryption:
            return "CP"
        else:
            raise ValueError(
                "No encryption type is set. Please set either index_encryption or query_encryption to True."
            )
    ...
    def index_encryption(self):
        ...
        Returns:
            bool: True if the encryption type is for database, False otherwise.
        """
    ...
    def index_encryption(self, index_encryption: bool):
        ...
        Args:
            index_encryption (bool): True if the encryption type is for database, False otherwise.
        """
        if index_encryption is None:
            index_encryption = True
        self._index_encryption = index_encryption
    ...
    def query_encryption(self):
        ...
        Returns:
            bool: True if the encryption type is for query, False otherwise.
        """
    ...
    def query_encryption(self, query_encryption: bool):
        ...
        if query_encryption is True:
            raise ValueError("Query encryption type cannot be True. It should be set to False.")
        self._query_encryption = query_encryption
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"  encryption_type={self.encryption_type},\n"
