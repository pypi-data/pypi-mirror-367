...
if platform.system() == "Windows":
    ...
    from vgrid.generator.settings import ISEA3H_RES_ACCURACY_DICT, ISEA4T_RES_ACCURACY_DICT
...
def latlon2h3_cli():
    ...
    res = validate_h3_resolution(args.res)

    h3_id = latlon2h3(args.lat, args.lon, res)
    print(h3_id)
...
def latlon2s2_cli():
    ...
    res = validate_s2_resolution(args.res)
    s2_token = latlon2s2(args.lat, args.lon, res)
    print(s2_token)
...
def latlon2a5_cli():
    ...
    res = validate_a5_resolution(args.res)

    a5_hex = latlon2a5(args.lat, args.lon, res)
    print(a5_hex)
...
def latlon2ease(lat, lon, res=6):
    ...
    easedggs_id = easedggs_cell["result"]["data"][0]
    return easedggs_id
