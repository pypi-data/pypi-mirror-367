...
from mindbridgeapi.generated_pydantic_model.model import (
    ApiFileMergeRequestCreateOnly,
    ApiJsonTableRead,
    CreateApiFileManagerFileFromJsonTableRequestCreateOnly,
)
...
class FileManager(BaseSet):
    ...
    def merge(
        ...
        merge_request_item = ApiFileMergeRequestCreateOnly(
    ...
    def import_from_json_table(
        ...
        request_obj = CreateApiFileManagerFileFromJsonTableRequestCreateOnly(
            engagement_id=file_manager_item.engagement_id,
