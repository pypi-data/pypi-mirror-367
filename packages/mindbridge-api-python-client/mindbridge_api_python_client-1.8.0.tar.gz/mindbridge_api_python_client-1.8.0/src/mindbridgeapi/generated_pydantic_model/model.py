...
class ApiEngagementAccountGroupCreateOnly(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
    alias: Annotated[
        Optional[str],
        Field(
...
class ApiFilterValidateRequestCreateOnly(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
...
class ApiRiskRangeBoundsCreateOnly(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
...
class ApiRiskRangesCreateOnly(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
    analysis_type_id: Annotated[
        Optional[str],
        Field(
    ...
    high: Annotated[
        Optional[ApiRiskRangeBoundsCreateOnly],
        Field(description="The high range bounds."),
    ] = None
    library_id: Annotated[
        Optional[str],
        Field(
    ...
    low: Annotated[
        Optional[ApiRiskRangeBoundsCreateOnly],
        Field(description="The low range bounds."),
    ] = None
    medium: Annotated[
        Optional[ApiRiskRangeBoundsCreateOnly],
...
class ApiWebhookCreateOnly(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
    events: Annotated[
        Optional[list[Event]],
        Field(
    ...
    status: Annotated[
        Optional[Status8], Field(description="The current status of the webhook.")
    ] = None
    technical_contact_id: Annotated[
        Optional[str],
        Field(
            alias="technicalContactId",
            description="The email address to which side channel notifications will be sent when the webhook is triggered and there is an error during sending",
        ),
    ] = None
    url: Annotated[
        Optional[str],
...
class ApiFilterConditionCreateOnly(RootModel[Optional[Any]]):
    model_config = ConfigDict(populate_by_name=True)
...
class ApiFilterGroupConditionCreateOnly(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
    conditions: Annotated[
        Optional[list[ApiFilterConditionCreateOnly]],
...
class ApiFilterCreateOnly(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
    analysis_type_id: Annotated[
        Optional[str],
        Field(
    ...
    condition: Annotated[
        Optional[ApiFilterGroupConditionCreateOnly],
        Field(
...
class ApiPopulationTagCreateOnly(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
    analysis_id: Annotated[
        Optional[str],
