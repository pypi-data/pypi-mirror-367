...
import pyprocessors_xcago_reconciliation


# -- Project information -----------------------------------------------------

project = "pyprocessors_xcago_reconciliation"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_xcago_reconciliation.__version__
release = pyprocessors_xcago_reconciliation.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_xcago_reconciliation.__file__)
