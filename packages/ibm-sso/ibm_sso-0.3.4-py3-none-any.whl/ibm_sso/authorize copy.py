...
async def get_user_avatar(uid: str, access_token: str = Depends(__get_access_token)):
    # curl -H "Authorization: Bearer access_token" \
    # -o image.jpg \
    # "https://w3-ui-unified-profile-proxy.w3-ui.dal.app.cirrus.ibm.com/up-api-proxy/v3/image/uid"

    headers = {"Authorization": f"Bearer {access_token}"}

    async with httpx.AsyncClient() as client:
        response = await client.get(AVATAR_PREFIX + uid, headers=headers)
