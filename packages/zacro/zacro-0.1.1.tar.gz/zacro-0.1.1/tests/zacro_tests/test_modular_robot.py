...
<robot xmlns:xacro="http://ros.org/wiki/xacro">
  ...
  <xacro:module prefix="module2_" parent_link="module1_end_link"/>
        ...
        result_with_joints = zacro.xacro_from_string(xml_str, remove_first_joint=False)
        joint_count_with = result_with_joints.count('<joint')

        # With remove_first_joint
        result_without_joints = zacro.xacro_from_string(xml_str, remove_first_joint=True)
...
<robot xmlns:xacro="http://ros.org/wiki/xacro">
  ...
  <xacro:arm_segment prefix="seg3_"/>
        ...
        result_with = zacro.xacro_from_string(xml_str, remove_first_joint=False)
        result_without = zacro.xacro_from_string(xml_str, remove_first_joint=True)
