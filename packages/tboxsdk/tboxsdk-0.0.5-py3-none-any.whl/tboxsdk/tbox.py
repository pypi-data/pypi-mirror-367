...
from .model.conversation import Conversation, ConversationSource, ConversationStatus
from .model.message import Message, Answer, MessageStatus, MediaType
...
class TboxClient(object):
    ...
    def chat_sync(self,
        ...
        """
        return self.chat(app_id, query, user_id, conversation_id=conversation_id, request_id=request_id, inputs=inputs,
                           client_properties=client_properties, with_meta=False, files=files, stream=False)
    ...
    def completion_sync(self,
        ...
        """
        return self.completion(app_id, user_id, conversation_id=conversation_id, request_id=request_id, inputs=inputs,
                                 client_properties=client_properties, with_meta=False, files=files, stream=False)
