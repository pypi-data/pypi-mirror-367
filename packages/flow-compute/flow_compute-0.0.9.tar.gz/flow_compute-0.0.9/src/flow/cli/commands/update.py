...
class UpdateChecker:
        ...
        try:
            ...
            if pypi_latest in data["releases"]:
                ...
                if releases and releases[0].get("yanked", False):
                    ...
                    self.latest_version = self.available_versions[0] if self.available_versions else pypi_latest
                else:
    ...
    def detect_environment(self) -> dict:
        ...
        if "uv/tools" in sys.executable:
            ...
            env_info["update_command"] = f"{sys.executable} -m pip install --upgrade {self.PACKAGE_NAME}"
...
class UpdateCommand(BaseCommand):
    ...
    def get_command(self) -> click.Command:
        ...
        def update(check: bool, force: bool, version: Optional[str], rollback: Optional[str], 
                  yes: bool, output_json: bool):
            ...
            if version:
                ...
                if output_json:
                    ...
                    console.print(f"[green]✓ You're already on the latest version ({checker.current_version})[/green]")
                return
            else:
            ...
            if output_json:
                ...
                console.print(f"[cyan]Restart your terminal or run 'flow --version' to verify[/cyan]")
                if backup_file:
    ...
    def _display_version_info(self, checker: UpdateChecker, update_available: bool, 
