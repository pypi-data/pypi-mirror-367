...
@click.group(cls=OrderedGroup, context_settings={'max_content_width': TerminalAdapter.get_terminal_width()})
...
def cli(ctx, theme, no_color, hyperlinks):
    ...
    Development:
      ...
      flow grab 64 -i h100       # 64×H100, 3.2T interconnect
    
    \b
    Training:
      flow run post-training     # Execute training pipeline
