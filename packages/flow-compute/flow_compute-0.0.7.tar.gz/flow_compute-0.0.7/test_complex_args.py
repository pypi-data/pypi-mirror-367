...
from __main__ import test_complex_args

args_data = json.loads('"{\\"args\\": [[1, 2, 3, 4, 5]], \\"kwargs\\": {\\"config\\": {\\"learning_rate\\": 0.001, \\"batch_size\\": 32}, \\"threshold\\": 0.8}}"')
args = args_data["args"]
