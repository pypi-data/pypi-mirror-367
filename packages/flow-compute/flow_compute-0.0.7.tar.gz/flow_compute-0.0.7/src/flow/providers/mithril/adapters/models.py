...
class MithrilAdapter:
    ...
    @classmethod
    def mithril_instance_to_instance(cls, mithril_instance: MithrilInstance, bid: MithrilBid) -> Instance:
    ...
    @classmethod
    def _build_status_message(cls, bid: MithrilBid, instances: Optional[List[MithrilInstance]]) -> str:
