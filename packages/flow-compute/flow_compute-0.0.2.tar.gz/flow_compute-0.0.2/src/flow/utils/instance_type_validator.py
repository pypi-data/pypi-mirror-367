...
This module provides helpers to validate and normalize instance type names
across different providers, preventing mismatches between user input and
...
class InstanceTypeValidator:
    ...
    @classmethod
    def normalize_instance_type(cls, instance_type: str, provider: Optional[str] = None) -> str:
    ...
    @classmethod
    def validate_instance_type(cls, instance_type: str, provider: Optional[str] = None) -> Tuple[bool, Optional[str]]:
    ...
    @classmethod
    def _suggest_instance_type(cls, user_input: str, known_types: Set[str]) -> Optional[str]:
    ...
    @classmethod
    def get_all_valid_types(cls, provider: Optional[str] = None) -> Set[str]:
