...
| **Best price-performance via market-based pricing** | Preemptible secure jobs for sub **\$1/H100-hr**                              | Blind two-sided second-price auction; client-side bid capping                        |
...
**How Flow's Second-Price Auction Works:**
You express your limit price; GPUs provision instantly at the fair market clearing rate.
...
| Example Bid | Clearing Price | You Pay                                                      |
| ----------- | -------------- | ------------------------------------------------------------ |
| \$3.00      | \$1.00         | \$1.00                                                       |
| \$3.00      | \$3.50 (spike) | No [allocation](https://mlfoundry.com/blog/introducing-foundry) |
...
| Workflow   | Best for                  | Startup  |
| ---------- | ------------------------- | -------- |
| `flow dev` | Interactive development   | < 5 s    |
| `flow run` | Batch / reproducible jobs | \~10 min |
| Python API | Pipelines & orchestration | \~10 min |
...
* **Rapid Experimentation** – conference sprints, weekend hunts for SOTA.
* **Instant Elasticity** – scale to thousands of GPUs, tear down in minutes.
* **Collaborative Research** – shared dev VMs with per‑task cost caps.
...
* **Multi-cloud Ready** – Mithril, Oracle, Nebius, and more
