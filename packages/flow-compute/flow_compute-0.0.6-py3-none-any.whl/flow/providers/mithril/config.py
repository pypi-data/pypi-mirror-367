...
class MithrilScriptSizeConfig:
    ...
    def from_env(cls) -> "MithrilScriptSizeConfig":
        ...
        return cls(
            ...
            enable_split_storage=os.getenv("MITHRIL_ENABLE_SPLIT_STORAGE", "true").lower() == "true",
            enable_metrics=os.getenv("MITHRIL_ENABLE_METRICS", "true").lower() == "true",
            enable_health_checks=os.getenv("MITHRIL_ENABLE_HEALTH_CHECKS", "true").lower() == "true",
            # Storage backend
            ...
            # Monitoring
            enable_detailed_logging=os.getenv("MITHRIL_DETAILED_LOGGING", "false").lower() == "true",
