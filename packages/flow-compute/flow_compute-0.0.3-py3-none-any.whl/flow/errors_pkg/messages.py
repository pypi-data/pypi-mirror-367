...
Possible reasons:
1. Instance is still starting (FCP instances can take up to {EXPECTED_PROVISION_MINUTES} minutes)
...
INSTANCE_TYPE_NOT_AVAILABLE = "Instance type '{instance_type}' is not available in region '{region}'"
...
ENV_VAR_NAME_TOO_LONG = "Environment variable name too long: {name} ({length} chars, max: {max_length})"
ENV_VAR_VALUE_TOO_LONG = "Environment variable value too long for {name} ({length} chars, max: {max_length})"
