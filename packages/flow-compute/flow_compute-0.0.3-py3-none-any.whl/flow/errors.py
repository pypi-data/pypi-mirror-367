...
class RateLimitError(APIError):
    ...
    def __init__(self, message: str, retry_after=None, **kwargs):
...
class ValidationAPIError(APIError):
    ...
    def __init__(self, response):
        ...
        super().__init__(message, status_code=422, response_body=response.text)
...
class InvalidResponseError(FlowError):
    ...
    Example:
        ...
        ...         "Check the FCP status page for ongoing incidents",
...
class ProviderError(FlowError):
    ...
    Example:
        >>> raise ProviderError(
        ...     "FCP provider requires 'project' to be configured",
        ...     suggestions=[
        ...         "Set project in flow.yaml configuration",
        ...         "Pass project parameter to Flow constructor",
        ...         "Set FCP_DEFAULT_PROJECT environment variable"
        ...     ]
        ... )
    """
    ...
    def __init__(self, name: str, resource_type: str = "resource"):
        ...
        super().__init__(
            ...
            suggestions=[
                ...
                f"Use --force-new to create with a unique suffix",
