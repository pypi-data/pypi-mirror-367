"""GPU specifications for FCP provider.

This module contains the GPU specifications used by the FCP provider.
Following the principle of provider-specific configuration, these specs
are maintained here rather than in the core module.
"""

# GPU specifications - single source of truth for FCP provider
GPU_SPECS = {
    # A100 variants
