...
class MithrilProvider(IProvider):
    ...
    def submit_task(
        ...
        try:
            ...
            raise MithrilBidError(f"Failed to create bid for task '{adjusted_config.name}': {e}") from e
    ...
    def upload_code_to_task(
        self, task_id: str, source_dir: Path | None = None, timeout: int = 600, console: Optional["Console"] = None
    ) -> None:
        ...
        # Don't print here - let the caller (dev.py) handle success messages
        # This avoids duplicate output when called from CLI commands
        logger.info(
            ...
            if isinstance(first_instance, dict):
                ...
                if instance_status:
                    ...
                    if instance_status == "STATUS_PREEMPTING":
                        ...
                        provider_metadata["state_help"] = "Mithril is finding available GPU resources for your bid."
