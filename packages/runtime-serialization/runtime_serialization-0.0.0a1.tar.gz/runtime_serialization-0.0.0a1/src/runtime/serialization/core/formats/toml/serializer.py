...
from runtime.serialization.core.formats.toml.formatter import Formatter
...
class TomlSerializer(Serializer[T]):
    ...
    def serialize(self, obj: T) -> str:
        """Serializes the object to a TOML string
...
def serialize(obj: T, base: type[T]) -> str:
    """Serializes the object to a TOML string, using the Serializer of a specific base class.
