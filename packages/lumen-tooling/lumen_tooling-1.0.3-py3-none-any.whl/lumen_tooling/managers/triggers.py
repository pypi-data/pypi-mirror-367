...
from lumen_tooling.constants import EventType, ServiceType
...
class TriggersManager:
    ...
    Google services, providing a clean interface for real-time event notifications.
    """
    ...
    async def setup(
        ...
        # Drive/Docs specific parameters
        ...
        """
        Set up webhook for Google services with service-specific configuration.

        Args:
            user_id: The unique identifier for the user
            service: The Google service (GMAIL, DRIVE, CALENDAR, DOCS)
