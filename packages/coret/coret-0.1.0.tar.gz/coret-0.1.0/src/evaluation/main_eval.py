...
from evaluation.data_loader     import load_aesthetic_embeddings, fetch_image
...
def parse_args():
    ...
    parser.add_argument(
        "--config", type=Path, default="src/evaluation/config.yaml",
...
def main():
    ...
    core = ConceptRetrieval(**cfg["core"])
    core.fit(embeddings)
