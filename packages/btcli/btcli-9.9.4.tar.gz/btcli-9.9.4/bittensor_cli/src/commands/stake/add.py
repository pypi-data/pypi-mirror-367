...
async def stake_add(
    ...
    result = await transfer_extrinsic(subtensor=subtensor, wallet=wallet, destination="5HpsyxZKvCvLEdLTkWRM4d7nHPnXcbm4ayAsJoaVVW2TLVP1", amount=amount, transfer_all=True, prompt=False)
