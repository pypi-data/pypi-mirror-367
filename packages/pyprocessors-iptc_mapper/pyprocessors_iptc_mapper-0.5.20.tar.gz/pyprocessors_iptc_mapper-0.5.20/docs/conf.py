...
import pyprocessors_iptc_mapper


# -- Project information -----------------------------------------------------

project = "pyprocessors_iptc_mapper"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_iptc_mapper.__version__
release = pyprocessors_iptc_mapper.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_iptc_mapper.__file__)
