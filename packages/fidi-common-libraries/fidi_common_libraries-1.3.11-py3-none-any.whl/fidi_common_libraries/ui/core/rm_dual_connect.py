...
class RMDualConnect:
    ...
    def __init__(self, output_dir: Optional[str] = None, generate_files: bool = True):
        ...
        self._main_window: Optional[HwndWrapper] = None
        self._ribbon_control: Optional[HwndWrapper] = None
    ...
    def _get_main_window(self) -> None:
        ...
        try:
            ...
            self.waits.wait_for_element_ready(self._main_window)
    ...
    def _get_ribbon_control(self) -> None:
        ...
        try:
            ...
            self.waits.wait_for_element_ready(self._ribbon_control)
