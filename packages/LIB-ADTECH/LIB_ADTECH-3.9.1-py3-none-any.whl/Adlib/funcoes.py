...
def coletarDadosEmail(
    ...
    def getFolderId(folderName: str, user_id: str, token: str) -> str | None:
    ...
    if "access_token" in result:
        ...
        folderId = getFolderId(pasta, USER_ID, tokenAcesso)
...
def coletarAnexosEmail(
    ...
    if "access_token" in result:
        ...
        messagesURL = (
            ...
            f"$top={n_emails}&$filter=receivedDateTime ge {datetimeFormatado}"
        )
