...
@login_decorator
def loginAmigoz(driver: Chrome, usuario: str, senha: str) -> LoginReturn:
    ...
    return checkLogin(), EnumBanco.AMIGOZ
...
def loginC6(driver: Chrome, usuario: str, senha: str) -> LoginReturn:
    ...
    def checkLogin() -> LoginReturn:
        ...
        if "Usuário já autenticado" in text:
            return LoginReturn.LOGIN_COM_SUCESSO
        if esperarElemento(driver, '//span[contains(text(), "Atualizar meus Dados Cadastrais")]', tempo_espera=3, debug=False):
