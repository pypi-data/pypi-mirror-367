...
chatIdMapping = {
    ...
    EnumProcesso.BLIP_LINK: chatIdBlipConsulta,
    EnumProcesso.BLIP_CONSULTA: chatIdBlipConsulta,
...
baseFolderMapping = {
    ...
    (EnumBanco.DAYCOVAL_CARTAO, EnumProcesso.CONFIRMACAO_CREDITO): r"Z:\Arquivos de Confirmação de Crédito\14 - Daycoval\Cartão",
    (EnumBanco.ICRED, EnumProcesso.CONFIRMACAO_CREDITO): r"Z:\Arquivos de Confirmação de Crédito\19 - Icred",
    (EnumBanco.AMIGOZ, EnumProcesso.CONFIRMACAO_CREDITO): r"Z:\Arquivos de Confirmação de Crédito\02 - AmigoZ",
