...
class ReversalPattern(ChartPattern):
    ...
    def volume_exceeds(self, volume1: float, volume2: float, is_major: bool,
                       properties: ReversalPatternProperties) -> bool:
        volume_diff_pct = properties.major_volume_diff_pct if is_major else \
    ...
    def check_volumes_head_n_shoulders(self, properties: ReversalPatternProperties) -> bool:
        ...
        return self.volume_exceeds(self.pivots[1].point.volume, self.pivots[5].point.volume, True, properties) and \
            self.volume_exceeds(self.pivots[3].point.volume, self.pivots[5].point.volume, True, properties)
    ...
    def check_volumes_inverse_head_n_shoulders(self, properties: ReversalPatternProperties) -> bool:
        ...
        return self.volume_exceeds(self.pivots[4].point.volume, self.pivots[2].point.volume, False, properties) and \
            self.volume_exceeds(self.pivots[4].point.volume, self.pivots[5].point.volume, True, properties)

    def check_volumes_3_tops(self, properties: ReversalPatternProperties) -> bool:
        # each rally peak should be on lighter volume
        return self.volume_exceeds(self.pivots[1].point.volume, self.pivots[3].point.volume, False, properties) and \
            self.volume_exceeds(self.pivots[3].point.volume, self.pivots[5].point.volume, False, properties)
    ...
    def check_volumes_3_bottoms(self, properties: ReversalPatternProperties) -> bool:
        ...
        return self.volume_exceeds(self.pivots[1].point.volume, self.pivots[3].point.volume, False, properties) and \
            self.volume_exceeds(self.pivots[4].point.volume, self.pivots[2].point.volume, False, properties) and \
            self.volume_exceeds(self.pivots[4].point.volume, self.pivots[5].point.volume, True, properties)
    ...
    def check_volumes_2_tops(self, properties: ReversalPatternProperties) -> bool:
        ...
        return self.volume_exceeds(self.pivots[1].point.volume, self.pivots[3].point.volume, False, properties)
    ...
    def check_volumes_2_bottoms(self, properties: ReversalPatternProperties) -> bool:
        ...
        return self.volume_exceeds(self.pivots[2].point.volume, self.pivots[3].point.volume, True, properties) and \
            self.volume_exceeds(self.pivots[1].point.volume, self.pivots[3].point.volume, False, properties)
