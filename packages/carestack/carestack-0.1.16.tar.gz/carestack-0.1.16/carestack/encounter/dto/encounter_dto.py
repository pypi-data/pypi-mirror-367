...
class EncounterRequestDTO(BaseModel):
    ...
    patient_details: Optional[PatientDetails] = Field(
        ..., alias="patientDetails", description="Patient's information."
    )
    doctor_details: Optional[list[DoctorDetails]] = Field(
        ..., alias="doctorDetails", description="Doctor's information."
    )
