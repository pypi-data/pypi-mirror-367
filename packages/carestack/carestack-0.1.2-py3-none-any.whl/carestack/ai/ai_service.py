...
class AiService(BaseService):
    ...
    async def generate_discharge_summary(
        ...
        ### Args:
            process_ds_data (dict): (`ProcessDSDto`) containing required inputs for processing the discharge summary.Expected keys include:
    ...
    async def generate_fhir_bundle(
        ...
        """
        Generate a FHIR bundle using AI based on the provided clinical case data.
