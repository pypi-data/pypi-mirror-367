...
import pyprocessors_segment_renseignor


# -- Project information -----------------------------------------------------

project = "pyprocessors_segment_renseignor"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_segment_renseignor.__version__
release = pyprocessors_segment_renseignor.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_segment_renseignor.__file__)
