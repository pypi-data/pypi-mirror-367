...
class ResourceClient(Client):
    ...
    async def get_resource_proof_profiles(
        self,
        query_arguments: resource_queries.GetResourceProofProfilesQuery,
        domain_name: str,
        ...
        try:
            resp_model = resource_schemas.PageResourceProofProfile.model_validate(
                resp.json()
            )
        except pydantic_core.ValidationError:
            raise EnsureException(
    ...
    async def create_resource_proof_profile(
        ...
        resp = await self.post(
            f"/v1/domains/{domain_name}/resource_proofs/profiles/",
            data=str(createresourceproofprofilerequest)
            if not issubclass(type(createresourceproofprofilerequest), BaseModel)
            else createresourceproofprofilerequest.model_dump_json(),  # type: ignore
            params=path_params,
        )

        try:
            resp_model = resource_schemas.ResourceProofProfile.model_validate(
                resp.json()
            )
        except pydantic_core.ValidationError:
            raise EnsureException(
    ...
    async def update_resource_proof_profile(
        ...
        resp = await self.put(
            f"/v1/domains/{domain_name}/resource_proofs/profiles/{profile_id}",
            data=str(updateresourceproofprofilerequest)
            if not issubclass(type(updateresourceproofprofilerequest), BaseModel)
            else updateresourceproofprofilerequest.model_dump_json(),  # type: ignore
            params=path_params,
        )
    ...
    async def update_resource_proof_task(
        ...
        resp = await self.put(
            f"/v1/domains/{domain_name}/resource_proofs/{uid}/tasks/{task_id}",
            data=str(updateresourceprooftask)
            if not issubclass(type(updateresourceprooftask), BaseModel)
            else updateresourceprooftask.model_dump_json(),  # type: ignore
            params=path_params,
        )
    ...
    async def get_resource_proof_tasks(
        self,
        query_arguments: resource_queries.GetResourceProofTasksQuery,
        uid: str,
        domain_name: str,
        ...
        try:
            resp_model = resource_schemas.PageResourceProofTask.model_validate(
                resp.json()
            )
        except pydantic_core.ValidationError:
            raise EnsureException(
    ...
    async def get_resource_proofs(
        self,
        query_arguments: resource_queries.GetResourceProofsQuery,
        domain_name: str,
    ...
    async def publish_resource_proof(
        ...
        resp = await self.post(
            f"/v1/domains/{domain_name}/resource_proofs/",
            data=str(createresourceproofrequest)
            if not issubclass(type(createresourceproofrequest), BaseModel)
            else createresourceproofrequest.model_dump_json(),  # type: ignore
            params=path_params,
        )
    ...
    async def get_resource_proof(
        ...
        resp = await self.get(
            f"/v1/domains/{domain_name}/resource_proofs/{uid}", params=path_params
        )
    ...
    async def set_resource_proof_tree(
        ...
        resp = await self.put(
            ...
            data=str(updateresourceproofrequest)
            if not issubclass(type(updateresourceproofrequest), BaseModel)
            else updateresourceproofrequest.model_dump_json(),  # type: ignore
            params=path_params,
        )
    ...
    async def get_resource_proof_event(
        ...
        try:
            resp_model = resource_schemas.ResourceProofEventModel.model_validate(
                resp.json()
            )
        except pydantic_core.ValidationError:
            raise EnsureException(
    ...
    async def get_resource_proof_events(
        self,
        query_arguments: resource_queries.GetResourceProofEventsQuery,
        domain_name: str,
        ...
        try:
            resp_model = resource_schemas.PageResourceProofEventModel.model_validate(
                resp.json()
            )
        except pydantic_core.ValidationError:
            raise EnsureException(
    ...
    async def get_org_resource_proof_profiles(
        self,
        query_arguments: resource_queries.GetOrgResourceProofProfilesQuery,
        domain_name: str,
        organisation_name: str,
    ) -> resource_schemas.PageResourceProofProfile:
        """ """
    ...
    async def get_org_resource_proof_tasks(
        self,
        query_arguments: resource_queries.GetOrgResourceProofTasksQuery,
        uid: str,
        domain_name: str,
        organisation_name: str,
    ) -> resource_schemas.PageResourceProofTask:
    ...
    async def get_org_resource_proofs(
        self,
        query_arguments: resource_queries.GetOrgResourceProofsQuery,
        domain_name: str,
        organisation_name: str,
    ) -> resource_schemas.PageResourceProof:
        """ """
    ...
    async def get_org_resource_proof_events(
        self,
        query_arguments: resource_queries.GetOrgResourceProofEventsQuery,
        domain_name: str,
        organisation_name: str,
    ) -> resource_schemas.PageResourceProofEventModel:
        """ """
    ...
    async def get_domain_configuration(
        ...
        resp = await self.get(
            f"/v1/domains/{domain_name}/configuration/", params=path_params
        )
