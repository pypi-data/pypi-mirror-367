...
class AgentBox(ABC):
    ...
    async def ainvoke(self, agent_input: Any) -> AgentOutput | JSONResponse:
    ...
    def stream(self, agent_input: Any) -> StreamingResponse:
    ...
    async def astream(self, agent_input: Any) -> StreamingResponse:
