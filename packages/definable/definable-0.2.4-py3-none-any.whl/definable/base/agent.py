...
from definable.base.models import AgentInfo, AgentOutput
...
class AgentBox(ABC):
    ...
    def invoke(self, agent_input: Any) -> Union[AgentOutput, JSONResponse]:
        ...
        """
        raise NotImplementedError("Agent must implement at least one of: invoke, ainvoke, stream, or astream")
