...
def _activate_venv() -> None:
    ...
    if site_packages.exists():
        ...
        click.echo(f"Virtual environment activated (site-packages: {site_packages})")
    else:
        click.echo(f"Warning: Could not find site-packages in virtual environment (looked at: {site_packages})")
