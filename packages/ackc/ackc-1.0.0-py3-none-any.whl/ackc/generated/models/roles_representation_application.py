...
T = TypeVar("T", bound="RolesRepresentationApplication")



@_attrs_define
class RolesRepresentationApplication:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.role_representation import RoleRepresentation
        d = dict(src_dict)
        roles_representation_application = cls(
        )
        ...
        roles_representation_application.additional_properties = additional_properties
        return roles_representation_application
