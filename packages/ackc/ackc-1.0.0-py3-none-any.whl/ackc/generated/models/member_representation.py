...
if TYPE_CHECKING:
  from ..models.member_representation_access import MemberRepresentationAccess
  from ..models.user_profile_metadata import UserProfileMetadata
  from ..models.member_representation_client_roles import MemberRepresentationClientRoles
  from ..models.federated_identity_representation import FederatedIdentityRepresentation
  from ..models.member_representation_application_roles import MemberRepresentationApplicationRoles
  from ..models.member_representation_attributes import MemberRepresentationAttributes
...
T = TypeVar("T", bound="MemberRepresentation")
...
class MemberRepresentation:
    """ 
        Attributes:
            ...
            attributes (Union[Unset, MemberRepresentationAttributes]):
            ...
            client_roles (Union[Unset, MemberRepresentationClientRoles]):
            client_consents (Union[Unset, list['UserConsentRepresentation']]):
            not_before (Union[Unset, int]):
            application_roles (Union[Unset, MemberRepresentationApplicationRoles]):
            social_links (Union[Unset, list['SocialLinkRepresentation']]):
            groups (Union[Unset, list[str]]):
            access (Union[Unset, MemberRepresentationAccess]):
            membership_type (Union[Unset, MembershipType]):
     """
    ...
    attributes: Union[Unset, 'MemberRepresentationAttributes'] = UNSET
    ...
    client_roles: Union[Unset, 'MemberRepresentationClientRoles'] = UNSET
    client_consents: Union[Unset, list['UserConsentRepresentation']] = UNSET
    not_before: Union[Unset, int] = UNSET
    application_roles: Union[Unset, 'MemberRepresentationApplicationRoles'] = UNSET
    social_links: Union[Unset, list['SocialLinkRepresentation']] = UNSET
    groups: Union[Unset, list[str]] = UNSET
    access: Union[Unset, 'MemberRepresentationAccess'] = UNSET
    membership_type: Union[Unset, MembershipType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes,  Unset):
            ...
            attributes = MemberRepresentationAttributes.from_dict(_attributes)
        ...
        if isinstance(_client_roles,  Unset):
            ...
            client_roles = MemberRepresentationClientRoles.from_dict(_client_roles)
        ...
        if isinstance(_application_roles,  Unset):
            ...
            application_roles = MemberRepresentationApplicationRoles.from_dict(_application_roles)
        ...
        if isinstance(_access,  Unset):
            ...
            access = MemberRepresentationAccess.from_dict(_access)
        ...
        member_representation.additional_properties = d
        return member_representation
