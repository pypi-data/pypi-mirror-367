...
class IDToken:
    """ 
        Attributes:
            ...
            typ (Union[Unset, str]):
            azp (Union[Unset, str]):
            other_claims (Union[Unset, IDTokenOtherClaims]):
    ...
    other_claims: Union[Unset, 'IDTokenOtherClaims'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_other_claims,  Unset):
            ...
            other_claims = IDTokenOtherClaims.from_dict(_other_claims)
        ...
        id_token.additional_properties = d
        return id_token
