...
from ...models.client_initial_access_presentation import ClientInitialAccessPresentation
...
def _parse_response(*, client: AuthenticatedClient | Client, response: niquests.Response) -> list['ClientInitialAccessPresentation'] | None:
    if response.status_code == 200:
        ...
        for response_200_item_data in (_response_200):
            response_200_item = ClientInitialAccessPresentation.from_dict(response_200_item_data)
...
) -> Response[list['ClientInitialAccessPresentation']]:
    """ 
    Args:
        realm (str):
