...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/clients/{client_uuid}/authz/resource-server/resource/{resource_id}/attributes".format(realm=realm,client_uuid=client_uuid,resource_id=resource_id,),
        "params": params,
    }
