...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/clients/{client_uuid}/authz/resource-server/scope/{scope_id}/permissions".format(realm=realm,client_uuid=client_uuid,scope_id=scope_id,),
    }
