...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/client-scopes/{client_scope_id}/protocol-mappers/protocol/{protocol}".format(realm=realm,client_scope_id=client_scope_id,protocol=protocol,),
    }
