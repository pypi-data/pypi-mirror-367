...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/admin/realms/{realm}/clients/{client_uuid}/optional-client-scopes/{client_scope_id}".format(realm=realm,client_uuid=client_uuid,client_scope_id=client_scope_id,),
    }
