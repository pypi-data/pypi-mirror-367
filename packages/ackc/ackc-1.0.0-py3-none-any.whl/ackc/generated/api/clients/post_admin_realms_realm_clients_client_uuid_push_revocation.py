...
from ...models.global_request_result import GlobalRequestResult
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/realms/{realm}/clients/{client_uuid}/push-revocation".format(realm=realm,client_uuid=client_uuid,),
    }
...
) -> Response[GlobalRequestResult]:
    """ Push the client's revocation policy to its admin URL If the client has an admin URL, push revocation
    policy to it.
