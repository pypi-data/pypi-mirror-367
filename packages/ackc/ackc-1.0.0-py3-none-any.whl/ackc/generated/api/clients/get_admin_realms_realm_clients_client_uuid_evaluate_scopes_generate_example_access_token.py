...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/clients/{client_uuid}/evaluate-scopes/generate-example-access-token".format(realm=realm,client_uuid=client_uuid,),
        "params": params,
    }
...
) -> Response[Union[AccessToken, Any]]:
