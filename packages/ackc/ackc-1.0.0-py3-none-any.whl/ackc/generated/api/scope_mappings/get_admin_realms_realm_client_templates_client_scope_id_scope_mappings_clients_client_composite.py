...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/client-templates/{client_scope_id}/scope-mappings/clients/{client_path}/composite".format(realm=realm,client_scope_id=client_scope_id,client_path=client_path,),
        "params": params,
    }
