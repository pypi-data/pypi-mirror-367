...
if TYPE_CHECKING:
  ...
  from ..models.application_representation_attributes import ApplicationRepresentationAttributes
  from ..models.application_representation_access import ApplicationRepresentationAccess
  from ..models.application_representation_registered_nodes import ApplicationRepresentationRegisteredNodes
  from ..models.application_representation_authentication_flow_binding_overrides import ApplicationRepresentationAuthenticationFlowBindingOverrides
...
T = TypeVar("T", bound="ApplicationRepresentation")
...
class ApplicationRepresentation:
    """ 
        Attributes:
            ...
            attributes (Union[Unset, ApplicationRepresentationAttributes]):
            authentication_flow_binding_overrides (Union[Unset,
            ...
            registered_nodes (Union[Unset, ApplicationRepresentationRegisteredNodes]):
            ...
            access (Union[Unset, ApplicationRepresentationAccess]):
            origin (Union[Unset, str]):
            name (Union[Unset, str]):
            claims (Union[Unset, ClaimRepresentation]):
     """
    ...
    attributes: Union[Unset, 'ApplicationRepresentationAttributes'] = UNSET
    authentication_flow_binding_overrides: Union[Unset, 'ApplicationRepresentationAuthenticationFlowBindingOverrides'] = UNSET
    full_scope_allowed: Union[Unset, bool] = UNSET
    node_re_registration_timeout: Union[Unset, int] = UNSET
    registered_nodes: Union[Unset, 'ApplicationRepresentationRegisteredNodes'] = UNSET
    ...
    access: Union[Unset, 'ApplicationRepresentationAccess'] = UNSET
    origin: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    claims: Union[Unset, 'ClaimRepresentation'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes,  Unset):
            ...
            attributes = ApplicationRepresentationAttributes.from_dict(_attributes)




        _authentication_flow_binding_overrides = d.pop("authenticationFlowBindingOverrides", UNSET)
        authentication_flow_binding_overrides: Union[Unset, ApplicationRepresentationAuthenticationFlowBindingOverrides]
        if isinstance(_authentication_flow_binding_overrides,  Unset):
            authentication_flow_binding_overrides = UNSET
        else:
            authentication_flow_binding_overrides = ApplicationRepresentationAuthenticationFlowBindingOverrides.from_dict(_authentication_flow_binding_overrides)
        ...
        if isinstance(_registered_nodes,  Unset):
            ...
            registered_nodes = ApplicationRepresentationRegisteredNodes.from_dict(_registered_nodes)
        ...
        if isinstance(_access,  Unset):
            ...
            access = ApplicationRepresentationAccess.from_dict(_access)
        ...
        if isinstance(_claims,  Unset):
            ...
            claims = ClaimRepresentation.from_dict(_claims)




        application_representation = cls(
            id=id,
            client_id=client_id,
        ...
        application_representation.additional_properties = d
        return application_representation
