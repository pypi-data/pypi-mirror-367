...
T = TypeVar("T", bound="RealmRepresentationClientScopeMappings")



@_attrs_define
class RealmRepresentationClientScopeMappings:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.scope_mapping_representation import ScopeMappingRepresentation
        d = dict(src_dict)
        realm_representation_client_scope_mappings = cls(
        )
        ...
        realm_representation_client_scope_mappings.additional_properties = additional_properties
        return realm_representation_client_scope_mappings
