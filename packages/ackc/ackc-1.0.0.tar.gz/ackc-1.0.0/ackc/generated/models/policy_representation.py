...
if TYPE_CHECKING:
  ...
  from ..models.policy_representation_config import PolicyRepresentationConfig





T = TypeVar("T", bound="PolicyRepresentation")
...
class PolicyRepresentation:
    """ 
        Attributes:
            ...
            config (Union[Unset, PolicyRepresentationConfig]):
     """
    ...
    config: Union[Unset, 'PolicyRepresentationConfig'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_config,  Unset):
            ...
            config = PolicyRepresentationConfig.from_dict(_config)




        policy_representation = cls(
            id=id,
            name=name,
        ...
        policy_representation.additional_properties = d
        return policy_representation
