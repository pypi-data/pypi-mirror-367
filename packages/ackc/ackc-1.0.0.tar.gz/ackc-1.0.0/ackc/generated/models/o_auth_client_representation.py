...
T = TypeVar("T", bound="OAuthClientRepresentation")
...
class OAuthClientRepresentation:
    """ 
        Attributes:
            ...
            attributes (Union[Unset, OAuthClientRepresentationAttributes]):
            ...
            registered_nodes (Union[Unset, OAuthClientRepresentationRegisteredNodes]):
            ...
            access (Union[Unset, OAuthClientRepresentationAccess]):
    ...
    attributes: Union[Unset, 'OAuthClientRepresentationAttributes'] = UNSET
    authentication_flow_binding_overrides: Union[Unset, 'OAuthClientRepresentationAuthenticationFlowBindingOverrides'] = UNSET
    full_scope_allowed: Union[Unset, bool] = UNSET
    node_re_registration_timeout: Union[Unset, int] = UNSET
    registered_nodes: Union[Unset, 'OAuthClientRepresentationRegisteredNodes'] = UNSET
    ...
    access: Union[Unset, 'OAuthClientRepresentationAccess'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes,  Unset):
            ...
            attributes = OAuthClientRepresentationAttributes.from_dict(_attributes)




        _authentication_flow_binding_overrides = d.pop("authenticationFlowBindingOverrides", UNSET)
        authentication_flow_binding_overrides: Union[Unset, OAuthClientRepresentationAuthenticationFlowBindingOverrides]
        if isinstance(_authentication_flow_binding_overrides,  Unset):
            authentication_flow_binding_overrides = UNSET
        else:
            authentication_flow_binding_overrides = OAuthClientRepresentationAuthenticationFlowBindingOverrides.from_dict(_authentication_flow_binding_overrides)
        ...
        if isinstance(_registered_nodes,  Unset):
            ...
            registered_nodes = OAuthClientRepresentationRegisteredNodes.from_dict(_registered_nodes)
        ...
        if isinstance(_access,  Unset):
            ...
            access = OAuthClientRepresentationAccess.from_dict(_access)
        ...
        o_auth_client_representation = cls(
            id=id,
            client_id=client_id,
        ...
        o_auth_client_representation.additional_properties = d
        return o_auth_client_representation
