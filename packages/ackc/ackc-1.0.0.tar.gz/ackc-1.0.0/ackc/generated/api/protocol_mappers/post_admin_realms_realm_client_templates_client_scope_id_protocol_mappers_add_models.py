...
def _get_kwargs(
    ...
    client_scope_id: str,
    *,
    body: list['ProtocolMapperRepresentation'],
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/realms/{realm}/client-templates/{client_scope_id}/protocol-mappers/add-models".format(realm=realm,client_scope_id=client_scope_id,),
    }
