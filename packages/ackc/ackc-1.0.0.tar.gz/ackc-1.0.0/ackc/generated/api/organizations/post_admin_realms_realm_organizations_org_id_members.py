...
def sync_detailed(
    ...
    *,
    ...
    """ Adds the user with the specified id as a member of the organization
     ...
     Adds, or associates, an existing user with the organization. If no user is found, or if it is
    already associated with the organization, an error response is returned
