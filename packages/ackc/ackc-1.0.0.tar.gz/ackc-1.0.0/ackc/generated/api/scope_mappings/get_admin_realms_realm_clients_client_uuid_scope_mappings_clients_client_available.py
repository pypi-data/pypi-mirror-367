...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/clients/{client_uuid}/scope-mappings/clients/{client_path}/available".format(realm=realm,client_uuid=client_uuid,client_path=client_path,),
    }
