...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/client-scopes/{client_scope_id}/scope-mappings/clients/{client_path}/available".format(realm=realm,client_scope_id=client_scope_id,client_path=client_path,),
    }
