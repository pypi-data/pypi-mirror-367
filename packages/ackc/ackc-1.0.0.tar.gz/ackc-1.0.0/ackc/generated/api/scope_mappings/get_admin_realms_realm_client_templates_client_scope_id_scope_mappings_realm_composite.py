...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/client-templates/{client_scope_id}/scope-mappings/realm/composite".format(realm=realm,client_scope_id=client_scope_id,),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    composite roles associated with the client’s scope and adds the roles to this lists.
     ...
     The method is really to show a comprehensive total view of realm-level roles associated with the
    client.
