...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/realms/{realm}/client-templates/{client_scope_id}/scope-mappings/clients/{client_path}/available".format(realm=realm,client_scope_id=client_scope_id,client_path=client_path,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ The available client-level roles Returns the roles for the client that can be associated with the
    client's scope
