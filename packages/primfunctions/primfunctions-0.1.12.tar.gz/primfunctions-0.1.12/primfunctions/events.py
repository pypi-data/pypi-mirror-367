...
class TextToSpeechEvent(Event):
    def __init__(self, text: str, voice="nova", cache=True, interruptable=True, instructions="", speed=1.0):
        super().__init__(
            "text_to_speech",
            {
                "text": text,
...
class STTUpdateSettingsEvent(Event):
    def __init__(self, language: str = None, prompt: str = None, endpointing: int = None):
        super().__init__(
            "stt_update_settings",
            {
                "language": language,
