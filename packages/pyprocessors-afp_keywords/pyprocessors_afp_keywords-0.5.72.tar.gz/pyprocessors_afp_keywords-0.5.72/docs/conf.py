...
import pyprocessors_afp_keywords


# -- Project information -----------------------------------------------------

project = "pyprocessors_afp_keywords"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_afp_keywords.__version__
release = pyprocessors_afp_keywords.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_afp_keywords.__file__)
