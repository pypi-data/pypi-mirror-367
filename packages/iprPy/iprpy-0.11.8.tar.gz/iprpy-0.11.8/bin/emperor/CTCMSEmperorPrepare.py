...
class CTCMSEmperorPrepare(BaseEmperorPrepare):
    ...
    def build_prepare_pool(self):
        ...
        self.prepare_pool[19] = self.prepare_pool_19
    ...
    def prepare_pool_18(self, debug: bool = False, **kwargs):
        """
        Pool #18: viscosity liquid calculations
    ...
    def prepare_pool_19(self, debug: bool = False, **kwargs):
        """
        Pool #19: elastic constants dynamic
