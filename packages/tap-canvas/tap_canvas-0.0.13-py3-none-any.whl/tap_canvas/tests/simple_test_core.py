...
def test_stream_discovery():
    ...
    # Check that some expected streams are present
    stream_names = [stream.name for stream in streams]
    print(f"Found streams: {stream_names}")  # Debug output
    
    # Just verify we have streams, don't check for specific ones
...
def test_capabilities():
    ...
    # The SDK should provide default capabilities
    ...
    print(f"Found capabilities: {capabilities}")  # Debug output
