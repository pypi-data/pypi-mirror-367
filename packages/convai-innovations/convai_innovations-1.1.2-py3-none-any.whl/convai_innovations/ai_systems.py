...
class LLMAIFeedbackSystem:
    """Enhanced LLM system with Argostranslate (2025 optimized)"""
...
Don't tell about the next session or task, just focus on the current one./no_think"""
...
Keep code concise but educational. Focus on the core concept being asked about./no_think"""
    ...
    def initial_session_message(self, session_id: str, language: Language = Language.ENGLISH) -> str:
        ...
        system_prompt = """You are Sandra, an LLM training mentor. Give a warm welcome and encourage manual typing practice. Be brief (1-2 sentences) and encouraging./no_think"""
