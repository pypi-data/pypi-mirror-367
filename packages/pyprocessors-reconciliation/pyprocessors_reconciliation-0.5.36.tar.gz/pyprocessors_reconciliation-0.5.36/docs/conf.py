...
import pyprocessors_reconciliation


# -- Project information -----------------------------------------------------

project = "pyprocessors_reconciliation"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_reconciliation.__version__
release = pyprocessors_reconciliation.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_reconciliation.__file__)
