...
class UserService(t.Generic[_ClientT]):
    ...
    def get_coupon_usages(
        ...
        *,
        user_id: int,
        page_size: int = 20,
    ) -> paginated.Response[t.Union[TenantCouponUsage, CourseCouponUsage]]:
    ...
    def get_transactions(
        ...
        *,
        user_id: int,
        page_size: int = 20,
    ) -> paginated.Response[Transaction]:
        ...
        def parse_response(resp: httpx.Response) -> t.Sequence[Transaction]:
            if utils.response_code_matches(resp.status_code, 200):
                from ..models.transaction import Transaction
