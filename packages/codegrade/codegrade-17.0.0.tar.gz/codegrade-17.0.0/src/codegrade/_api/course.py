...
class CourseService(t.Generic[_ClientT]):
    ...
    def get_assignments(
        ...
        *,
        ...
        params: t.Dict[str, t.Any] = {
            "has_rubric": utils.to_dict(has_rubric),
            "has_auto_test": utils.to_dict(has_auto_test),
            "has_handin_requirements": utils.to_dict(has_handin_requirements),
            "q": utils.to_dict(q),
        }
        maybe_from_nullable(t.cast(t.Any, division_parent_id)).if_just(
            lambda val: params.__setitem__("division_parent_id", val)
        )
        maybe_from_nullable(t.cast(t.Any, group_set_id)).if_just(
            lambda val: params.__setitem__("group_set_id", val)
        )
