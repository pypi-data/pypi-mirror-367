...
class MainFileGenerator:
    ...
    def generate(self) -> str:
        ...
        prod_template_name, dev_template_name = self.select_template()
        ...
        context = {
            ...
            "responses_import_path": pm.config.responses_import_path,
        ...
        # Escribir archivo
        prod_output_path = Path(self.output_dir) / "__main__.py"
        prod_output_path.parent.mkdir(parents=True, exist_ok=True)

        dev_output_path = Path(self.output_dir) / "__dev__.py"
    ...
    def select_template(self) -> tuple[str, str]:
        ...
        if has_auth and has_routers:
            ...
            prod_template = "__main__generate.py.j2"  # Solo routers generados
        else:
            prod_template = "__main__init.py.j2"  # Solo básico
        ...
        return prod_template, dev_template