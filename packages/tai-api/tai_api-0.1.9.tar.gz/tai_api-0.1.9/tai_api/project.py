...
class ProjectConfig:
    ...
    @property
    def responses_namespace(self) -> Path:
        """Retorna el namespace para respuestas"""
        return Path(self.namespace) / self.subnamespace / "responses"
    ...
    @property
    def responses_import_path(self) -> str:
        """Retorna la ruta de importación para respuestas"""
        return f"{self.subnamespace}.responses"
