...
def create_server(lackey_dir_path: str = ".lackey") -> FastMCP:
    ...
    logger.info(f"Lackey MCP server initialized with lackey dir: {lackey_dir_path}")
    return mcp_server
...
@mcp_server.tool()
@mcp_rate_limit(rule_name="lenient")  # More lenient for read operations
