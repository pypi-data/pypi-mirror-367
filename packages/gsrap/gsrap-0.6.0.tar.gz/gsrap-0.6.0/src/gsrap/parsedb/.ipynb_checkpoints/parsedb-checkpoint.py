...
def main(args, logger):
    ...
    df_G = grow_on_media(logger, universe, dbexp, 'M9,M9an,M9photo', '-', True)
    ...
    df_E = precursors_on_media(logger, universe, universe, dbexp, 'M9,M9an,M9photo', cond_col_dict, args.precursors)
    if type(df_E)==int: return 1

    # check blocked metabolites / dead-ends
    df_S = biosynthesis_on_media(logger, universe, dbexp, 'M9,M9an,M9photo', args.biosynth)
