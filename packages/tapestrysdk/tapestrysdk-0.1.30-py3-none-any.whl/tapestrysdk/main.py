...
def change_tapestry_details(token, tapestry_id, temperature, top_p, alpha, model, embedded, limit, prompt, web_prompt, group_prompt, chunks, overlap, boundry_regex, name):
