...
def ask_ai_question(token, question, tapestry_id, session_id=None, group_ids=None, document_name=None):
    url = "http://localhost:8951/admin/ask_ai_question"
    headers = {
        "accept": "application/json, text/plain, */*",
        "authorization": f"Bearer {token}",
        "content-type": "application/json",
...
def search_group(token, tapestry_id, search=None):
    url = "http://localhost:8951/admin/search_group"
    headers = {
        "accept": "application/json, text/plain, */*",
        "authorization": f"Bearer {token}",
        "content-type": "application/json",
