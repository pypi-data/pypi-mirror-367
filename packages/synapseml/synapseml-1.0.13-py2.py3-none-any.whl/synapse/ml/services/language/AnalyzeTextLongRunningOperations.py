...
class AnalyzeTextLongRunningOperations(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeTextLongRunningOperations_ba5a29733a5a_error",
        ...
        outputCol="AnalyzeTextLongRunningOperations_ba5a29733a5a_output",
        overlapPolicy=None,
        ...
        self._setDefault(errorCol="AnalyzeTextLongRunningOperations_ba5a29733a5a_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeTextLongRunningOperations_ba5a29733a5a_output")
