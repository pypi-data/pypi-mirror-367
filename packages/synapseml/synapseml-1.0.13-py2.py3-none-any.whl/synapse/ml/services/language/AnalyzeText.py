...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_0c29b3d7c1d3_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_0c29b3d7c1d3_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_0c29b3d7c1d3_error")
        self._setDefault(outputCol="AnalyzeText_0c29b3d7c1d3_output")
