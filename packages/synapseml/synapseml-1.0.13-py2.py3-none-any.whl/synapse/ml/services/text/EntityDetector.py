...
class EntityDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="EntityDetector_a8b2ac88255b_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="EntityDetector_a8b2ac88255b_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="EntityDetector_a8b2ac88255b_error")
        self._setDefault(outputCol="EntityDetector_a8b2ac88255b_output")
