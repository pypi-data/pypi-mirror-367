...
class KeyPhraseExtractor(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="KeyPhraseExtractor_b92f3e48627a_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="KeyPhraseExtractor_b92f3e48627a_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="KeyPhraseExtractor_b92f3e48627a_error")
        self._setDefault(outputCol="KeyPhraseExtractor_b92f3e48627a_output")
