...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_eaac1362a4b8_error",
        ...
        outputCol="TextAnalyze_eaac1362a4b8_output",
        ...
        self._setDefault(errorCol="TextAnalyze_eaac1362a4b8_error")
        ...
        self._setDefault(outputCol="TextAnalyze_eaac1362a4b8_output")
