...
class LanguageDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="LanguageDetector_290830c2f0b5_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="LanguageDetector_290830c2f0b5_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="LanguageDetector_290830c2f0b5_error")
        self._setDefault(outputCol="LanguageDetector_290830c2f0b5_output")
