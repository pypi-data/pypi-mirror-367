...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_681d996fc5d7_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_681d996fc5d7_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_681d996fc5d7_error")
        self._setDefault(outputCol="NER_681d996fc5d7_output")
