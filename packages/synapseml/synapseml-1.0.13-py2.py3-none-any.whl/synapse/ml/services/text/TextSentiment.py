...
class TextSentiment(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextSentiment_0a5bde307523_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        ...
        outputCol="TextSentiment_0a5bde307523_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="TextSentiment_0a5bde307523_error")
        self._setDefault(outputCol="TextSentiment_0a5bde307523_output")
