...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_0509d1c3480b_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_0509d1c3480b_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_0509d1c3480b_error")
        self._setDefault(outputCol="PII_0509d1c3480b_output")
