...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="IdentifyFaces_24f351214ff4_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_24f351214ff4_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_24f351214ff4_error")
        self._setDefault(outputCol="IdentifyFaces_24f351214ff4_output")
