...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectFace_084b19a52680_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_084b19a52680_output",
        ...
        self._setDefault(errorCol="DetectFace_084b19a52680_error")
        self._setDefault(outputCol="DetectFace_084b19a52680_output")
