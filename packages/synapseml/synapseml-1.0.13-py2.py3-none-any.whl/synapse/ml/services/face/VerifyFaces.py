...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="VerifyFaces_95df9461f297_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_95df9461f297_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_95df9461f297_error")
        self._setDefault(outputCol="VerifyFaces_95df9461f297_output")
