...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="FindSimilarFace_20a14428eae5_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_20a14428eae5_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_20a14428eae5_error")
        self._setDefault(outputCol="FindSimilarFace_20a14428eae5_output")
