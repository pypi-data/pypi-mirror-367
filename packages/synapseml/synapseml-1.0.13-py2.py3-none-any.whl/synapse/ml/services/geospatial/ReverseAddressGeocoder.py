...
class ReverseAddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ReverseAddressGeocoder_af4ec72a0198_error",
        ...
        outputCol="ReverseAddressGeocoder_af4ec72a0198_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="ReverseAddressGeocoder_af4ec72a0198_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="ReverseAddressGeocoder_af4ec72a0198_output")
