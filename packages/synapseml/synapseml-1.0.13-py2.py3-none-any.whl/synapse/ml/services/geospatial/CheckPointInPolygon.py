...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_fd6ba5705d38_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_fd6ba5705d38_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_fd6ba5705d38_error")
        self._setDefault(outputCol="CheckPointInPolygon_fd6ba5705d38_output")
