...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_7895afeed78a_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_7895afeed78a_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_7895afeed78a_error")
        self._setDefault(outputCol="OpenAIChatCompletion_7895afeed78a_output")
