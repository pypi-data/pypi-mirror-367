...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        dimensions=None,
        dimensionsCol=None,
        errorCol="OpenAIEmbedding_9cf9fbd9ff22_error",
        handler=None,
        outputCol="OpenAIEmbedding_9cf9fbd9ff22_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_9cf9fbd9ff22_error")
        self._setDefault(outputCol="OpenAIEmbedding_9cf9fbd9ff22_output")
