...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_eb539b677cde_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_eb539b677cde_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_eb539b677cde_error")
        self._setDefault(outputCol="OpenAICompletion_eb539b677cde_output")
