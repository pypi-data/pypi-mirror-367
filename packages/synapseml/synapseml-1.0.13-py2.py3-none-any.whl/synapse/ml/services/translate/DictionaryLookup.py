...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryLookup_6b8213abf4cc_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_6b8213abf4cc_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_6b8213abf4cc_error")
        self._setDefault(outputCol="DictionaryLookup_6b8213abf4cc_output")
