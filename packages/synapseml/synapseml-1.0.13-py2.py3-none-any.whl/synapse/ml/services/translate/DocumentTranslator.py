...
class DocumentTranslator(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DocumentTranslator_180ea22c0808_error",
        filterPrefix=None,
        ...
        outputCol="DocumentTranslator_180ea22c0808_output",
        pollingDelay=300,
        serviceName=None,
        sourceLanguage=None,
        ...
        self._setDefault(errorCol="DocumentTranslator_180ea22c0808_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="DocumentTranslator_180ea22c0808_output")
