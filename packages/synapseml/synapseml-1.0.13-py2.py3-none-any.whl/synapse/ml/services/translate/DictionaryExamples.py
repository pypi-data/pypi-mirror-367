...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_397de2cc2778_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_397de2cc2778_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_397de2cc2778_error")
        self._setDefault(outputCol="DictionaryExamples_397de2cc2778_output")
