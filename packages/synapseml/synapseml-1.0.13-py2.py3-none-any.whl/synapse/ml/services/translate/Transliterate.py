...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_d28092d21364_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_d28092d21364_output",
        ...
        self._setDefault(errorCol="Transliterate_d28092d21364_error")
        self._setDefault(outputCol="Transliterate_d28092d21364_output")
