...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_b8069d1636ba_error",
        handler=None,
        outputCol="Detect_b8069d1636ba_output",
        ...
        self._setDefault(errorCol="Detect_b8069d1636ba_error")
        self._setDefault(outputCol="Detect_b8069d1636ba_output")
