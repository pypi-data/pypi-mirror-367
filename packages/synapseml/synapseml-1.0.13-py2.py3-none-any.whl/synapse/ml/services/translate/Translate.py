...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Translate_0856f1cfb5be_error",
        fromLanguage=None,
        ...
        outputCol="Translate_0856f1cfb5be_output",
        ...
        self._setDefault(errorCol="Translate_0856f1cfb5be_error")
        self._setDefault(outputCol="Translate_0856f1cfb5be_output")
