...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_33fd26eccb7c_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_33fd26eccb7c_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_33fd26eccb7c_error")
        self._setDefault(outputCol="SpeakerEmotionInference_33fd26eccb7c_output")
