...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DescribeImage_cc420df390b6_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_cc420df390b6_output",
        ...
        self._setDefault(errorCol="DescribeImage_cc420df390b6_error")
        self._setDefault(outputCol="DescribeImage_cc420df390b6_output")
