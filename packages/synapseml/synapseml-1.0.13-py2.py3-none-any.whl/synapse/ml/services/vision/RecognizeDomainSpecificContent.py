...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="RecognizeDomainSpecificContent_81f982f04f4b_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        model=None,
        modelCol=None,
        outputCol="RecognizeDomainSpecificContent_81f982f04f4b_output",
        ...
        self._setDefault(errorCol="RecognizeDomainSpecificContent_81f982f04f4b_error")
        self._setDefault(outputCol="RecognizeDomainSpecificContent_81f982f04f4b_output")
