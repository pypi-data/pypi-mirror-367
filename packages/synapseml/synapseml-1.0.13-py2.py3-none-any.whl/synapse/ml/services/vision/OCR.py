...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_a0786cccb596_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_a0786cccb596_output",
        ...
        self._setDefault(errorCol="OCR_a0786cccb596_error")
        self._setDefault(outputCol="OCR_a0786cccb596_output")
