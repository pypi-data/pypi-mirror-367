...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="TagImage_b35ac5a6e71d_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_b35ac5a6e71d_output",
        ...
        self._setDefault(errorCol="TagImage_b35ac5a6e71d_error")
        self._setDefault(outputCol="TagImage_b35ac5a6e71d_output")
