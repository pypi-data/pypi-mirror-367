...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_3d85fca282b4_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_3d85fca282b4_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_3d85fca282b4_error")
        self._setDefault(outputCol="AnalyzeImage_3d85fca282b4_output")
