...
class ReadImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ReadImage_9cd4ea98326d_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="ReadImage_9cd4ea98326d_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="ReadImage_9cd4ea98326d_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="ReadImage_9cd4ea98326d_output")
