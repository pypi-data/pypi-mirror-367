...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GenerateThumbnails_dcb256bce6b5_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_dcb256bce6b5_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_dcb256bce6b5_error")
        self._setDefault(outputCol="GenerateThumbnails_dcb256bce6b5_output")
