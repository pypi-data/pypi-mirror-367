...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AddDocuments_572a5b9af632_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_572a5b9af632_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_572a5b9af632_error")
        self._setDefault(outputCol="AddDocuments_572a5b9af632_output")
