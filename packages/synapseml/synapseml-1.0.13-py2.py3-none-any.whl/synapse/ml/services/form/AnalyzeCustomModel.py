...
class AnalyzeCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeCustomModel_c32af2454ec1_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        modelId=None,
        modelIdCol=None,
        outputCol="AnalyzeCustomModel_c32af2454ec1_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeCustomModel_c32af2454ec1_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeCustomModel_c32af2454ec1_output")
