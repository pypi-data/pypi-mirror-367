...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_1cba7dcc6fc9_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_1cba7dcc6fc9_output",
        ...
        self._setDefault(errorCol="ListCustomModels_1cba7dcc6fc9_error")
        self._setDefault(outputCol="ListCustomModels_1cba7dcc6fc9_output")
