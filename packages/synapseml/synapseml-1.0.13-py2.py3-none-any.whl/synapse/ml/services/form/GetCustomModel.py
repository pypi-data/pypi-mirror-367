...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_12f5b41c61b9_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_12f5b41c61b9_output",
        ...
        self._setDefault(errorCol="GetCustomModel_12f5b41c61b9_error")
        self._setDefault(outputCol="GetCustomModel_12f5b41c61b9_output")
