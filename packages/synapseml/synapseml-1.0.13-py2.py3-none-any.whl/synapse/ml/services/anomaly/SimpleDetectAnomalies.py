...
class SimpleDetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SimpleDetectAnomalies_cee576a45aad_error",
        granularity=None,
        granularityCol=None,
        groupbyCol=None,
        handler=None,
        ...
        outputCol="SimpleDetectAnomalies_cee576a45aad_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="SimpleDetectAnomalies_cee576a45aad_error")
        self._setDefault(outputCol="SimpleDetectAnomalies_cee576a45aad_output")
