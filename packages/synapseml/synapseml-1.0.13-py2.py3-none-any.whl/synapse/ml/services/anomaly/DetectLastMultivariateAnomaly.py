...
class DetectLastMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastMultivariateAnomaly_d4ec4b799457_error",
        handler=None,
        inputVariablesCols=None,
        modelId=None,
        outputCol="DetectLastMultivariateAnomaly_d4ec4b799457_output",
        ...
        self._setDefault(errorCol="DetectLastMultivariateAnomaly_d4ec4b799457_error")
        self._setDefault(outputCol="DetectLastMultivariateAnomaly_d4ec4b799457_output")
