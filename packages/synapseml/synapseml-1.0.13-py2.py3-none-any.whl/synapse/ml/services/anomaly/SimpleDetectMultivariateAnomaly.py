...
class SimpleDetectMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(
        ...
        endTime=None,
        errorCol="SimpleDetectMultivariateAnomaly_3a36a1b0b5a5_error",
        handler=None,
        ...
        modelId=None,
        outputCol="SimpleDetectMultivariateAnomaly_3a36a1b0b5a5_output",
        pollingDelay=300,
        startTime=None,
        ...
        self._setDefault(errorCol="SimpleDetectMultivariateAnomaly_3a36a1b0b5a5_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="SimpleDetectMultivariateAnomaly_3a36a1b0b5a5_output")
