...
class DetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectAnomalies_810e2fb70070_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectAnomalies_810e2fb70070_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectAnomalies_810e2fb70070_error")
        self._setDefault(outputCol="DetectAnomalies_810e2fb70070_output")
