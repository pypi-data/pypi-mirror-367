...
class DetectLastAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectLastAnomaly_79fac551d1d0_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectLastAnomaly_79fac551d1d0_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectLastAnomaly_79fac551d1d0_error")
        self._setDefault(outputCol="DetectLastAnomaly_79fac551d1d0_output")
