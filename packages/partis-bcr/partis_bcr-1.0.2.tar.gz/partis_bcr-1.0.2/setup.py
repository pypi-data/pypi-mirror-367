...
def check_system_dependencies():
    ...
    required_commands = ['scons', 'gcc', 'g++', 'python3', 'pip', 'pkg-config']
    missing = []
...
Ubuntu/Debian:
    sudo apt-get install python3 python3-pip python3-venv build-essential scons libgsl-dev libyaml-cpp-dev pkg-config

macOS (with Homebrew):
    brew install python3 scons gsl yaml-cpp pkg-config
