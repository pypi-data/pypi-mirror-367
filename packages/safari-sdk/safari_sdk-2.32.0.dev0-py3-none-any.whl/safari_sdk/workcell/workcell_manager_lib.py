...
class WorkcellManager:
    ...
    while True:
      ...
      if total_ergo_break_duration_minutes < required_ergo_duration_minutes:
        ...
        if (
          ...
          self._show_ergo_reminder_popup(msg)
      time.sleep(1)
  ...
  def _show_ergo_reminder_popup(self, msg: str) -> None:
    ...
    try:
      image_pkg = "google3.third_party.safari.sdk.safari.workcell.ergo.images"
      image_jpeg_bytes = (
          resources.files(image_pkg).joinpath(image_name).read_bytes()
      )
