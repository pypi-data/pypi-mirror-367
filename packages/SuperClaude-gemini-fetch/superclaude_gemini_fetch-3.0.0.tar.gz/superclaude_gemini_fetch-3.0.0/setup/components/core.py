...
class CoreComponent(Component):
    ...
    def _get_source_dir(self, ai_type: str):
        """Get source directory for framework files"""
        # Assume we're in SuperClaude/setup/components/core.py
        # and framework files are in SuperClaude/ClaudeCore/ or SuperClaude/GeminiCore/
        project_root = Path(__file__).parent.parent.parent
        if ai_type == 'gemini':
            return project_root / "SuperClaude" / "GeminiCore"
