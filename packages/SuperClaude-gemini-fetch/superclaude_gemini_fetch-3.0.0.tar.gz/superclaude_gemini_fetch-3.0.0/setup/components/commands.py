...
class CommandsComponent(Component):
    ...
    def __init__(self, install_dir: Optional[Path] = None, ai_type: str = 'claude'):
        ...
        command_subdir = "commands/sg" if ai_type == 'gemini' else "commands/sc"
        super().__init__(install_dir, Path(command_subdir), ai_type=ai_type)
    ...
    def uninstall(self) -> bool:
        ...
        try:
            ...
            # Remove command files from sc/sg subdirectory
    ...
    def validate_installation(self) -> Tuple[bool, List[str]]:
        ...
        # Check if sc/sg commands directory exists
        commands_dir = self.install_component_subdir
        if not commands_dir.exists():
            errors.append(f"{self.ai_type.upper()} commands directory not found")
            return False, errors
    ...
    def _get_source_dir(self, ai_type: str) -> Path:
        """Get source directory for command files"""
        # Assume we're in SuperClaude/setup/components/commands.py
        # and command files are in SuperClaude/Commands/ or SuperClaude/GeminiCommands/
        project_root = Path(__file__).parent.parent.parent
        if ai_type == 'gemini':
            return project_root / "SuperClaude" / "GeminiCommands"
