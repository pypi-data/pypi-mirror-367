...
class ComponentRegistry:
    ...
    def get_component_instance(self, component_name: str, install_dir: Optional[Path] = None, ai_type: str = 'claude') -> Optional[Component]:
        """
        ...
        Args:
            ...
            ai_type: The AI type ('claude' or 'gemini')
        ...
        if install_dir is not None:
            # Create new instance with specified install directory and AI type
            component_class = self.component_classes.get(component_name)
            if component_class:
                try:
                    return component_class(install_dir, ai_type=ai_type)
                except Exception as e:
    ...
    def create_component_instances(self, component_names: List[str], install_dir: Optional[Path] = None, ai_type: str = 'claude') -> Dict[str, Component]:
        """
        ...
        for name in component_names:
            instance = self.get_component_instance(name, install_dir, ai_type=ai_type)
            if instance:
