...
import pyannotators_acronyms


# -- Project information -----------------------------------------------------

project = "pyannotators_acronyms"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyannotators_acronyms.__version__
release = pyannotators_acronyms.__version__
...
apidoc_module_dir = os.path.dirname(pyannotators_acronyms.__file__)
