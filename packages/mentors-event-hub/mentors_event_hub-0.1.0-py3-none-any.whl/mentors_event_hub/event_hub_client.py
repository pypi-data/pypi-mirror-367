...
class EventHubClient:
    ...
    def send_event(self, event_type: str = "UNDEFINED", message: str = "", **kwargs):
        """
    ...
    def send_error(self, exception: Exception, context: str = "", **kwargs):
        """
    ...
    def capture_errors(self, context: str = ""):
        """
