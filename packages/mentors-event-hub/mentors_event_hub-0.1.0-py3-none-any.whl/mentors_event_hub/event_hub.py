...
def setup_global_hub(project: str, layer: str = "undefined", **kwargs) -> EventHubClient:
    """
...
def send_event(event_type: str = "UNDEFINED", message: str = "", **kwargs):
    """
...
def send_error(exception: Exception, context: str = "", **kwargs):
    """
...
def capture_errors(context: str = ""):
    """
