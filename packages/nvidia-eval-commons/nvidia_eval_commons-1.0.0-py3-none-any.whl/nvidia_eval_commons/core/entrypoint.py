...
def get_args() -> argparse.Namespace:
    ...
    if args.debug:
        # FIXME(tgrzegorzek) this is not entirely making ot work because logs can be rendered earlier
...
def show_available_tasks() -> None:
    # TODO(tgrzegorzek): This should be refactored into a single function returning
    ...
    if not core_evals_pkg:
        # TODO(tgrzegorzek): once commons go public, put here a reference to
        # the website that lists evaluation packages
