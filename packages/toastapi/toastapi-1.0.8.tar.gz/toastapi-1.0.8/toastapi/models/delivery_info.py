...
class DeliveryInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address1", "address2", "city", "state", "zipCode", "latitude", "longitude", "notes", "deliveredDate", "dispatchedDate", "deliveryEmployee", "deliveryState"]
