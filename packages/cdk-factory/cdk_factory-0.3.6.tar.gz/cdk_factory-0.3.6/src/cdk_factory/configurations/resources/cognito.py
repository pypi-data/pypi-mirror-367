...
class CognitoConfig:
    ...
    @property
    def ssm_export_user_pool_id(self) -> bool:
        """Whether to export the user pool id (default: False)"""
        return bool(self.__config.get("ssm_export_user_pool_id", False))

    @property
    def ssm_export_user_pool_name(self) -> bool:
        """Whether to export the user pool name (default: False)"""
        return bool(self.__config.get("ssm_export_user_pool_name", False))

    @property
    def ssm_export_user_pool_arn(self) -> bool:
        """Whether to export the user pool arn (default: False)"""
        return bool(self.__config.get("ssm_export_user_pool_arn", False))
