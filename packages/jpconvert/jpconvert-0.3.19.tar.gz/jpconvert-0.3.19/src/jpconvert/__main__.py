...
parser.add_argument('--fail-embedded-output', action='store_true', default=False,
                    help='raise an exception if embedded output is discovered')
...
pipeline = build_pipeline(practice, solution, teaching,
                          ...
                          args.fail_embedded_output, not args.keep_output)
