...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("He hasn't arrived yet , hasn't he ?", "He hasn't arrived yet , has he ?", "QUESTION_TAG"),
        ...
        ("They will call us , do they ?", "They will call us , won't they ?", "QUESTION_TAG"),
        # ── ③ Wrong pronoun ────────────────────────────────────────────
        (
        ...
        ("Anna is late again , isn't Anna ?", "Anna is late again , isn't she ?", "QUESTION_TAG"),
        ...
        ("You cleaned the room , did not you ?", "You cleaned the room , didn't you ?", "QUESTION_TAG"),
        # DNAI - 925
        ("He isn't ready, isn't he?", "He isn't ready, is he?", "QUESTION_TAG"),
        ("I'm late, aren't I?", "I'm late, am I?", "QUESTION_TAG"),
        ("She can speak French, doesn't she?", "She can speak French, can't she?", "QUESTION_TAG"),
