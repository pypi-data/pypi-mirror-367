...
import vnerrant
from vnerrant.model.edit import convert_edits_to_dict, get_corrected_text_and_edits, noop_edit
...
def parallel_to_m2(
    ...
    with ExitStack() as stack, open(output, "w", encoding="utf-8") as out_m2:
        in_files = [stack.enter_context(open(i)) for i in [orig_file] + list(corr_files)]
        ...
        for line in zip(*in_files):
            ...
            for cor_id, cor_text in enumerate(corr_texts):
                ...
                # Otherwise, do extra processing
                    ...
                    edits = annotator.annotate_raw(orig_text.text, cor_text.text, lev, merge)
