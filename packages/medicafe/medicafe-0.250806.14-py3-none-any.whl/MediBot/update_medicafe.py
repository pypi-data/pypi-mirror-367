...
def debug_step(step_number, step_title, message=""):
    ...
    # Make debug steps less intrusive - only pause for critical steps
    if step_number in [1, 7, 8]:  # Only pause for environment check, update execution, and verification
