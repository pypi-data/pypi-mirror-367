...
class SDKVersionChecker:
    ...
    def __init__(self):
        ...
        self._current_version = version("obiguard_trace_python_sdk")
    ...
    def check(self):
        if self.is_outdated():
            print(
                Fore.YELLOW
                + f"Warning: Your Obiguard inner trace SDK version {self._current_version} is outdated. Please upgrade to {self._latest_version}."
                + Fore.RESET
            )
