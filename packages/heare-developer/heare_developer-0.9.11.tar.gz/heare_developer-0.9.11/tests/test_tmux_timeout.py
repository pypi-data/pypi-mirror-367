...
from heare.developer.tools.tmux_session import TmuxSessionManager
...
class TestTimeoutFunctionality:
    ...
    def test_timeout_initialization(self):
        ...
        from heare.developer.tools.tmux_session import TmuxSession
    ...
    @patch("heare.developer.tools.tmux_session.TmuxSessionManager._run_tmux_command")
    @patch(
        "heare.developer.tools.tmux_session.TmuxSessionManager._kill_session_processes"
    )
