...
# MLX is only available for Apple Silicon, not Intel Macs
# Don't add it to install_requires automatically - make it optional
# Users on Apple Silicon can install with: pip install hanzo-net[apple_silicon]
...
setup(
  name="hanzo-net",
  version="0.1.3",
  description="Hanzo Network - Distributed AI compute network for running models locally",
  author="Hanzo AI",
  ...
  long_description="""
Hanzo Network - Distributed AI compute network for running models locally.

**Platform Support:**
- Linux: Full support
- macOS Intel (x86_64): Full support (without MLX)
- macOS Apple Silicon (ARM64): Full support with MLX - install with `pip install hanzo-net[apple_silicon]`
- Windows: Experimental support

For Apple Silicon Macs with MLX support:
```bash
pip install hanzo-net[apple_silicon]
```
