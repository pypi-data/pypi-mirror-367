...
from yta_video_base.duration import EnshortVideoMode, ExtendVideoMode, set_video_duration
...
class VideoWrapped:
    ...
    """
    The properties below are the ones that we
    can edit through the video editor.
    """
    @property
    ...
    """
    The properties above are the ones that we
    can edit through the video editor.
    """
