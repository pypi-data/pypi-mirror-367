        ...
        try:
            ...
            for child in key.split('.'):
                ...
                try:
                    ...
                    # 'list' is a keyword that allows for iteration
                    # over a dict within the template.

                    # TODO figure out why it takes so long!
                    if child == 'list' and type(scope) is dict:
                        return [ v for v in scope.values() ]
            ...
            # I need this for scoping to work properly with arbitrary
            # key lookups
            if scope is None:
                continue
