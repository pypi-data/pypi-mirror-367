...
def load_plugin_variables(file: str, backup_dirs: list[str] | None = None) -> dict[str, Any]:
    ...
    if plugin_file and exists(plugin_file):
        ...
        from agent_zero_lite.python.helpers import extract_tools
...
from agent_zero_lite.python.helpers.strings import sanitize_string
...
def fix_dev_path(path:str):
    ...
    from agent_zero_lite.python.helpers.runtime import is_development
    if is_development():
