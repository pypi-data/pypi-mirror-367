...
from agent_zero_lite.python.helpers import dotenv, runtime
from agent_zero_lite.python.helpers.tunnel_manager import TunnelManager
import requests
...
class TunnelProxy(ApiHandler):
    async def process(self, input: dict, request: Request) -> dict | Response:
        ...
        if service_ok:
            ...
            from agent_zero_lite.python.api.tunnel import Tunnel
