...
@dataclass
class AgentConfig:
    # Core model configurations - keeping all for full LiteLLM support
    chat_model: models.ModelConfig
    utility_model: models.ModelConfig
    embeddings_model: models.ModelConfig
    browser_model: models.ModelConfig  # Keep for API compatibility, not browser automation
    mcp_servers: str
    profile: str = ""
    memory_subdir: str = ""
    knowledge_subdirs: list[str] = field(default_factory=lambda: ["default", "custom"])
    # Simplified execution - local only
    code_exec_local: bool = True
...
class Agent:
    ...
    async def process_tools(self, msg: str):
        ...
        if tool_request is not None:
            ...
            try:
                from .python.helpers import mcp_handler as mcp_helper
