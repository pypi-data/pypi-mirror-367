...
# Configuration
OBSERA_API_URL = "https://mp1grlhon8.execute-api.ap-south-1.amazonaws.com/dev/send-call-log"
OBSERA_API_KEY = os.getenv("OBSERA_API_KEY")
...
async def send_to_pype(data):
    ...
    try:
        ...
        async with aiohttp.ClientSession() as session:
            async with session.post(OBSERA_API_URL, json=data, headers=headers) as response:
