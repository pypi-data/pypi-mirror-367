...
class APISuapCourseBlock(StructBlock):
    ...
    api_url = blocks.URLBlock(
        default="https://suap.enap.gov.br/portal/api/v3/eventosAltosExecutivos",
        label="URL da API",
    ...
    def get_destaques(self, limit=None):
        ...
        try:
            # Nova URL da API
            resp = requests.get("https://suap.enap.gov.br/portal/api/v3/eventosAltosExecutivos", timeout=5)
            resp.raise_for_status()
            data = resp.json()
