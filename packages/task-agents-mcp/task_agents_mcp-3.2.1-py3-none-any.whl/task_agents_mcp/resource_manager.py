...
class AgentResourceManager:
    ...
    def _register_agent_resource(self, internal_name: str, agent_config):
        ...
        # Create a proper URI using agent:// scheme with the agent's display name
        resource_uri = f"agent://{agent_config.agent_name}"
        
        # Create a closure to capture the agent config
        async def get_agent_resource() -> Dict[str, Any]:
        ...
        self.mcp.resource(resource_uri)(get_agent_resource)
