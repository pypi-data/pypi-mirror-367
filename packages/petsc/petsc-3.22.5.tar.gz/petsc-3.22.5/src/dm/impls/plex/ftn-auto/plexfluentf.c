...
extern "C" {
#endif
PETSC_EXTERN void  dmplexcreatefluentfromfile_(MPI_Fint * comm, char filename[],PetscBool *interpolate,DM *dm, int *ierr, PETSC_FORTRAN_CHARLEN_T cl0)
{
...
*ierr = DMPlexCreateFluentFromFile(
