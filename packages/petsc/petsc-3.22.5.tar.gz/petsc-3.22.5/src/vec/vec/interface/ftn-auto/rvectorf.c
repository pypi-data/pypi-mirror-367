...
extern "C" {
#endif
PETSC_EXTERN void  vecmaxpointwisedivide_(Vec x,Vec y,PetscReal *max, int *ierr)
{
...
PETSC_EXTERN void  vecdot_(Vec x,Vec y,PetscScalar *val, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
CHKFORTRANNULLOBJECT(y);
...
PETSC_EXTERN void  vecdotrealpart_(Vec x,Vec y,PetscReal *val, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
CHKFORTRANNULLOBJECT(y);
...
PETSC_EXTERN void  vecnorm_(Vec x,NormType *type,PetscReal *val, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
CHKFORTRANNULLREAL(val);
*ierr = VecNorm(
...
PETSC_EXTERN void  vecnormavailable_(Vec x,NormType *type,PetscBool *available,PetscReal *val, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
CHKFORTRANNULLREAL(val);
*ierr = VecNormAvailable(
	(Vec)PetscToPointer((x) ),*type,available,val);
}
PETSC_EXTERN void  vecnormalize_(Vec x,PetscReal *val, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
CHKFORTRANNULLREAL(val);
*ierr = VecNormalize(
...
PETSC_EXTERN void  vectdot_(Vec x,Vec y,PetscScalar *val, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
CHKFORTRANNULLOBJECT(y);
CHKFORTRANNULLSCALAR(val);
...
PETSC_EXTERN void  vecscale_(Vec x,PetscScalar *alpha, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
*ierr = VecScale(
	(Vec)PetscToPointer((x) ),*alpha);
}
PETSC_EXTERN void  vecset_(Vec x,PetscScalar *alpha, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
*ierr = VecSet(
	(Vec)PetscToPointer((x) ),*alpha);
}
PETSC_EXTERN void  vecaxpy_(Vec y,PetscScalar *alpha,Vec x, int *ierr)
{
CHKFORTRANNULLOBJECT(y);
CHKFORTRANNULLOBJECT(x);
*ierr = VecAXPY(
...
PETSC_EXTERN void  vecaypx_(Vec y,PetscScalar *beta,Vec x, int *ierr)
{
CHKFORTRANNULLOBJECT(y);
CHKFORTRANNULLOBJECT(x);
*ierr = VecAYPX(
...
PETSC_EXTERN void  vecaxpby_(Vec y,PetscScalar *alpha,PetscScalar *beta,Vec x, int *ierr)
{
CHKFORTRANNULLOBJECT(y);
CHKFORTRANNULLOBJECT(x);
*ierr = VecAXPBY(
...
PETSC_EXTERN void  vecaxpbypcz_(Vec z,PetscScalar *alpha,PetscScalar *beta,PetscScalar *gamma,Vec x,Vec y, int *ierr)
{
...
PETSC_EXTERN void  vecwaxpy_(Vec w,PetscScalar *alpha,Vec x,Vec y, int *ierr)
{
...
PETSC_EXTERN void  vecsetvaluesblockedlocal_(Vec x,PetscInt *ni, PetscInt ix[], PetscScalar y[],InsertMode *iora, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
CHKFORTRANNULLINTEGER(ix);
CHKFORTRANNULLSCALAR(y);
...
PETSC_EXTERN void  vecmtdot_(Vec x,PetscInt *nv, Vec y[],PetscScalar val[], int *ierr)
{
CHKFORTRANNULLOBJECT(x);
...
PETSC_EXTERN void  vecmdot_(Vec x,PetscInt *nv, Vec y[],PetscScalar val[], int *ierr)
{
CHKFORTRANNULLOBJECT(x);
PetscBool y_null = !*(void**) y ? PETSC_TRUE : PETSC_FALSE;
CHKFORTRANNULLOBJECT(y);
...
PETSC_EXTERN void  vecmaxpy_(Vec y,PetscInt *nv, PetscScalar alpha[],Vec x[], int *ierr)
{
CHKFORTRANNULLOBJECT(y);
...
PETSC_EXTERN void  vecmaxpby_(Vec y,PetscInt *nv, PetscScalar alpha[],PetscScalar *beta,Vec x[], int *ierr)
{
CHKFORTRANNULLOBJECT(y);
CHKFORTRANNULLSCALAR(alpha);
PetscBool x_null = !*(void**) x ? PETSC_TRUE : PETSC_FALSE;
...
PETSC_EXTERN void  vecconcatenate_(PetscInt *nx, Vec X[],Vec *Y,IS *x_is[], int *ierr)
{
PetscBool X_null = !*(void**) X ? PETSC_TRUE : PETSC_FALSE;
CHKFORTRANNULLOBJECT(X);
PetscBool Y_null = !*(void**) Y ? PETSC_TRUE : PETSC_FALSE;
CHKFORTRANNULLOBJECT(Y);
CHKFORTRANNULLOBJECT(x_is);
*ierr = VecConcatenate(*nx,X,Y,x_is);
// if C routine nullifed the object, we must set to to -2 to indicate null set in Fortran
if (! X_null && !*(void**) X) * (void **) X = (void *)-2;
// if C routine nullifed the object, we must set to to -2 to indicate null set in Fortran
if (! Y_null && !*(void**) Y) * (void **) Y = (void *)-2;
}
PETSC_EXTERN void  vecgetsubvector_(Vec X,IS is,Vec *Y, int *ierr)
{
CHKFORTRANNULLOBJECT(X);
...
PETSC_EXTERN void  vecrestoresubvector_(Vec X,IS is,Vec *Y, int *ierr)
{
CHKFORTRANNULLOBJECT(X);
CHKFORTRANNULLOBJECT(is);
PetscBool Y_null = !*(void**) Y ? PETSC_TRUE : PETSC_FALSE;
...
PETSC_EXTERN void  veccreatelocalvector_(Vec v,Vec *w, int *ierr)
{
CHKFORTRANNULLOBJECT(v);
PetscBool w_null = !*(void**) w ? PETSC_TRUE : PETSC_FALSE;
CHKFORTRANNULLOBJECT(w);
*ierr = VecCreateLocalVector(
	(Vec)PetscToPointer((v) ),w);
// if C routine nullifed the object, we must set to to -2 to indicate null set in Fortran
if (! w_null && !*(void**) w) * (void **) w = (void *)-2;
}
PETSC_EXTERN void  vecgetlocalvectorread_(Vec v,Vec w, int *ierr)
{
CHKFORTRANNULLOBJECT(v);
CHKFORTRANNULLOBJECT(w);
*ierr = VecGetLocalVectorRead(
	(Vec)PetscToPointer((v) ),
	(Vec)PetscToPointer((w) ));
}
PETSC_EXTERN void  vecrestorelocalvectorread_(Vec v,Vec w, int *ierr)
{
CHKFORTRANNULLOBJECT(v);
CHKFORTRANNULLOBJECT(w);
*ierr = VecRestoreLocalVectorRead(
	(Vec)PetscToPointer((v) ),
	(Vec)PetscToPointer((w) ));
}
PETSC_EXTERN void  vecgetlocalvector_(Vec v,Vec w, int *ierr)
{
CHKFORTRANNULLOBJECT(v);
CHKFORTRANNULLOBJECT(w);
*ierr = VecGetLocalVector(
	(Vec)PetscToPointer((v) ),
	(Vec)PetscToPointer((w) ));
}
PETSC_EXTERN void  vecrestorelocalvector_(Vec v,Vec w, int *ierr)
{
CHKFORTRANNULLOBJECT(v);
CHKFORTRANNULLOBJECT(w);
*ierr = VecRestoreLocalVector(
	(Vec)PetscToPointer((v) ),
	(Vec)PetscToPointer((w) ));
}
PETSC_EXTERN void  vecplacearray_(Vec vec, PetscScalar array[], int *ierr)
{
...
PETSC_EXTERN void  veclockget_(Vec x,PetscInt *state, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
CHKFORTRANNULLINTEGER(state);
*ierr = VecLockGet(
	(Vec)PetscToPointer((x) ),state);
}
PETSC_EXTERN void  veclockreadpush_(Vec x, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
*ierr = VecLockReadPush(
	(Vec)PetscToPointer((x) ));
}
PETSC_EXTERN void  veclockreadpop_(Vec x, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
*ierr = VecLockReadPop(
	(Vec)PetscToPointer((x) ));
}
PETSC_EXTERN void  veclockwriteset_(Vec x,PetscBool *flg, int *ierr)
{
CHKFORTRANNULLOBJECT(x);
*ierr = VecLockWriteSet(
	(Vec)PetscToPointer((x) ),*flg);
}
#if defined(__cplusplus)
}
#endif
