...
extern "C" {
#endif
PETSC_EXTERN void  petscmemorygetcurrentusage_(PetscLogDouble *mem, int *ierr)
{
*ierr = PetscMemoryGetCurrentUsage(mem);
}
PETSC_EXTERN void  petscmemorygetmaximumusage_(PetscLogDouble *mem, int *ierr)
{
*ierr = PetscMemoryGetMaximumUsage(mem);
}
PETSC_EXTERN void  petscmemorysetgetmaximumusage_(int *ierr)
{
