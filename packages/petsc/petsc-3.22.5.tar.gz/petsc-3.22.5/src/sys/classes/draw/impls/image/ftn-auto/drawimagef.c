...
extern "C" {
#endif
PETSC_EXTERN void  petscdrawopenimage_(MPI_Fint * comm, char filename[],int *w,int *h,PetscDraw *draw, int *ierr, PETSC_FORTRAN_CHARLEN_T cl0)
{
...
*ierr = PetscDrawOpenImage(
	MPI_Comm_f2c(*(comm)),_cltmp0,*w,*h,draw);
