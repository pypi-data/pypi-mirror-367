...
from textual_fspicker import FileSave, Filters, FileOpen
...
class WorklistWidget(Static):
    def __init__(self, pacs_config: PacsConfig, **kwargs: Any):
        ...
        def load_worklist(filename: Path | None) -> None:
            ...
            with filename.open('r', encoding='utf8') as csvfile:
                ...
                for row in csv_reader:
                    self.studies.append(StudyData(**dict(zip(header, row))))
                self._update_table()
