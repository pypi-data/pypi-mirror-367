...
class DeidAnonymizer:
    ...
    def hash_func(self, item: dict, value: str, field: DicomField, dicom: pydicom.Dataset) -> str:
    ...
    # noinspection PyUnusedLocal
    def date_time_jitter(self, item: dict, value: str, field: DicomField, dicom: pydicom.Dataset) -> str:
