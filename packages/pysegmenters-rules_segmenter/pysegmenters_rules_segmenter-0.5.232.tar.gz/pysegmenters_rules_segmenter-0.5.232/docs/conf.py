...
import pysegmenters_rules_segmenter


# -- Project information -----------------------------------------------------

project = "pysegmenters_rules_segmenter"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pysegmenters_rules_segmenter.__version__
release = pysegmenters_rules_segmenter.__version__
...
apidoc_module_dir = os.path.dirname(pysegmenters_rules_segmenter.__file__)
