...
def main():
    parser = argparse.ArgumentParser(
        description=(
            ...
            'example: cortexa-sdk -d "dataset-id" --export-type COCO --api-key your-api-key --base-url http://localhost:8000/api/v1 --download-dir ./tmp/datasets\n'
    ...
    parser.add_argument(
        "--base-url",
        help="Base URL of the server, such as https://localhost:8000/api/v1",
    )
    parser.add_argument(
