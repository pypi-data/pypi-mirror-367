...
class Payment:
    ...
    def _normalize_text(cls, text: str) -> str:
        ...
        text_normalied = (u"".join([c for c in nfkd_form if not unicodedata.combining(c)]))
...
class StrGenerator:
    def __init__(self, iban: str, ammount: int, message: str = None, rn: str = None, vs: int = None, ss: int = None, ks: int = None):
