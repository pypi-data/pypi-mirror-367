...
echo "Publishing Niamoto version $VERSION with GUI"
...
if [ -z "$PYPI_TOKEN" ]; then
    ...
    echo "2. Pass it directly: PYPI_TOKEN=your-token bash scripts/publish_with_gui.sh"
