...
class IndonesiaDukcapilBiometricMatchInput(BaseModel):
    """
    ...
    selfie_image: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="The raw bytes of the selfie image of the individual.              Must be JPEG format; 1MB maximum.", alias="selfieImage")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IndonesiaDukcapilBiometricMatchInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IndonesiaDukcapilBiometricMatchInput from a dict"""
        if obj is None:
            return None
