...
from trinsic_api.models.indonesia_dukcapil_biometric_match_input import IndonesiaDukcapilBiometricMatchInput
...
class ProviderInput(BaseModel):
    ...
    indonesia_dukcapil_biometric_match: Optional[IndonesiaDukcapilBiometricMatchInput] = Field(default=None, description="Input for the `indonesia-dukcapil-biometric-match` provider", alias="indonesiaDukcapilBiometricMatch")
    ...
    __properties: ClassVar[List[str]] = ["indonesiaNik", "indonesiaDukcapilBiometricMatch", "mexicoCurp", "southAfricaNid", "kenyaNid", "nigeriaNin", "aadhaar", "bangladeshNationalId", "brazilCpfCheck", "brazilDigitalCnh", "philippineMatch", "philippineQR", "smartId", "mobileId", "idin", "spid", "trinsicTestDatabaseLookup", "trinsicTestSubProviders"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of indonesia_dukcapil_biometric_match
        if self.indonesia_dukcapil_biometric_match:
            _dict['indonesiaDukcapilBiometricMatch'] = self.indonesia_dukcapil_biometric_match.to_dict()
        ...
        # set to None if indonesia_dukcapil_biometric_match (nullable) is None
        # and model_fields_set contains the field
        if self.indonesia_dukcapil_biometric_match is None and "indonesia_dukcapil_biometric_match" in self.model_fields_set:
            _dict['indonesiaDukcapilBiometricMatch'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "indonesiaDukcapilBiometricMatch": IndonesiaDukcapilBiometricMatchInput.from_dict(obj["indonesiaDukcapilBiometricMatch"]) if obj.get("indonesiaDukcapilBiometricMatch") is not None else None,
