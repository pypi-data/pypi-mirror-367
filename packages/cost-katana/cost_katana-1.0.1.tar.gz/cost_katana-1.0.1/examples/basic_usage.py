...
def main():
    ...
    print("\n💭 Generating content...")
    response = model.generate_content("Explain the benefits of using AI cost optimization in simple terms")
    ...
    claude_response = claude_model.generate_content("What makes Claude different from other AI models? Be brief.")
