...
import pyprocessors_afp_sports


# -- Project information -----------------------------------------------------

project = "pyprocessors_afp_sports"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_afp_sports.__version__
release = pyprocessors_afp_sports.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_afp_sports.__file__)
