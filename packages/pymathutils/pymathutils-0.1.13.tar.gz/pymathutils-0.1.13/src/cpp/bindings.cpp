...
PYBIND11_MODULE(mathutils_backend, m) {
  ...
  special.def("reduced_spherical_Pmm",
              ...
              "Compute reduced spherical Pmm", py::arg("m"), py::arg("theta"));
  ...
  special.def("recursive_Ylm",
              static_cast<std::complex<double> (*)(int, int, double, double)>(
                  &mathutils::special::recursive_Ylm),
  ...
  special.def("recursive_real_Ylm",
              static_cast<double (*)(int, int, double, double)>(
                  &mathutils::special::recursive_real_Ylm),
