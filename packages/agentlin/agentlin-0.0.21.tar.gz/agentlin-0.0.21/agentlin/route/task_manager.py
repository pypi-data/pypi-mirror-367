...
from agentlin.core.types import SendTaskRequest
...
class InMemoryTaskManager(TaskManager):
    ...
    async def fail_streaming_response(self, request_id: str, task_id: str, error: JSONRPCError) -> SendTaskStreamingResponse:
