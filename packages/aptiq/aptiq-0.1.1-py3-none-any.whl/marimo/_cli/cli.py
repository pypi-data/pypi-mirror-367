    ...
    [
        ...
        _key_value_bullets(
            [
                (
                    "aptiq edit",
                    "Start the aptiq marimo notebook server",
                ),
                ("aptiq edit notebook.py", "Create or edit notebook.py"),
            ]
        ),
    ]
)
    ...
    [
        ...
        _key_value_bullets(
            [
                ...
                (
                    'aptiq new "Plot an interactive 3D surface with matplotlib."',
                    "Generate a notebook from a prompt.",
                ),
                (
                    "aptiq new prompt.txt",
