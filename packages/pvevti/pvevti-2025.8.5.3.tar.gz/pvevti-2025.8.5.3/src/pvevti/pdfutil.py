        ...
        match self.type:
            ...
            case "map":
                ...
                try:
                    ...
                    span_x = max(max(self.data[1]) - min(self.data[1]), 0.001)
                    mid_x = (max(self.data[1]) + min(self.data[1]))/2
                    span_y = max(max(self.data[2]) - min(self.data[2]), 0.001)
                    mid_y = (max(self.data[2]) + min(self.data[2]))/2
                    p.set_xlim([mid_x-span_x/2,  mid_x+span_x/2])
                    p.set_ylim([mid_y-span_y/2, mid_y+span_y/2])
