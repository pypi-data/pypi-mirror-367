...
but doteval evaluations are executed later during session finalization. This
...
class FixtureManager:
    ...
    teardown for doteval evaluations. It bridges the gap between pytest's
    fixture system and doteval's deferred execution model.
    """
