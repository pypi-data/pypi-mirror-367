...
class TestModelProvidersFixture:
    ...
    @patch("doteval.providers.discover_model_providers")
...
class TestProviderIntegration:
    ...
    def test_old_api_fallback_with_dict(self):
        ...
        from doteval.providers import discover_model_providers
        ...
        with patch("importlib.metadata.entry_points") as mock_ep:
            ...
            mock_ep.side_effect = [
                TypeError("entry_points() got an unexpected keyword argument 'group'"),
                {"doteval.model_providers": [MockEntryPoint()]},
            ]
