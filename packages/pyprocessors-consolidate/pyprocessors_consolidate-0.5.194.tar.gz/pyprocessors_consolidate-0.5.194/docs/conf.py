...
import pyprocessors_consolidate


# -- Project information -----------------------------------------------------

project = "pyprocessors_consolidate"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_consolidate.__version__
release = pyprocessors_consolidate.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_consolidate.__file__)
