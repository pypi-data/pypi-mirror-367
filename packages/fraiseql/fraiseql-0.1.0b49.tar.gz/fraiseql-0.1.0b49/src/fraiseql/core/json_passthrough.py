...
class JSONPassthrough:
    ...
    __slots__ = ("_config", "_data", "_type_hint", "_type_name", "_wrapped_cache", "_injected_typename")
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        available = sorted([k for k in self._data.keys() if k != "__typename" or not self._injected_typename])
    ...
    def __repr__(self):
        ...
        fields = [k for k in self._data.keys() if k != "__typename" or not self._injected_typename]
