...
from maleo_soma.schemas.mixin import SuccessT
...
from .result import (
    AnyDataResourceOperationResult,
...
class SuccessfulResourceOperationSchema(
    OperationResultMixin[AnyDataResourceOperationResult[MetadataT]],
    NoErrorMixin,
...
class CreateMultipleResourceOperationSchema(
    OperationResultMixin[CreateMultipleResourceOperationResult[DataT, MetadataT]],
    NoErrorMixin,
    ResourceOperationSchema[Literal[True], CreateResourceOperationAction],
    Generic[DataT, MetadataT],
):
...
class ReadMultipleResourceOperationSchema(
    OperationResultMixin[ReadMultipleResourceOperationResult[DataT, MetadataT]],
    NoErrorMixin,
    ResourceOperationSchema[Literal[True], ReadResourceOperationAction],
    Generic[DataT, MetadataT],
):
...
class UpdateMultipleResourceOperationSchema(
    OperationResultMixin[UpdateMultipleResourceOperationResult[DataT, MetadataT]],
    NoErrorMixin,
    ResourceOperationSchema[Literal[True], UpdateResourceOperationAction],
    Generic[DataT, MetadataT],
):
...
class DeleteMultipleResourceOperationSchema(
    OperationResultMixin[DeleteMultipleResourceOperationResult[DataT, MetadataT]],
    NoErrorMixin,
    ResourceOperationSchema[Literal[True], DeleteResourceOperationAction],
    Generic[DataT, MetadataT],
):
