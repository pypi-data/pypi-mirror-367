...
from maleo_soma.utils.extractor import extract_client_ip
from maleo_soma.utils.parser import parse_user_agent
from .user_agent import UserAgent


class RequestContext(BaseModel):
    request_id: UUID = Field(..., description="Request's ID")
    requested_at: datetime = Field(..., description="Requested at timestamp")
