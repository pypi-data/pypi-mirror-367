...
class GetUnpaginatedMultipleParameterSchema(
...
class GetUnpaginatedMultipleQueryParameterSchema(
    Sorts, Filters, GetUnpaginatedMultipleParameterSchema
):
...
class GetPaginatedMultipleParameterSchema(
...
class GetPaginatedMultipleQueryParameterSchema(
    Sorts, Filters, GetPaginatedMultipleParameterSchema
):
    @model_validator(mode="after")
    def set_sort(self) -> Self:
        # * Process sort_columns parameters
