...
from maleo_soma.enums.identifier import DataIdentifier
...
# Identifier
IDENTIFIER_TYPE_VALUE_TYPE_MAP: Mapping[DataIdentifier, object] = {
    DataIdentifier.ID: int,
    DataIdentifier.UUID: UUID,
}
