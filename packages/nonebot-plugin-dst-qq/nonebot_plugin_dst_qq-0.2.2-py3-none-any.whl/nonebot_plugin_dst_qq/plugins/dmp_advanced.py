...
try:
    ...
    from nonebot_plugin_dst_qq.database import chat_db
    config = get_config()
except ImportError:
    # 如果绝对导入失败，尝试相对导入
...
# 高级命令处理器
backup_list_cmd = on_command("备份", aliases={"backup", "backuplist"}, priority=5, permission=SUPERUSER)
