        ...
        with Pool(self.n_processes) as pool:
            ...
            for result in pool.imap_unordered(self.convert_folder, dicom_folders):
                ...
                # Handled skip - returns the skip reason and the dicom folder
                    ...
                    warning_message = lambda text: logger.warning(f"{completed}/{num_folders} - Skipped {dicom_folder} {text}")
                    match reason:
                        case 'mincount':
                        ...
                        case 'ai-rad':
                            warning_message('because the series was an AI-Rad Companion report')
                        case 'not-ax':
