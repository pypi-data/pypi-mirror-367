...
class KernelDaemon:
    ...
    def _run_daemon(self, output_mode: str = "stream"):
        ...
        # Note: No output callback for daemon mode - output goes through file communication
        self.executor = JupyterKernelExecutor(
            output_callback=None,
            output_mode="collected"  # Always use collected mode for daemon communication
        )
