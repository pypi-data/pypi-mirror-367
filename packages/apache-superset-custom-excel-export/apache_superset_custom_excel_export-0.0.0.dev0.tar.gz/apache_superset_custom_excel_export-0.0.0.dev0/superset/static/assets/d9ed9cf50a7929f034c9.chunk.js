"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[9915],{11188:(e,t,r)=>{r.d(t,{A:()=>u});var a=r(2445),i=r(96540),o=r(72234),n=r(95579),s=r(42944),l=r(38380),c=r(73135);const d=o.I4.div`
  position: relative;
  margin-top: -24px;
...
`;function u({addDangerToast:e,addSuccessToast:t,children:r,language:o,...u}){function h(r){(0,c.A)((()=>Promise.resolve(r))).then((()=>{t&&t((0,n.t)("Code Copied!"))})).catch((()=>{e&&e((0,n.t)("Sorry, your browser does not support copying."))}))}return(0,i.useEffect)((()=>{(0,s.Fq)([o])}),[o]),(0,a.FD)(d,{children:[(0,a.Y)(l.F.CopyOutlined,{className:"copy-button",tabIndex:0,role:"button","aria-label":(0,n.t)("Copy code to clipboard"),onClick:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget.blur(),h(r)},onKeyDown:e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),h(r))}}),(0,a.Y)(s.Ay,{language:o,...u,children:r})]})}},14318:(e,t,r)=>{r.d(t,{A:()=>i});var a=r(96540);function i({queries:e,fetchData:t,currentQueryId:r}){const i=e.findIndex((e=>e.id===r)),[o,n]=(0,a.useState)(i),[s,l]=(0,a.useState)(!1),[c,d]=(0,a.useState)(!1);function u(){l(0===o),d(o===e.length-1)}function h(r){const a=o+(r?-1:1);a>=0&&a<e.length&&(t(e[a].id),n(a),u())}return(0,a.useEffect)((()=>{u()})),{handleKeyPress:function(t){o>=0&&o<e.length&&("ArrowDown"===t.key||"k"===t.key?(t.preventDefault(),h(!1)):"ArrowUp"!==t.key&&"j"!==t.key||(t.preventDefault(),h(!0)))},handleDataChange:h,disablePrevious:s,disableNext:c}}},52825:(e,t,r)=>{r.r(t),r.d(t,{default:()=>Z});var a=r(2445),i=r(96540),o=r(61574),n=r(71519),s=r(72234),l=r(95579),c=r(35742),d=r(69108),u=r(17437),h=r(30703),m=r(5261),p=r(50500),b=r(51713),g=r(82537),y=r(97470),f=r(20900),v=r(93514),S=r(44344),x=r(42944),q=r(27023),k=r(23193),H=r(38380),w=r(46942),D=r.n(w),C=r(84335),F=r(15509),Y=r(11188),$=r(14318);const T=s.I4.div`
...
`,N=(0,m.Ay)((function({onHide:e,openInSqlLab:t,queries:r,query:o,fetchData:n,show:s,addDangerToast:c,addSuccessToast:d}){const{handleKeyPress:u,handleDataChange:h,disablePrevious:m,disableNext:p}=(0,$.A)({queries:r,currentQueryId:o.id,fetchData:n}),[b,g]=(0,i.useState)("user"),{id:y,sql:f,executed_sql:v}=o;return(0,a.Y)("div",{role:"none",onKeyUp:u,children:(0,a.FD)(U,{onHide:e,show:s,title:(0,l.t)("Query preview"),footer:(0,a.FD)(a.FK,{children:[(0,a.Y)(F.$,{disabled:m,onClick:()=>h(!0),children:(0,l.t)("Previous")},"previous-query"),(0,a.Y)(F.$,{disabled:p,onClick:()=>h(!1),children:(0,l.t)("Next")},"next-query"),(0,a.Y)(F.$,{buttonStyle:"primary",onClick:()=>t(y),children:(0,l.t)("Open in SQL Lab")},"open-in-sql-lab")]}),children:[(0,a.Y)(T,{children:(0,l.t)("Tab name")}),(0,a.Y)(z,{children:o.tab_name}),(0,a.FD)(A,{children:[(0,a.Y)(I,{role:"button",className:D()({active:"user"===b}),onClick:()=>g("user"),children:(0,l.t)("User query")}),(0,a.Y)(I,{role:"button",className:D()({active:"executed"===b}),onClick:()=>g("executed"),children:(0,l.t)("Executed query")})]}),(0,a.Y)(Y.A,{addDangerToast:c,addSuccessToast:d,language:"sql",children:("user"===b?f:v)||""})]})})}));var R=r(95272),Q=r(25106),L=r(95070);const P=(0,s.I4)(S.uO)`
