...
`,j=(e,t,n)=>e?(0,a.FD)("div",{children:[t&&(0,a.Y)("strong",{children:t}),n&&(0,a.Y)("div",{css:e=>r.AH`
          ...
          `,children:n})]}):n||null;function X(e){var t;const{name:n,onChange:r,onOpenPopover:u=b.fZ,onClosePopover:A=b.fZ,overlayStyle:x="Popover",isOverflowingFilterBar:F=!1}=e,T=(0,D.IM)(),M=null!=(t=e.value)?t:T,[N,R]=(0,i.useState)(M),[k,O]=(0,i.useState)(!1),I=(0,i.useMemo)((()=>(0,D.J5)(M)),[M]),[V,G]=(0,i.useState)(I),[z,W]=(0,i.useState)(M),[P,H]=(0,i.useState)(M),[U,q]=(0,i.useState)(!1),[X,Q]=(0,i.useState)(M),[ee,te]=(0,i.useState)(M),ne=(0,l.DP)(),[ae,ie]=(0,o.A)();function le(){H(M),G(I),O(!1),A()}(0,i.useEffect)((()=>{if(M===c.WC)return R(c.WC),te(null),void q(!0);(0,d.x9)(M).then((({value:e,error:t})=>{t?(Q(t||""),q(!1),te(M||null)):("Common"===I||"Calendar"===I||"Current"===I||"No filter"===I?(R(M),te(j(ie,M,e))):(R(e||""),te(j(ie,e,M))),q(!0)),W(M),Q(e||M)}))}),[I,ie,ae,M]),(0,Y.sv)((()=>{if(P===c.WC)return Q(c.WC),W(c.WC),void q(!0);z!==P&&(0,d.x9)(P).then((({value:e,error:t})=>{t?(Q(t||""),q(!1)):(Q(e||""),q(!0)),W(P)}))}),h.Y.SLOW_DEBOUNCE,[P]);const re=()=>{k?le():(H(M),G(I),O(!0),u())},oe=(0,a.FD)(Z,{children:[(0,a.Y)("div",{className:"control-label",children:(0,s.t)("Range type")}),(0,a.Y)(K,{ariaLabel:(0,s.t)("Range type"),options:D.BJ,value:V,onChange:function(e){e===c.WC&&H(c.WC),G(e)}}),"No filter"!==V&&(0,a.Y)(p.c,{}),"Common"===V&&(0,a.Y)($,{value:P,onChange:H}),"Calendar"===V&&(0,a.Y)(S,{value:P,onChange:H}),"Current"===V&&(0,a.Y)(E,{value:P,onChange:H}),"Advanced"===V&&(0,a.Y)(B,{value:P,onChange:H}),"Custom"===V&&(0,a.Y)(L,{value:P,onChange:H,isOverflowingFilterBar:F}),"No filter"===V&&(0,a.Y)("div",{}),(0,a.Y)(p.c,{}),(0,a.FD)("div",{children:[(0,a.Y)("div",{className:"section-title",children:(0,s.t)("Actual time range")}),U&&(0,a.Y)("div",{children:"No filter"===X?(0,s.t)("No filter"):X}),!U&&(0,a.FD)(J,{className:"warning",children:[(0,a.Y)(C.F.ExclamationCircleOutlined,{iconColor:ne.colorError}),(0,a.Y)("span",{className:"text error",children:X})]})]}),(0,a.Y)(p.c,{}),(0,a.FD)("div",{className:"footer",children:[(0,a.Y)(m.$,{buttonStyle:"secondary",cta:!0,onClick:le,children:(0,s.t)("CANCEL")},"cancel"),(0,a.Y)(m.$,{buttonStyle:"primary",cta:!0,disabled:!U,onClick:function(){r(P),O(!1),A()},children:(0,s.t)("APPLY")},"apply")]})]}),ce=(0,a.Y)(w.A,{autoAdjustOverflow:!1,trigger:"click",placement:"right",content:oe,title:(0,a.FD)(J,{children:[(0,a.Y)(C.F.EditOutlined,{}),(0,a.Y)("span",{className:"text",children:(0,s.t)("Edit time range")})]}),defaultOpen:k,open:k,onOpenChange:re,overlayStyle:{width:"600px"},destroyTooltipOnHide:!0,getPopupContainer:e=>F?e.parentNode:document.body,overlayClassName:"time-range-popover",children:(0,a.Y)(v.m,{placement:"top",title:ee,children:(0,a.Y)(_,{name:n,"aria-labelledby":`filter-name-${e.name}`,"aria-describedby":`date-label-${e.name}`,label:N,isActive:k,isPlaceholder:N===c.WC,ref:ae})})}),de=(0,a.FD)(a.FK,{children:[(0,a.Y)(v.m,{placement:"top",title:ee,children:(0,a.Y)(_,{name:n,"aria-labelledby":`filter-name-${e.name}`,"aria-describedby":`date-label-${e.name}`,onClick:re,label:N,isActive:k,isPlaceholder:N===c.WC,ref:ae})}),(0,a.Y)(g.aF,{title:(0,a.Y)(y.r,{className:"text",isEditMode:!0,title:(0,s.t)("Edit time range")}),name:(0,s.t)("Edit time range"),show:k,onHide:re,width:"600px",hideFooter:!0,zIndex:1030,children:oe})]});return(0,a.FD)(a.FK,{children:[(0,a.Y)(f.A,{...e}),"Modal"===x?de:ce]})}},77189:(e,t,n)=>{n.d(t,{wv:()=>s,x9:()=>m});var a=n(62193),i=n.n(a),l=n(58561),r=n.n(l),o=n(62952),c=n(35742),d=n(51436);const s=" : ",u=(e,t)=>`${e}${s}${t}`,h=(e,t)=>e.replace("T00:00:00","")||(t?"-∞":"∞"),p=(e,t="col")=>{const n=e.split(s);return 1===n.length?e:`${h(n[0],!0)} ≤ ${t} < ${h(n[1])}`},m=async(e,t="col",n)=>{let a,l;if(i()(n))a=r().encode_uri(e),l=`/api/v1/time_range/?q=${a}`;else{const t=(0,o.A)(n).map((t=>({timeRange:e,shift:t})));a=r().encode_uri([{timeRange:e},...t]),l=`/api/v1/time_range/?q=${a}`}try{var m;const e=await c.A.get({endpoint:l});if(i()(n)){var v,g;const n=u((null==e||null==(v=e.json)||null==(v=v.result[0])?void 0:v.since)||"",(null==e||null==(g=e.json)||null==(g=g.result[0])?void 0:g.until)||"");return{value:p(n,t)}}const a=null==e||null==(m=e.json)?void 0:m.result.map((e=>u(e.since,e.until)));return{value:a.slice(1).map((e=>((e,t,n="col")=>{const a=e.split(s),i=t.split(s);return`${n}: ${h(a[0],!0)} to ${h(a[1])} vs\n  ${h(i[0],!0)} to ${h(i[1])}`})(a[0],e,t)))}}catch(e){const t=await(0,d.h4)(e);return{error:t.message||t.error||e.statusText}}}}}]);