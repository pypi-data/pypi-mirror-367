...
T = TypeVar("T", bound="GithubComKalshiExchangeInfraSvcApi2ModelGetQuotesResponseQuotesItem")


@_attrs_define
class GithubComKalshiExchangeInfraSvcApi2ModelGetQuotesResponseQuotesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_get_quotes_response_quotes_item = cls(
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_get_quotes_response_quotes_item.additional_properties = d
        return github_com_kalshi_exchange_infra_svc_api_2_model_get_quotes_response_quotes_item
