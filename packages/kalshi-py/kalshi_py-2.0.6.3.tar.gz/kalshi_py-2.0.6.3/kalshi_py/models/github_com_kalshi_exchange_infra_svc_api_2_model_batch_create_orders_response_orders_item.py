...
T = TypeVar("T", bound="GithubComKalshiExchangeInfraSvcApi2ModelBatchCreateOrdersResponseOrdersItem")


@_attrs_define
class GithubComKalshiExchangeInfraSvcApi2ModelBatchCreateOrdersResponseOrdersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_batch_create_orders_response_orders_item = cls(
            client_order_id=client_order_id,
            error=error,
            order=order,
        )

        github_com_kalshi_exchange_infra_svc_api_2_model_batch_create_orders_response_orders_item.additional_properties = d
        return github_com_kalshi_exchange_infra_svc_api_2_model_batch_create_orders_response_orders_item
