...
T = TypeVar("T", bound="GithubComKalshiExchangeInfraSvcApi2ModelGetMarketCandlesticksResponseCandlesticksItem")


@_attrs_define
class GithubComKalshiExchangeInfraSvcApi2ModelGetMarketCandlesticksResponseCandlesticksItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_get_market_candlesticks_response_candlesticks_item = cls(
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_get_market_candlesticks_response_candlesticks_item.additional_properties = d
        return github_com_kalshi_exchange_infra_svc_api_2_model_get_market_candlesticks_response_candlesticks_item
