...
T = TypeVar("T", bound="GithubComKalshiExchangeInfraSvcApi2ModelGetRFQResponse")


@_attrs_define
class GithubComKalshiExchangeInfraSvcApi2ModelGetRFQResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_get_rfq_response = cls(
            rfq=rfq,
        )

        github_com_kalshi_exchange_infra_svc_api_2_model_get_rfq_response.additional_properties = d
        return github_com_kalshi_exchange_infra_svc_api_2_model_get_rfq_response
