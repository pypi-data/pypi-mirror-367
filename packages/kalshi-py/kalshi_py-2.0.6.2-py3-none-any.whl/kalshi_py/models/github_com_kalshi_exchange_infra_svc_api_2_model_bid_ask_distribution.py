...
T = TypeVar("T", bound="GithubComKalshiExchangeInfraSvcApi2ModelBidAskDistribution")


@_attrs_define
class GithubComKalshiExchangeInfraSvcApi2ModelBidAskDistribution:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_bid_ask_distribution = cls(
            close=close,
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_bid_ask_distribution.additional_properties = d
        return github_com_kalshi_exchange_infra_svc_api_2_model_bid_ask_distribution
