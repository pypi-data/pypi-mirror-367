...
T = TypeVar("T", bound="GithubComKalshiExchangeInfraSvcApi2ModelBatchCancelOrdersResponseOrdersItem")


@_attrs_define
class GithubComKalshiExchangeInfraSvcApi2ModelBatchCancelOrdersResponseOrdersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_batch_cancel_orders_response_orders_item = cls(
            error=error,
            order=order,
            order_id=order_id,
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_batch_cancel_orders_response_orders_item.additional_properties = d
        return github_com_kalshi_exchange_infra_svc_api_2_model_batch_cancel_orders_response_orders_item
