...
class PlatformCacheRepository:
    ...
    def delete_by_prefix(self, prefix: str) -> None:
        ...
        """
        try:
            if hasattr(self._cache, "delete_by_prefix"):
                self._cache.delete_by_prefix(prefix)
            else:
                logger.warning("delete_by_prefix not supported by current cache implementation")
        except (ConnectionError, TimeoutError, OSError):
            logger.exception("Error deleting by prefix")
