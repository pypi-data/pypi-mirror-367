...
@click.option('--jenkins-username', default=None)
@click.option('--jenkins-password', default=None)
...
def main(
    ...
    if jenkins_url:
        ...
        if jenkins_username is not None:
        ...
        raise ValueError('Please provide valid jenkins_url')
