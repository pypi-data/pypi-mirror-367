...
class GRPO:
    ...
    def __init__(
        ...
        self.model = model
        self.scorer = grader
        self.scoring_fn = grader.score_without_metadata
        self.logger = logger
    ...
    async def train_mini_batch(self, sample: Sample):
    ...
    async def run(self):
        ...
        while self.training_completion_percentage < 1.0:
            ...
            for mini_batch in get_minibatches(flattened_data, self.samples_per_mini_batch, self.mini_epochs_per_batch):
