...
class MLFlowLogger(Logger):
    def __init__(
        ...
        log_tables_every_n_steps: int = 10,
    ):
        ...
        self.step = 0
        self.log_tables_every_n_steps = log_tables_every_n_steps
    ...
    def __call__(self, metrics: Mapping[str, int | float | Table]):
        ...
        if self.step % self.log_tables_every_n_steps == 0:
...
class StdoutLogger(Logger):
    ...
    def __call__(self, logs: Mapping[str, Any]):
        pprint(logs)
