...
from hanzo_mcp.tools.search import UnifiedSearch, create_unified_search_tool
...
async def test_unified_search_auto_detection():
    ...
    result = await search_tool.run(
        pattern="how does search work in this codebase",
        max_results_per_type=5
    )
