...
def get_all_from_sqlite(path: str) -> Generator[Tuple[Dict, Dict], None, None]:
    ...
    Thread-hostile. Does not load the entire database into memory, unlike diskcache.Cache.items().
    """
...
class Cache(object):
    ...
    We use diskcache to persist the cache: https://github.com/grantjenks/python-diskcache.
    """
