...
import pyannotators_duckling


# -- Project information -----------------------------------------------------

project = "pyannotators_duckling"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyannotators_duckling.__version__
release = pyannotators_duckling.__version__
...
apidoc_module_dir = os.path.dirname(pyannotators_duckling.__file__)
