...
if TYPE_CHECKING:
    ...
    from polaris.management.models.implicit_authentication_parameters import ImplicitAuthenticationParameters
...
class AuthenticationParameters(BaseModel):
    ...
    def authentication_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['OAUTH', 'BEARER', 'SIGV4', 'IMPLICIT']):
            raise ValueError("must be one of enum values ('OAUTH', 'BEARER', 'SIGV4', 'IMPLICIT')")
        return value
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'BEARER': 'BearerAuthenticationParameters','IMPLICIT': 'ImplicitAuthenticationParameters','OAUTH': 'OAuthClientCredentialsParameters','SIGV4': 'SigV4AuthenticationParameters'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[BearerAuthenticationParameters, ImplicitAuthenticationParameters, OAuthClientCredentialsParameters, SigV4AuthenticationParameters]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[BearerAuthenticationParameters, ImplicitAuthenticationParameters, OAuthClientCredentialsParameters, SigV4AuthenticationParameters]]:
        ...
        if object_type ==  'ImplicitAuthenticationParameters':
            return import_module("polaris.management.models.implicit_authentication_parameters").ImplicitAuthenticationParameters.from_dict(obj)
