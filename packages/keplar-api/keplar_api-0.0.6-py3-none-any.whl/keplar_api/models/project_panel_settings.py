...
class ProjectPanelSettings(BaseModel):
    """
    ProjectPanelSettings
    """ # noqa: E501
    respondent_attributes: List[ProjectPanelRespondentAttribute]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectPanelSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectPanelSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "respondent_attributes": [ProjectPanelRespondentAttribute.from_dict(_item) for _item in obj["respondent_attributes"]] if obj.get("respondent_attributes") is not None else None,
