...
class ApiInviteCodeCodeStartGet302ResponseSettings(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["maxResponsesPerParticipant", "maxDurationSeconds", "screenerQuestions", "files", "collectEmail", "privacyNotice"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiInviteCodeCodeStartGet302ResponseSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiInviteCodeCodeStartGet302ResponseSettings from a dict"""
        if obj is None:
            return None
