...
class User(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "seq", "createdAt", "updatedAt", "provider", "userId", "email", "name", "accountStatus", "location", "profileImageUrl", "data", "orgId", "org", "projects", "invites", "chatSessions", "moderators", "uploadedFiles", "threads"]
