...
class InviteResponseData(BaseModel):
    ...
    screener_questions_responses: Optional[List[ProjectScreenerQuestionResponse]] = Field(default=None, alias="screenerQuestionsResponses")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "screenerQuestionsResponses": [ProjectScreenerQuestionResponse.from_dict(_item) for _item in obj["screenerQuestionsResponses"]] if obj.get("screenerQuestionsResponses") is not None else None,
