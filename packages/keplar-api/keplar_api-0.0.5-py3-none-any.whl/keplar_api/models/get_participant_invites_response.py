...
class GetParticipantInvitesResponse(BaseModel):
    """
    GetParticipantInvitesResponse
    """ # noqa: E501
    participant_invites: List[ParticipantInvite] = Field(alias="participantInvites")
    total: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["participantInvites", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetParticipantInvitesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetParticipantInvitesResponse from a dict"""
        if obj is None:
            return None
