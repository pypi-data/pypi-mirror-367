...
class ProjectWithAnalytics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "name", "description", "status", "createdById", "orgId", "moderatorId", "config", "conversationConfig", "analysis", "createdBy", "org", "moderator", "invites", "chatSessions", "projectFiles", "threads"]
