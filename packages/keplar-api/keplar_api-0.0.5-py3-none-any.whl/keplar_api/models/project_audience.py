...
class ProjectAudience(BaseModel):
    ...
    panel_settings: Optional[ProjectPanelSettings] = Field(default=None, alias="panelSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "panelSettings": ProjectPanelSettings.from_dict(obj["panelSettings"]) if obj.get("panelSettings") is not None else None
        })
        return _obj
