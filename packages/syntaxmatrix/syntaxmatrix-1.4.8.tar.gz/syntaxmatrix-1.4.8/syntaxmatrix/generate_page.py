...
profile = _prof.get_profile('code') 

if not profile:
    print("No Code Profile")
    print(profile)
else:
    client = _prof.get_client(profile)
    model = profile['model']

def generate_page_html(page_title: str, website_description: str) -> str:
...
def generate_page_html2(page_title, website_objectives):
