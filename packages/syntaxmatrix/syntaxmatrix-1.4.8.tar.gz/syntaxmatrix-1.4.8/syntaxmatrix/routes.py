...
from syntaxmatrix.settings.prompts import SMX_WEBSITE_DESCRIPTION
        ...
        <footer style="width:100%; padding:0; background:{smx.theme['nav_background']}; color:{smx.theme['nav_text']}; text-align:center; padding:4px;">
          <p style="margin:0; font_size:4px;">
            <em> 
              ...
              <span>|</span>
              <span style="margin-left:7px; vertical-align:middle;">{smx.bot_icon}</span>
...
# ────────────────────────────────────────────────────────────────────────────────
            if action == "upload_files":
              ...
              if file_name:
                ...
                page_content_html = _genpage.generate_page_html(page_name, SMX_WEBSITE_DESCRIPTION)
