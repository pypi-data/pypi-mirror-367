...
class SimulatorJob(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["agent_config", b"agent_config", "insight_agent", b"insight_agent"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["agent", b"agent", "agent_config", b"agent_config", "id", b"id", "inputs", b"inputs", "insight_agent", b"insight_agent"]) -> None: ...
