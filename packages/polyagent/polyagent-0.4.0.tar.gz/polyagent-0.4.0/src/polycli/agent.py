...
class OpenSourceAgent(BaseAgent):
    ...
    def _run_with_qwen(self, prompt: str, model: str, system_prompt: Optional[str] = None):
    ...
    def run(self, prompt: str, model="gpt-4o", system_prompt=None, cli="mini-swe"):
        if cli == "mini-swe":
            ...
            # Store in simple format for mini-swe
            ...
            return self._run_with_qwen(prompt, model, system_prompt)
        else:
