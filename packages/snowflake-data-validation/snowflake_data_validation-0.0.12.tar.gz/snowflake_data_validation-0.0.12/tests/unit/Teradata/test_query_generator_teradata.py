...
class TestQueryGeneratorTeradata:
    ...
    def test_generate_compute_md5_query(self):
        ...
        mock_table_context.normalized_fully_qualified_name = "test_db_test_schema_test_table"
        ...
        assert len(result) == 3  # Should have 3 queries: create concatenated, create md5, insert
