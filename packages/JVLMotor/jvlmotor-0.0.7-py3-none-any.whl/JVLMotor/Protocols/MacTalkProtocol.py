...
class MacTalkProtocol(TemplateProtocol):
    def __init__(self,com_type="Serial",port=None,ip=None,baudrate=19200,
        ...
        self.logger = logging.getLogger("MacTalkProtocol")

        # Ensure log directory exists and log file is unique
        log_file = os.path.join("protocol_logs", "MacTalkProtocol.log")
        ...
        if com_type == "Serial":
            ...
            self.logger.info("Serial MacTalkProtocol Initialized")
        if com_type == "Ethernet":
            ...
            self.logger.info("UDP MacTalkProtocol Initialized")
    ...
    def read(self,reg_num,length=4): 
        ...
        if self.com_type == "Serial":
            try:
                ...
                self.logger.error(f"Unknown Communication Problem on register {reg_num}")
                return
