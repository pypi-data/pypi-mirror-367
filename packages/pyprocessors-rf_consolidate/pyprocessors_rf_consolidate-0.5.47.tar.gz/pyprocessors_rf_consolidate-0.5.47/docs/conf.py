...
import pyprocessors_rf_consolidate


# -- Project information -----------------------------------------------------

project = "pyprocessors_rf_consolidate"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_rf_consolidate.__version__
release = pyprocessors_rf_consolidate.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_rf_consolidate.__file__)
