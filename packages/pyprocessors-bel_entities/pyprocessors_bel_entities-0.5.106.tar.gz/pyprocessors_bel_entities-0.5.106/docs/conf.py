...
import pyprocessors_bel_entities


# -- Project information -----------------------------------------------------

project = "pyprocessors_bel_entities"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_bel_entities.__version__
release = pyprocessors_bel_entities.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_bel_entities.__file__)
