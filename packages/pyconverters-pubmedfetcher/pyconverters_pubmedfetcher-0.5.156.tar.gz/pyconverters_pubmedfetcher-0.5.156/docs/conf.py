...
import pyconverters_pubmedfetcher


# -- Project information -----------------------------------------------------

project = "pyconverters_pubmedfetcher"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_pubmedfetcher.__version__
release = pyconverters_pubmedfetcher.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_pubmedfetcher.__file__)
