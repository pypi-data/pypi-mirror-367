...
antechamber -i lig_H.$LIGEXT -fi $LIGEXT -o lig_gcrt.com -fo gcrt -gv 1 -ge lig_gcrt.gesp -gn "%NProc=10" -s 2

#run gaussian
echo "GAUSSIAN: START"
g16 <lig_gcrt.com >lig_gcrt.log
echo "GAUSSIAN: END"
grep time lig_gcrt.log

# fit resp charges
antechamber -i lig_gcrt.gesp -fi gesp -o lig_ac.prep -fo prepi -at gaff2 -c resp -s 2 -eq 2 -nc 0
