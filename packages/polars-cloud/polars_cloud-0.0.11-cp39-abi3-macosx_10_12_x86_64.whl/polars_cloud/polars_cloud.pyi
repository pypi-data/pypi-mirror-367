...
def get_interactive_query_progress(
    address: str, query_id: UUID, tag: bytes | None, client_options: ClientOptions
...
class ApiClient:
    ...
    def cancel_batch_query(self, workspace_id: UUID, query_id: UUID) -> None: ...
    ...
    def submit_query(
        self, compute_id: UUID, plan: bytes, settings: bytes, labels: list[str] | None
    ) -> str:
        pass
