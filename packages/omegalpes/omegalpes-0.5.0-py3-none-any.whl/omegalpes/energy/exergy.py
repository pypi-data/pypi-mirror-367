...
5) Can proceed with only one temperature value or with a list of temperatures.
    ...
    5.2. Formulates timely exergy if one single EnergyUnit and a list of
    temperatures is provided.
    
    5.3. Formulates exergy for each unit within a list of EnergyUnits if only
    one temperature is provided.
    
    5.4. Formulates timely exergy for each unit within a list of EnergyUnits if
