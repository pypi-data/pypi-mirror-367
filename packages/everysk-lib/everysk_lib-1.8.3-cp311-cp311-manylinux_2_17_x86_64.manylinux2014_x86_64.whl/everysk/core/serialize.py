    ...
    **kwargs
    ...
    if protocol == 'json':
        ...
        try:
            ...
            raise ModuleNotFoundError('orjson is not installed. Please install it with "pip install orjson".') from error
        ...
        options = orjson.OPT_PASSTHROUGH_DATETIME | orjson.OPT_NON_STR_KEYS | orjson.OPT_SERIALIZE_NUMPY
