...
class SerializeJsonDumpsTestCase(TestCase):
    ...
    def test_protocol_invalid(self):
        with self.assertRaisesRegex(ValueError, "Unsupported serialize protocol 'invalid'. Use 'json', 'orjson' or 'pickle'."):
    ...
    def test_complex_object(self):
        ...
        self.assertEqual(
            ...
            '{"%s": "everysk.core._tests.serialize.test_json.BaseDictTest", "_errors": null, "_is_frozen": false, "_silent": false, "var1": {"%s": "everysk.core.object.BaseDict", "_errors": null, "_is_frozen": false, "_silent": false, "a": "foo", "b": "boo"}}' % (CLASS_KEY, CLASS_KEY)
        )
    ...
    def test_complex_object_with_key_function(self):
        ...
        self.assertEqual(
            ...
            '{"%s": "everysk.core._tests.serialize.test_json.BaseDictTest2", "_errors": null, "_is_frozen": false, "_silent": false, "var1": "new_value"}' % CLASS_KEY
        )
