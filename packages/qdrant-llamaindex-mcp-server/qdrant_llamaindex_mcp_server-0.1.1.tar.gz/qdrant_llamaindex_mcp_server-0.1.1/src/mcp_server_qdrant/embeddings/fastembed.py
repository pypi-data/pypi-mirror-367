...
class FastEmbedProvider(EmbeddingProvider):
    ...
    def get_vector_name(self) -> str:
        """
        Return the full model name as the vector name for the Qdrant collection.
        This allows for unambiguous model detection from collection vector configuration.
        """
    ...
    def get_vector_size(self) -> int:
        ...
        return model_description.dim or 384  # Fallback to common size if None
