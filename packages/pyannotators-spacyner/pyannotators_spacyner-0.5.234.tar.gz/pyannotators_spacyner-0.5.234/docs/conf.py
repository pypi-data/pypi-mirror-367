...
import pyannotators_spacyner


# -- Project information -----------------------------------------------------

project = "pyannotators_spacyner"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyannotators_spacyner.__version__
release = pyannotators_spacyner.__version__
...
apidoc_module_dir = os.path.dirname(pyannotators_spacyner.__file__)
