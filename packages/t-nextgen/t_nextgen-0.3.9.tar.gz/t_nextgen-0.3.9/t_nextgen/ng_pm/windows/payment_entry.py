...
class PaymentEntryWindow(NextGenWindow):
    ...
    def get_enc_clm_edit_value(self) -> str:
        ...
        Returns:
            str: value
        """
        pane = self.desktop_app.dialog.child_window(auto_id="_cboInput_103", control_type="Pane")
        combo_box = pane.child_window(control_type="ComboBox")
    ...
    def get_resub_value(self) -> str:
        ...
        Returns:
            str: resub value
        """
        resub = self.desktop_app.dialog.child_window(title="_txtDataEntry_116", control_type="Edit").get_value()
        return resub
