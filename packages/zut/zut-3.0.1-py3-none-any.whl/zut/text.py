...
from zut import UTF8_BOM, UTF8_BOM_BINARY, rfind_or_len, skip_utf8_bom
...
#region Open mixed-encoding files
...
__shortcuts__ = (UTF8_BOM, UTF8_BOM_BINARY, rfind_or_len, skip_utf8_bom)
