...
def configure_logging(level: str|int|None = None, *, names = False, file_level: str|int|None = None, loggers: Mapping[str,str|int|dict|None]|None = None, count = True, exit_handler = True):
