...
class Prompt:
    ...
    def prompt_intent_satisfied(prompt, response, agent_metadata, agent_name):
        template = f"""
            ...
            {{
                "Intent_Satisfied": "Yes/No - Brief explanation (1-2 sentences) of why the intent was or was not satisfied"
            }}
            """
        return template
...
async def insertion_with_context(payload: dict):
        ...
        try:
            ...
            if agent_flag:
                ...
                accuracy_value = accuracy_json["Accuracy"]
                ...
                hallucination_value = hallucination_json["Hallucination"]
