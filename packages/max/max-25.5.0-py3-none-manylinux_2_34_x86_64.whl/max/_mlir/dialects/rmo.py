...
class AvgPoolOp(_ods_ir.OpView):
  ...
  def __init__(self, input, filter_shape, strides, dilations, paddings, ceil_mode, count_boundary, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def avg_pool(input, filter_shape, strides, dilations, paddings, ceil_mode, count_boundary, *, loc=None, ip=None) -> _ods_ir.Value:
  return AvgPoolOp(input=input, filter_shape=filter_shape, strides=strides, dilations=dilations, paddings=paddings, ceil_mode=ceil_mode, count_boundary=count_boundary, loc=loc, ip=ip).result
...
class ConcatOp(_ods_ir.OpView):
  ...
  def __init__(self, inputs, axis, *, out_dim=None, outputParamDecls=None, loc=None, ip=None):
    ...
    if out_dim is not None: attributes["out_dim"] = (out_dim if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_1068')) else
          _ods_ir.AttrBuilder.get('anonymous_1068')(out_dim, context=_ods_context))
    if outputParamDecls is not None: attributes["outputParamDecls"] = (outputParamDecls if (
        isinstance(outputParamDecls, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('MO_ParamDecls')) else
          _ods_ir.AttrBuilder.get('MO_ParamDecls')(outputParamDecls, context=_ods_context))
...
class MaxPoolOp(_ods_ir.OpView):
  ...
  def __init__(self, input, filter_shape, strides, dilations, paddings, ceil_mode, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def max_pool(input, filter_shape, strides, dilations, paddings, ceil_mode, *, loc=None, ip=None) -> _ods_ir.Value:
  return MaxPoolOp(input=input, filter_shape=filter_shape, strides=strides, dilations=dilations, paddings=paddings, ceil_mode=ceil_mode, loc=loc, ip=ip).result
