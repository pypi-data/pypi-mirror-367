...
class ConstantScalarOp(_ods_ir.OpView):
  ...
  def __init__(self, result, value, *, loc=None, ip=None):
    ...
    attributes["value"] = (value if (
    isinstance(value, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1167')) else
      _ods_ir.AttrBuilder.get('anonymous_1167')(value, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class GraphOp(_ods_ir.OpView):
  ...
  def __init__(self, name, signature, functionType, inputParameters, resultParameters, counter, *, isSubgraph=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1116')) else
      _ods_ir.AttrBuilder.get('anonymous_1116')(signature, context=_ods_context))
    attributes["functionType"] = (functionType if (
    isinstance(functionType, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1120')) else
      _ods_ir.AttrBuilder.get('anonymous_1120')(functionType, context=_ods_context))
