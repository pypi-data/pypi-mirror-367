...
class BookChecker(BaseChecker):
    ...
    msgs = {
        ...
        "C7330": (  # message id
            # template of displayed message
            "Book %s tags are not following naming conventions",
            # message symbol
            "tags-bad-naming",
            # message description
        ...
        "C7332": (  # message id
            # template of displayed message
            "Book %s has implements the @discover mechanism but has no @discoverable functions",
            # message symbol
            "book-missing-discoverable-functions",
            # message description
            "Books that implement the @discover mechanism must have @discoverable functions that returns a list of discoverable entities. If that's not possible, return an empty list.",
        ),
    }
