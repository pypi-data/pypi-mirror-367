...
_FP32_OPS: Set[str] = {
    'exp', 'log', 'sqrt', 'cbrt', 'sin', 'cos', 'tan', 'log10', 'log2', 'softmax', 
    'batchnorm', 'batchnorm2d',
    'mse', 'rmse', 'mae', 'binarycrossentropy', 'categoricalcrossentropy',
    'sum', 'mean', 'std', 'var', 'norm', 'cast',
    'pow'
}

# Set of operations that are safe to run in FP16
_FP16_SAFE_OPS: Set[str] = {
    'add', 'sub', 'mul', 'div', 'dot', 'matmul', 'tensordot', 
    'relu', 'sigmoid', 'tanh', 'leakyrelu', 'abs', 'clip',
    'max', 'min', 'transpose', 'reshape', 'flatten', 'dropout', 
    'dropout2d', 'squeeze', 'expanddims', 'pad',
}
