...
async def test_salesforce(username: str, password: str, security_token: str, domain: str) -> Dict[str, Any]:
...
async def test_connectivity(tool_config: List[Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
    ...
    for tool in tool_config:
        ...
        # ------------------------------------------------------------------ #
        # Special-case: Salesforce (requires username/password/security_token)
        # ------------------------------------------------------------------ #
