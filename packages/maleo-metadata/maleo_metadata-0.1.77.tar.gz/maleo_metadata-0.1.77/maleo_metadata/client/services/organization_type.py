...
class MaleoMetadataOrganizationTypeClientService(MaleoClientService):
    ...
    async def get_organization_types(
    ...
    ) -> ReadMultipleResourceOperationResult[OrganizationTypeDataSchema, None]:
        ...
        if result_str is not None:
            ...
            ReadMultipleResourceOperationSchema[OrganizationTypeDataSchema, None](
        ...
        if controller_type is ClientControllerType.HTTP:
            response = await self._controllers.http.get_organization_types(
                authentication=authentication,
    ...
    async def get_organization_type(
        ...
        # Retrieve organization types using chosen controller
        if controller_type is ClientControllerType.HTTP:
            response = await self._controllers.http.get_organization_type(
                authentication=authentication,
                parameters=parameters,
                authorization=authorization,
                headers=headers,
