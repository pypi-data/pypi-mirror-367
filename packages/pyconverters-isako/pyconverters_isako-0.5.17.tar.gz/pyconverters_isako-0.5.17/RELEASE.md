...
This document guides a contributor through creating a release of pyconverters_isako.
...
[GitHub actions](https://github.com/oterrier/pyconverters_isako/actions?query=branch%3Amaster+workflow%3Atests).
