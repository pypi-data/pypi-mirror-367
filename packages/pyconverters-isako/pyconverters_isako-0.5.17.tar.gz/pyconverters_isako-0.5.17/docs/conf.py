...
import pyconverters_isako


# -- Project information -----------------------------------------------------

project = "pyconverters_isako"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_isako.__version__
release = pyconverters_isako.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_isako.__file__)
