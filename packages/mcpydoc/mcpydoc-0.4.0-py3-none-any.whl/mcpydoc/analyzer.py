...
class PackageAnalyzer:
    ...
    @memory_limit(256)
    def search_symbols(
        self, package_name: str, pattern: Optional[str] = None, version: Optional[str] = None
    ) -> List[SymbolInfo]:
        ...
        # Audit log the operation
        audit_log("search_symbols", package_name=package_name, pattern=pattern, version=version)
        results = []
