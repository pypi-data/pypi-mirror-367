...
def get_resource_group(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: UUID of the resource group
    ...
    __ret__ = pulumi.runtime.invoke('redpanda:index/getResourceGroup:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult).value
...
def get_resource_group_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('redpanda:index/getResourceGroup:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult)
