...
class NamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Name of the namespace. Changing the name of a namespace will result in a new namespace being created and the old one being destroyed
        """
        if name is not None:
