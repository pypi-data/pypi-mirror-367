...
module_app = typer.Typer(help="Manage CloudStack modules")
...
def module_list():
    ...
    console.print("[yellow]Module listing coming soon![/yellow]")


@module_app.command("deploy")
def module_deploy(
    module_name: str = typer.Argument(..., help="Module to deploy")
):
    """Deploy a new module."""
    console.print(f"[yellow]Deploying {module_name} coming soon![/yellow]")
