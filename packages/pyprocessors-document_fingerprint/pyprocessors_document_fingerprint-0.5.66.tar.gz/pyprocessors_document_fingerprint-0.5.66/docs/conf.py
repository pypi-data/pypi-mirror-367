...
import pyprocessors_document_fingerprint


# -- Project information -----------------------------------------------------

project = "pyprocessors_document_fingerprint"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_document_fingerprint.__version__
release = pyprocessors_document_fingerprint.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_document_fingerprint.__file__)
