...
class MemoriesApi:
    ...
    def retrieve_memory(
        ...
        pp_reranker_id: Annotated[Optional[StrictStr], Field(description="UUID of reranker to use for ChatPostProcessor (enables post-processing)")] = None,
        pp_llm_id: Annotated[Optional[StrictStr], Field(description="UUID of LLM to use for ChatPostProcessor generation")] = None,
        pp_relevance_threshold: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Minimum relevance score for ChatPostProcessor (default: 0.5)")] = None,
        pp_llm_temp: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="LLM temperature for ChatPostProcessor generation (default: 0.3)")] = None,
        pp_max_results: Annotated[Optional[StrictInt], Field(description="Maximum results for ChatPostProcessor (default: 10)")] = None,
        pp_chronological_resort: Annotated[Optional[StrictBool], Field(description="Whether ChatPostProcessor should resort by creation time (default: true)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pp_reranker_id: UUID of reranker to use for ChatPostProcessor (enables post-processing)
        :type pp_reranker_id: str
        :param pp_llm_id: UUID of LLM to use for ChatPostProcessor generation
        :type pp_llm_id: str
        :param pp_relevance_threshold: Minimum relevance score for ChatPostProcessor (default: 0.5)
        :type pp_relevance_threshold: float
        :param pp_llm_temp: LLM temperature for ChatPostProcessor generation (default: 0.3)
        :type pp_llm_temp: float
        :param pp_max_results: Maximum results for ChatPostProcessor (default: 10)
        :type pp_max_results: int
        :param pp_chronological_resort: Whether ChatPostProcessor should resort by creation time (default: true)
        :type pp_chronological_resort: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._retrieve_memory_serialize(
            ...
            pp_reranker_id=pp_reranker_id,
            pp_llm_id=pp_llm_id,
            pp_relevance_threshold=pp_relevance_threshold,
            pp_llm_temp=pp_llm_temp,
            pp_max_results=pp_max_results,
            pp_chronological_resort=pp_chronological_resort,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def retrieve_memory_advanced(
        self,
        retrieve_memory_request: Annotated[RetrieveMemoryRequest, Field(description="Request body with query, context, and space configurations")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param retrieve_memory_request: Request body with query, context, and space configurations (required)
        :type retrieve_memory_request: RetrieveMemoryRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._retrieve_memory_advanced_serialize(
            retrieve_memory_request=retrieve_memory_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
