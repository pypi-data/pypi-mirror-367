        ...
        if ok:
            ...
            match sensor_type:
                ...
                case "R" | "S" | "A1" | "A2" | "A3" | "K" | "L" | "E" | "J" | "T" | "N":
                    i = '1.0'
                    r = "R300"
                    self.itm_send_command(f'W,Rref1={r}', f'W,Rref{str(selected_row+1)}-OK', f'Для канала 1 установлено опорное сопротивление {r}', f'Невозможно установить опорное сопротивление {r} для канала 1')      # Выбираем опорный резистор для первого канала с заглушкой
                    self.itm_send_command(f'W,mc1={i}', f'W,mc{str(selected_row+1)}-OK', f'Для канала 1 установлен ток измерения {i}', f'Невозможно установить ток измерения {i} для канала 1')   # Устанавливаем ток измерения для первого канала с заглушкой
