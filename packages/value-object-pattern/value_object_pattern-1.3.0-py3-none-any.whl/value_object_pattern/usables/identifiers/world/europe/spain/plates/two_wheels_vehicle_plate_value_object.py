"""
TwoWheelsVehiclePlateValueObject value object.
"""
...
class TwoWheelsVehiclePlateValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    """
    TwoWheelsVehiclePlateValueObject value object ensures the provided value is a valid Spanish two-wheeled vehicle plate.
    ...
    plate = TwoWheelsVehiclePlateValueObject(value='C-1234-BBB')

    print(repr(plate))
    # >>> TwoWheelsVehiclePlateValueObject(value=C1234BBB)
    ```
    """  # noqa: E501  # fmt: skip

    _IDENTIFICATION_REGEX: Pattern[str] = re_compile(pattern=r'([cC])[\s-]?([0-9]{4})[\s-]?([a-zA-Z]{3})')  # noqa: E501  # fmt: skip
    ...
    def _raise_value_is_not_two_wheeled_plate(self, value: str) -> NoReturn:
        ...
        """
        raise ValueError(f'TwoWheelsVehiclePlateValueObject value <<<{value}>>> is not a valid Spanish two-wheeled vehicle plate.')  # noqa: E501  # fmt: skip
