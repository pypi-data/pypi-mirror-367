"""
StateMotorPoolVehiclePlateValueObject value object.
"""
...
class StateMotorPoolVehiclePlateValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    """
    StateMotorPoolVehiclePlateValueObject value object ensures the provided value is a valid Spanish state motor pool plate.
    ...
    plate = StateMotorPoolVehiclePlateValueObject(value='PME-1234-A')

    print(repr(plate))
    # >>> StateMotorPoolVehiclePlateValueObject(value=PME1234A)
    ```
    """  # noqa: E501  # fmt: skip

    _IDENTIFICATION_REGEX: Pattern[str] = re_compile(pattern=r'([pP][mM][eE])[\s-]?([0-9]{4})[\s-]?([a-zA-Z])')  # noqa: E501  # fmt: skip
    ...
    def _raise_value_is_not_state_motor_pool_plate(self, value: str) -> NoReturn:
        ...
        """
        raise ValueError(f'StateMotorPoolVehiclePlateValueObject value <<<{value}>>> is not a valid Spanish state motor pool plate.')  # noqa: E501  # fmt: skip
