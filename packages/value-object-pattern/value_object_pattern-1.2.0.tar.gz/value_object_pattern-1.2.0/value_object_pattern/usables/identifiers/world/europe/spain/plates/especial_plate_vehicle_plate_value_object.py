"""
EspecialVehiclePlateValueObject value object.
"""
...
class EspecialVehiclePlateValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    """
    EspecialVehiclePlateValueObject value object ensures the provided value is a valid Spanish especial vehicle plate.
    ...
    plate = EspecialVehiclePlateValueObject(value='E-1234-ABC')

    print(repr(plate))
    # >>> EspecialVehiclePlateValueObject(value=E1234ABC)
    ```
    """  # noqa: E501  # fmt: skip

    _IDENTIFICATION_REGEX: Pattern[str] = re_compile(pattern=r'([eE])[\s-]?([0-9]{4})[\s-]?([a-zA-Z]{3})')  # noqa: E501  # fmt: skip
    ...
    def _raise_value_is_not_especial_plate(self, value: str) -> NoReturn:
        ...
        """
        raise ValueError(f'EspecialVehiclePlateValueObject value <<<{value}>>> is not a valid Spanish especial vehicle plate.')  # noqa: E501  # fmt: skip
