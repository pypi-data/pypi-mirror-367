"""
AdministrativeTechnicianVehiclePlateValueObject value object.
"""
...
class AdministrativeTechnicianVehiclePlateValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    """
    AdministrativeTechnicianVehiclePlateValueObject value object ensures the provided value is a valid Spanish administrative
    ...
    Example:
    ```python
    from value_object_pattern.usables.identifiers.world.europe.spain.plates import AdministrativeTechnicianVehiclePlateValueObject

    plate = AdministrativeTechnicianVehiclePlateValueObject(value='TA-123-456')

    print(repr(plate))
    # >>> AdministrativeTechnicianVehiclePlateValueObject(value=TA123456)
    ```
    """  # noqa: E501  # fmt: skip

    _IDENTIFICATION_REGEX: Pattern[str] = re_compile(pattern=r'([tT][aA])[-\s]?([0-9]{1,3})[-\s]?([0-9]{3})')  # noqa: E501  # fmt: skip
    ...
    def _raise_value_is_not_administrative_technician_plate(self, value: str) -> NoReturn:
        ...
        """
        raise ValueError(f'AdministrativeTechnicianVehiclePlateValueObject value <<<{value}>>> is not a valid Spanish administrative technician plate.')  # noqa: E501  # fmt: skip
