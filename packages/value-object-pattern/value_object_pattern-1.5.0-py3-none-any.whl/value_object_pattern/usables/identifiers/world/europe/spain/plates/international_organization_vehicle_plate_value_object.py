"""
InternationalOrganizationVehiclePlateValueObject value object.
"""
...
class InternationalOrganizationVehiclePlateValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    """
    InternationalOrganizationVehiclePlateValueObject value object ensures the provided value is a valid Spanish international
    ...
    Example:
    ```python
    from value_object_pattern.usables.identifiers.world.europe.spain.plates import InternationalOrganizationVehiclePlateValueObject

    plate = InternationalOrganizationVehiclePlateValueObject(value='OI-123-456')

    print(repr(plate))
    # >>> InternationalOrganizationVehiclePlateValueObject(value=OI123456)
    ```
    """  # noqa: E501  # fmt: skip

    _IDENTIFICATION_REGEX: Pattern[str] = re_compile(pattern=r'([oO][iI])[-\s]?([0-9]{1,3})[-\s]?([0-9]{3})')  # noqa: E501  # fmt: skip
    ...
    def _raise_value_is_not_international_organization_plate(self, value: str) -> NoReturn:
        ...
        """
        raise ValueError(f'InternationalOrganizationVehiclePlateValueObject value <<<{value}>>> is not a valid Spanish international organization plate.')  # noqa: E501  # fmt: skip
