...
class Datapoints(Base):
    ...
    __table_args__ = (
        UniqueConstraint("skuID", "dateID"),
        Index("idx_datapoints_skuid_dateid", "skuID", "dateID"),
        Index("idx_skuid_datapoints", "skuID"),
    )
...
#     TABLE = "companies"
#     COLUMNS: t.ClassVar[list[str]] = ["name", "dataset_type", "description", "min_date", "max_date", "frequency"]
#     TYPES: t.ClassVar[list[type]] = [str, str, str, datetime, datetime, int]
#     UNIQUE: t.ClassVar[list[str]] = ["name"]
#     AUTO_ID = True

#     def __init__(self, db: SQLDatabase, insertion_mode: InsertionMode) -> None:
#         super().__init__(db, insertion_mode)


# class Stores(Writer):
#     TABLE = "stores"
#     COLUMNS: t.ClassVar[list[str]] = ["companyID", "regionID", "name"]
#     TYPES: t.ClassVar[list[type]] = [int, int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["companyID", "name"]
#     AUTO_ID = True
...
#     COLUMNS: t.ClassVar[list[str]] = ["level", "name", "companyID"]
#     UNIQUE: t.ClassVar[list[str]] = ["level", "name", "companyID"]
#     TYPES: t.ClassVar[list[type]] = [int, str, int]
#     AUTO_ID = True


# class CategoryRelations(Writer):
#     TABLE = "category_relations"
#     COLUMNS: t.ClassVar[list[str]] = ["subID", "parentID"]
#     TYPES: t.ClassVar[list[type]] = [int, int]
#     UNIQUE: t.ClassVar[list[str]] = ["subID", "parentID"]
#     AUTO_ID = False


# class Categories(Writer):
#     TABLE = "categories"
#     COLUMNS: t.ClassVar[list[str]] = ["companyID", "name"]
#     TYPES: t.ClassVar[list[type]] = [int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["companyID", "name"]
#     AUTO_ID = True
...
#     TABLE = "products"
#     COLUMNS: t.ClassVar[list[str]] = ["name", "companyID"]
#     TYPES: t.ClassVar[list[type]] = [str, int]
#     UNIQUE: t.ClassVar[list[str]] = ["name", "companyID"]
#     AUTO_ID = True


# class ProductCategories(Writer):
#     TABLE = "product_categories"
#     COLUMNS: t.ClassVar[list[str]] = ["productID", "categoryID"]
#     TYPES: t.ClassVar[list[type]] = [int, int]
#     UNIQUE: t.ClassVar[list[str]] = ["productID", "categoryID"]
#     AUTO_ID = False


# class SKUTable(Writer):
#     TABLE = "sku_table"
#     COLUMNS: t.ClassVar[list[str]] = [
#         "productID",
#         "storeID",
#     ]
#     TYPES: t.ClassVar[list[type]] = [int, int]
#     UNIQUE: t.ClassVar[list[str]] = ["productID", "storeID"]
#     AUTO_ID = True


# class DataPoints(Writer):
#     TABLE = "datapoints"
#     COLUMNS: t.ClassVar[list[str]] = ["skuID", "dateID"]
#     TYPES: t.ClassVar[list[type]] = [int, int]
#     UNIQUE: t.ClassVar[list[str]] = ["skuID", "dateID"]
#     AUTO_ID = True


# class Flags(Writer):
#     TABLE = "flags"
#     COLUMNS: t.ClassVar[list[str]] = ["datapointID", "name"]
#     TYPES: t.ClassVar[list[type]] = [int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["datapointID", "name"]


# class TimeSkuFeatures(Writer):
#     TABLE = "time_sku_features"
#     COLUMNS: t.ClassVar[list[str]] = ["datapointID", "featureID", "value"]
#     TYPES: t.ClassVar[list[type]] = [int, int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["datapointID", "featureID"]
#     AUTO_ID = False
...
#     COLUMNS: t.ClassVar[list[str]] = ["name", "description", "var_type", "feature_type", "companyID"]
#     TYPES: t.ClassVar[list[type]] = [str, str, str, str, int]
#     UNIQUE: t.ClassVar[list[str]] = ["name", "companyID"]
#     AUTO_ID = True
...
#     COLUMNS: t.ClassVar[list[str]] = ["featureID", "level", "order"]
#     TYPES: t.ClassVar[list[type]] = [int, str, int]
#     UNIQUE: t.ClassVar[list[str]] = ["featureID", "level"]
#     AUTO_ID = False
...
#     COLUMNS: t.ClassVar[list[str]] = ["storeID", "featureID", "value"]
#     TYPES: t.ClassVar[list[type]] = [int, int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["storeID", "featureID"]
#     AUTO_ID = False


# class ProductFeatures(Writer):
#     TABLE = "product_features"
#     COLUMNS: t.ClassVar[list[str]] = ["productID", "featureID", "value"]
#     TYPES: t.ClassVar[list[type]] = [int, int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["productID", "featureID"]
#     AUTO_ID = False


# class SKUFeatures(Writer):
#     TABLE = "sku_features"
#     COLUMNS: t.ClassVar[list[str]] = ["skuID", "featureID", "value"]
#     TYPES: t.ClassVar[list[type]] = [int, int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["skuID", "featureID"]
#     AUTO_ID = False


# class TimeProductFeatures(Writer):
#     TABLE = "time_product_features"
#     COLUMNS: t.ClassVar[list[str]] = ["dateID", "productID", "featureID", "value"]
#     TYPES: t.ClassVar[list[type]] = [int, int, int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["productID", "dateID", "featureID"]
#     AUTO_ID = False


# class TimeRegionFeatures(Writer):
#     TABLE = "time_region_features"
#     COLUMNS: t.ClassVar[list[str]] = ["regionID", "dateID", "featureID", "value"]
#     TYPES: t.ClassVar[list[type]] = [int, int, int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["regionID", "dateID", "featureID"]
#     AUTO_ID = False


# class TimeStoreFeatures(Writer):
#     TABLE = "time_store_features"
#     COLUMNS: t.ClassVar[list[str]] = ["storeID", "dateID", "featureID", "value"]
#     TYPES: t.ClassVar[list[type]] = [int, int, int, str]
#     UNIQUE: t.ClassVar[list[str]] = ["storeID", "dateID", "featureID"]
#     AUTO_ID = False
...
#     COLUMNS: t.ClassVar[list[str]] = ["name", "description"]
#     TYPES: t.ClassVar[list[type]] = [str, str]
#     UNIQUE: t.ClassVar[list[str]] = ["name"]
#     AUTO_ID = True
...
#     TABLE = "datasets"
#     COLUMNS: t.ClassVar[list[str]] = ["experiment_groupID", "type", "start_date", "end_date", "name", "description"]
#     TYPES: t.ClassVar[list[type]] = [int, str, datetime, datetime, str, str]
#     UNIQUE: t.ClassVar[list[str]] = ["name"]
#     AUTO_ID = True
