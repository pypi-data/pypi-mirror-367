...
def node_write_stores(
    ...
    *,
    ...
    return data_loader.write_stores(store_region_map, company, check_passed=check_passed)
...
def node_write_categories(
    ...
    *,
    ...
    return data_loader.write_categories(company, categories_dict, level_names, check_passed=check_passed)


def node_write_products(
    data_loader: DataLoader,
    products: pl.DataFrame,
    company_object: t.Any,
    *,
    check_passed: bool,
) -> tuple[t.Any, pl.DataFrame]:
    return data_loader.write_products(products, company_object, check_passed=check_passed)


def node_write_product_categories(
    data_loader: DataLoader,
    products: pl.DataFrame,
    unique_products_df: pl.DataFrame,
    company_object: t.Any,
    category_object: t.Any,
    product_object: t.Any,
    *,
    check_passed: bool,
) -> t.Any:
    return data_loader.write_product_categories(
        products, unique_products_df, company_object, category_object, product_object, check_passed=check_passed
    )
...
def node_write_skus(
    ...
    *,
    ...
    return data_loader.write_skus(
        time_sku_data, store_object, product_object, company_object, check_passed=check_passed
    )


def node_write_datapoints(
    data_loader: DataLoader,
    time_sku_data_with_sku_id: pl.DataFrame,
    *,
    check_passed: bool,
) -> t.Any:
    return data_loader.write_datapoints(time_sku_data_with_sku_id, check_passed=check_passed)


def node_write_time_sku_data(
    data_loader: DataLoader,
    time_sku_feature_description_map: pl.DataFrame,
    time_sku_data_with_datapoint_id: pl.DataFrame,
    company_object: t.Any,
    *,
    create_new_time_sku_table: bool,
    check_passed: bool,
) -> t.Any:
    return data_loader.write_time_sku_data(
        time_sku_feature_description_map,
        time_sku_data_with_datapoint_id,
        company_object,
        create_new_time_sku_table,
...
def node_write_flags(
    ...
    *,
    ...
    return data_loader.write_flags(flags, company_object, time_sku_data_with_datapoint_id, check_passed=check_passed)
...
def node_write_store_data(
    ...
    *,
    ...
    return data_loader.write_store_data(
        store_feature_description_map, store_feature_map, store_object, company_object, check_passed=check_passed
    )
...
def node_write_product_data(
    ...
    *,
    ...
    return data_loader.write_product_data(
        product_feature_description_map, product_feature_map, product_object, company_object, check_passed=check_passed
    )
...
def node_write_sku_data(
    ...
    *,
    ...
    return data_loader.write_sku_data(
        sku_feature_description_map, sku_feature_map, sku_object, company_object, check_passed=check_passed
    )
...
def node_write_time_region_data(
    ...
    *,
    ...
    return data_loader.write_time_region_data(
        time_region_feature_description_map, time_region_feature_map, company_object, check_passed=check_passed
    )
