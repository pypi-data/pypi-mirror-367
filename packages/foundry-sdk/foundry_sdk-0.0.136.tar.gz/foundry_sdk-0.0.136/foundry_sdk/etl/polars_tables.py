...
store_region_map_schema = SchemaSpec(
    columns=[
        ...
        ColumnSpec(name="subdivision", types=[pl.Utf8], nullable=False, optional=True, unique=False),
        ColumnSpec(name="city", types=[pl.Utf8], nullable=False, optional=True, unique=False),
        ColumnSpec(name="country", types=[pl.Utf8], nullable=False, unique=False),
    ],
    keys=["store"],
    exclusive_optional_groups=[["subdivision", "city"]],
)
