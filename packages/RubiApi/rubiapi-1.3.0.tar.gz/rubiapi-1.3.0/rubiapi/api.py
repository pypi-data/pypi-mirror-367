...
from .adaptorrubiapi import Client as Client_get
...
def check_rubiapi_version():
    package_name = "rubiapi"
    ...
    if installed_version != latest_version:
        ...
        print(f"To see new methods : @rubiapi_library\n\n")

check_rubiapi_version()
