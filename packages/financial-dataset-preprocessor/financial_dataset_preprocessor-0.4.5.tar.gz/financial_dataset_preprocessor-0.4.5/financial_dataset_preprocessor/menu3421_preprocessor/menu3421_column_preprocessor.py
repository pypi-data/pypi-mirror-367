...
def get_df_preprocessed_column_menu3421(menu3421: DataFrame) -> DataFrame:
    return (
        menu3421
...
def get_preprocessed_column_names_menu3421(menu3421: DataFrame) -> list[str]:
    df = get_df_preprocessed_column_menu3421(menu3421)
