    ...
    def _get_knowledge_base_context(self, query: str, session_id: Optional[str] = None, 
        ...
        try:
            ...
            simple_query_patterns = [
                ...
                'hello', 'hi', 'hey', 'good', 'great', 'nice',
                'can you', 'could you', 'would you', 'please',
                'i think', 'i believe', 'i want', 'i need', 'i like'
            ]
            
            query_lower = query.lower().strip()
            
            # If query is very short or starts with simple patterns, skip knowledge base
            if (len(query_lower.split()) <= 3 or 
                any(query_lower.startswith(pattern) for pattern in simple_query_patterns)):
                return []
