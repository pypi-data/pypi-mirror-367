...
def fair_value(
    ...
    try:
        ...
        console.print(f"\n[green]✓ Fair value analysis complete![/green]")
...
def shares_analysis(
    ...
    try:
        ...
        if result:
            console.print(f"\n[bold green]✓ Shares analysis complete![/bold green]")
            console.print(f"Analysis saved to: ./analysis_output/{ticker.lower()}_shares_analysis.png")
        else:
            console.print(f"[bold red]✗ Failed to analyze shares for {ticker}[/bold red]")
