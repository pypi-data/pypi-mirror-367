...
def show_ai_agent_guide(template_type: str = None) -> None:
    ...
    print("🔧 **Step 6: Convert to JSON Configuration**")
    print("   • Transform XSD structure to JSON format")
    ...
    print("📝 **JSON Configuration Example**")
    print("   {")
    print("     'presentations': [")
    print("       {")
    print("         'id': 'ai_generated',")
    print("         'title': 'AI Generated Presentation',")
    print("         'subtitle': 'Created by AI Agent',")
    print("         'author': 'AI Assistant',")
    print("         'company': 'Tech Company',")
    print("         'date': '2024',")
    ...
    print("           {")
    print("             'id': 'cards',")
    print("             'type': 'card_grid',")
    print("             'content': {")
    print("               'title': 'Featured Items',")
    print("               'cards': [")
    print("                 {")
    print("                   'image_path': 'images/item1.png',")
    print("                   'category': 'FEATURED',")
    print("                   'title': 'Item One',")
    print("                   'description': 'Description of item one',")
    print("                   'rounded_corners': true,")
    print("                   'badge': {")
    print("                     'text': 'NEW',")
    print("                     'color': '#28a745',")
