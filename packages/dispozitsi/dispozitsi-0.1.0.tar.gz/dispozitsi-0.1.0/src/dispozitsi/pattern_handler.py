    ...
    def __check_pattern_and_semantic_validity(self, m, semantics_in_use) -> str:
        try:
            ...
            raise UnknownPatternError(
                known_patterns=self.pattern_file_handler.patterns.keys()
            )
        except re.error:
            pass
