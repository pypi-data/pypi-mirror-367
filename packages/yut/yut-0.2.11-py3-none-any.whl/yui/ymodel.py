...
from . import TranslateDirection, filename_for_save, QueryOp, alignment_flag
from .yfield import FACTORY
from yus import ColumnSpec, to_column_spec
...
class PandasModel(QAbstractTableModel):
    ...
    def __init__(self,
        ...
        super().__init__()
        self._data = data
        self._spec = {get_attr(o, 'name'): to_column_spec(o) for o in spec} if spec else {}
...
class YTreeModel(QAbstractItemModel):
    ...
    def __init__(self,
        ...
        self._data = data
        self._spec = {get_attr(o, 'name'): to_column_spec(o) for o in spec}
        self._field_painters = {name: FACTORY.get_painter(spec) for name, spec in self._spec.items()}
...
def add_qc_value(o, attr, op: QueryOp, value):
    v = (op.value, value)
