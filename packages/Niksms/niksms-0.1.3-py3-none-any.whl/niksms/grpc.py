...
class NiksmsGrpcClient:
    def __init__(self, grpc_url: str, api_key: str):
        ...
        if grpc_url.startswith("localhost") or grpc_url.startswith("127.0.0.1") or grpc_url.startswith("192.168."):
            # Use insecure channel for local/dev environments
            self.channel = grpc.insecure_channel(grpc_url)
        else:
            # Use secure channel for public gRPC endpoints like grpc.niksms.com:443
