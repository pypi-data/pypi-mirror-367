...
- **Session Persistence**: Cart state saved automatically when session ends
...
- Use release_session() when done to free up credentials

**🔄 Session Lifecycle:**
1. initialize_doordash() → get client_id
2. Use client_id for search, cart, order operations  
3. release_session() → save state and free credentials
