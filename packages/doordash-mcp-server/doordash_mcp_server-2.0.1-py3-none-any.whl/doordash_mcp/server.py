...
Args:
    ...
    lat: Optional latitude for manual location (if not provided, uses your address)
    lng: Optional longitude for manual location (if not provided, uses your address)
