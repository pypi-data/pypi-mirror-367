...
Returns:
    ...
    try:
        ...
        # Parse location string into lat/lng if provided, otherwise let backend use automatic address resolution
        lat, lng = None, None
        if location:
            # For now, let the backend handle location parsing
            # The backend already has sophisticated geocoding and address resolution
            pass
