...
3. `release_session()` → Save state when done
...
Releases the session and saves the user's cart and addresses for next time.
...
- Cart contents are still saved (but better to release explicitly)
