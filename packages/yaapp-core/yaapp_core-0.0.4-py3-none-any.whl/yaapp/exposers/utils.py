...
def _reflect_class_methods(cls: type) -> Dict[str, Dict[str, Any]]:
    """
    Reflects on a class and returns metadata for all its public methods.
    ...
    for name in dir(cls):
        ...
        try:
            ...
            if callable(value) and not inspect.isclass(value):
                subcommands[name] = _reflect_function(value)
