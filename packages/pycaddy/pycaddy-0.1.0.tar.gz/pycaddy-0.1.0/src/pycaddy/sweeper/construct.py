...
def construct_split_data(parameters: dict, constants: dict = None,
                         adapter: TypeAdapter = None) -> SplitData:
    ...
    iterable_data, iterable_constants = split_dict_by_adapter(flat_data, IterableAdapter)
