...
class GPT5MiniConfiguration(OpenaiBaseConfiguration):
    ...
    metadata: ModelMetadata = ModelMetadata(
        ...
        pricing=ModelPricing(token_prices=TokenPrices(input_price_per_1k=0.00025, output_price_per_1k=0.002)),
        release_date=datetime(2025, 8, 6),
        data_cutoff_date=datetime(2025, 8, 6),
    )

    integration_aliases: IntegrationAliases | None = IntegrationAliases(
        pydantic_ai="gpt-5-mini",
        litellm="gpt-5-mini",
        langfuse="gpt-5-mini",
    )
