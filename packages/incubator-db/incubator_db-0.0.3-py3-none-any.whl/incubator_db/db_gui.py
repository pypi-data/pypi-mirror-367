...
class GUI:
    def __init__(self, master: str | None = None):
        ...
        """
        self.root = ttk.Toplevel(master) if master else ttk.Window(title="Incubator Data Base", themename="superhero")
        ...
        self.button_slots = ttk.Button(self.root,text="Slots", style="Default.TButton", command=self.callback_slots)
        self.button_plates = ttk.Button(self.root, text="Plates", style="Default.TButton", command = self.callback_plates)
        self.button_plate_actions = ttk.Button(self.root, text="PlateActions", style="Default.TButton", command = self.callback_plate_actions)
