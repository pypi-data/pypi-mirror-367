...
class CreateEmployeeRequestDependents(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, relationship, *args, **kwargs):  # noqa: E501
        """CreateEmployeeRequestDependents - a model defined in OpenAPI
