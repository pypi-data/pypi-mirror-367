...
class CreateEmployeeRequestEmergencyContacts(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'relationship': (str, none_type,),  # noqa: E501
            'mobile_phone_number': (str, none_type,),  # noqa: E501
            'primary_contact': (bool, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'primary_contact': 'primary_contact',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, first_name, last_name, relationship, mobile_phone_number, primary_contact, *args, **kwargs):  # noqa: E501
        """CreateEmployeeRequestEmergencyContacts - a model defined in OpenAPI
