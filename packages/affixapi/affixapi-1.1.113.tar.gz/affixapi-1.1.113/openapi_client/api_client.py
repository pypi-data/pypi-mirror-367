...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.xhr_companies20230301  # this is an instance of the class Endpoint
        api_instance.xhr_companies20230301()  # this invokes api_instance.xhr_companies20230301.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.xhr_companies20230301.callable or self.callable in this class
