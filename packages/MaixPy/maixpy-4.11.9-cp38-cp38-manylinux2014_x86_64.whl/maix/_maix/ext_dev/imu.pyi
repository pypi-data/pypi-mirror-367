...
import typing
__all__ = ['AccOdr', 'AccScale', 'Gcsv', 'GyroOdr', 'GyroScale', 'IMU', 'IMUData', 'IMUInfo', 'Mode', 'get_imu_info']
class AccOdr:
    """
    Members:
...
class IMU:
    ...
    def read_all(self, calib_gryo: bool = True, radian: bool = False) -> IMUData:
        ...
        Unit temperate: degree
        """
    def save_calib_gyro(self, calib: ..., save_id: str = 'default') -> maix._maix.err.Err:
        """
