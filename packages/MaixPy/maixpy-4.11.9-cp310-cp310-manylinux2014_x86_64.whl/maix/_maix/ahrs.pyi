...
import maix._maix
__all__ = ['DEG2RAD', 'MahonyAHRS', 'PI', 'RAD2DEG']
class MahonyAHRS:
    ki: float
    kp: float
    def __init__(self, kp: float, ki: float) -> None:
        ...
    def get_angle(self, acc: maix._maix.Vector3f, gyro: maix._maix.Vector3f, mag: maix._maix.Vector3f, dt: float, radian: bool = False) -> maix._maix.Vector3f:
        """
        Get angle by mahony complementary filter, will automatically call update method,
        and automatically call init in first time.
        
        Args:
          - acc: accelerometer data, unit is g or raw data. maix.Vector3f type.
        ...
        Returns: rotation angle data, maix.Vector3f type.
        """
