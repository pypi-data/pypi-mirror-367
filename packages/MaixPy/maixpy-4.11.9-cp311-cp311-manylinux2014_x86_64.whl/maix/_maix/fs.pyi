...
import typing
__all__ = ['File', 'SEEK', 'abspath', 'basename', 'dirname', 'exists', 'getcwd', 'getsize', 'isabs', 'isdir', 'isfile', 'islink', 'join', 'listdir', 'mkdir', 'open', 'realpath', 'remove', 'rename', 'rmdir', 'splitext', 'symlink', 'sync', 'tempdir']
class File:
