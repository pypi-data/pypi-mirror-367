...
class PP_OCR:
    ...
    def __init__(self, model: str = '') -> None:
        ...
    def detect(self, img: maix._maix.image.Image, thresh: float = 0.3, box_thresh: float = 0.6, fit: maix._maix.image.Fit = ..., char_box: bool = False) -> ...:
        """
        Detect objects from image
    ...
    def load(self, model: str) -> maix._maix.err.Err:
        ...
        Returns: err::Err
        """
    def recognize(self, img: maix._maix.image.Image, box_points: list[int] = []) -> ...:
        """
...
class Whisper:
    ...
    def transcribe(self, file: str) -> str:
        ...
        Args:
          - file: Pass in an audio file, supporting files in WAV format.
