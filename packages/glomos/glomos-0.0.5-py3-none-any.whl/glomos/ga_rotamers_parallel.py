...
from aegon.libcalc_ani import ANI_parallel
...
def conformational(inputfile='INPUT.txt'):
    ...
    xopt=ANI_parallel(xrand, nproc=nof_processes, opt=calculator, preclist=preclist)
    print('')
    ...
    for igen in range(nof_generations):
        ...
        print('Optimization at %s:' %(calculator))
        generation_opt=ANI_parallel(atoms_list_out+atoms_list_mut, nproc=nof_processes, opt=calculator, preclist=preclist)
