...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("SPEAKEASY_USERNAME"):
        security_dict.setdefault("option1", {})["username"] = os.getenv(
            "SPEAKEASY_USERNAME"
        )

    if os.getenv("SPEAKEASY_PASSWORD"):
        security_dict.setdefault("option1", {})["password"] = os.getenv(
            "SPEAKEASY_PASSWORD"
        )
    ...
    if os.getenv("SPEAKEASY_API_KEY"):
        security_dict.setdefault("option2", {})["api_key"] = os.getenv(
            "SPEAKEASY_API_KEY"
        )
    ...
    if os.getenv("SPEAKEASY_API_KEY"):
        security_dict.setdefault("option7", {})["api_key"] = os.getenv(
            "SPEAKEASY_API_KEY"
        )
