...
.. autoclass:: PlotMixin
   ...
   .. autosummary::
      ...
      ~PlotMixin.colormap_xyz
      ~PlotMixin.contour_xyz
      ~PlotMixin.figure
      ~PlotMixin.griddata
      ~PlotMixin.image_plot
      ~PlotMixin.inset
      ~PlotMixin.legend
      ~PlotMixin.plot
      ~PlotMixin.plot_matrix
      ~PlotMixin.plot_voxels
      ~PlotMixin.plot_xy
      ~PlotMixin.plot_xyuv
      ~PlotMixin.plot_xyuvw
      ~PlotMixin.plot_xyz
      ~PlotMixin.plot_xyzuvw
      ~PlotMixin.quiver_plot
      ~PlotMixin.subplot
      ~PlotMixin.subplot2grid
      ~PlotMixin.x2
      ~PlotMixin.y2
