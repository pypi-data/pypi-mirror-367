...
from orders.models.order_tracker_item import OrderTrackerItem
...
class OrderTrackerRequest(object):
    ...
    Attributes:
        ...
        carrier (ShipmentCarrierEnum): The carrier for the shipment. Some
            carriers have a global version as well as local subsidiaries. The
