...
from orders.models.callback_configuration import CallbackConfiguration
...
class PayPalWalletExperienceContext(object):
    ...
    Attributes:
        ...
        shipping_preference (PayPalWalletContextShippingPreferenceEnum): The
            location from which the shipping address is derived.
        return_url (str): Describes the URL.
        cancel_url (str): Describes the URL.
        landing_page (PayPalExperienceLandingPageEnum): The type of landing
            page to show on the PayPal site for customer checkout.
        user_action (PayPalExperienceUserActionEnum): Configures a Continue or
            Pay Now checkout flow.
        payment_method_preference (PayeePaymentMethodPreferenceEnum): The
