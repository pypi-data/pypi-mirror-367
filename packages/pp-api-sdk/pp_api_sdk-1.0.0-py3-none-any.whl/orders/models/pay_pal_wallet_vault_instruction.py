...
class PayPalWalletVaultInstruction(object):
    ...
    Attributes:
        store_in_vault (StoreInVaultInstructionEnum): Defines how and when the
        ...
        usage_type (PayPalPaymentTokenUsageTypeEnum): The usage type
            associated with the PayPal payment token.
        customer_type (PayPalPaymentTokenCustomerTypeEnum): The customer type
