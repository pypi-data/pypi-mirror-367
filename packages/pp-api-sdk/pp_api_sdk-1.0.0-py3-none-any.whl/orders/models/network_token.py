...
class NetworkToken(object):
    ...
    Attributes:
        ...
        eci_flag (ECIFlagEnum): Electronic Commerce Indicator (ECI). The ECI
            value is part of the 2 data elements that indicate the transaction
            was processed electronically. This should be passed on the
