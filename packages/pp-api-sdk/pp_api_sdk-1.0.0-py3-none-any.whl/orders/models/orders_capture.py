...
from orders.models.capture_status_details import CaptureStatusDetails
from orders.models.link_description import LinkDescription
from orders.models.money import Money
from orders.models.network_transaction_reference import NetworkTransactionReference
from orders.models.processor_response import ProcessorResponse
from orders.models.seller_protection import SellerProtection
from orders.models.seller_receivable_breakdown import SellerReceivableBreakdown
...
class OrdersCapture(object):
    ...
    Attributes:
        status (CaptureStatusEnum): The status of the captured payment.
        ...
        disbursement_mode (DisbursementModeEnum): The funds that are held on
