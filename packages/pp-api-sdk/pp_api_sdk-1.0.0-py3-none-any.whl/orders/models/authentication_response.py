...
from orders.models.three_d_secure_authentication_response import ThreeDSecureAuthenticationResponse
...
class AuthenticationResponse(object):
    ...
    Attributes:
        liability_shift (LiabilityShiftIndicatorEnum): Liability shift
            indicator. The outcome of the issuer's authentication.
