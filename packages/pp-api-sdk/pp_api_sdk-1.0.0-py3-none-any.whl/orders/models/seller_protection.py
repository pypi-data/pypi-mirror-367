...
class SellerProtection(object):
    ...
    Attributes:
        status (SellerProtectionStatusEnum): Indicates whether the transaction
            is eligible for seller protection. For information, see [PayPal
            Seller Protection for
            Merchants](https://www.paypal.com/us/webapps/mpp/security/seller-pr
            otection).
        dispute_categories (List[DisputeCategoryEnum]): An array of conditions
