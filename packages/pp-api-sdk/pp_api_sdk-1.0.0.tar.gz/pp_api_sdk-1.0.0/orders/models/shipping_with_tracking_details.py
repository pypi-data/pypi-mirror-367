...
from orders.models.order_tracker_response import OrderTrackerResponse
from orders.models.phone_number_with_country_code import PhoneNumberWithCountryCode
from orders.models.shipping_name import ShippingName
from orders.models.shipping_option import ShippingOption
...
class ShippingWithTrackingDetails(object):
    ...
    Attributes:
        ...
        mtype (FulfillmentTypeEnum): A classification for the method of
            purchase fulfillment (e.g shipping, in-store pickup, etc). Either
