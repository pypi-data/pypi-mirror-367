...
from orders.models.order_authorize_response_payment_source import OrderAuthorizeResponsePaymentSource
from orders.models.payer import Payer
from orders.models.purchase_unit import PurchaseUnit
...
class OrderAuthorizeResponse(object):
    ...
    Attributes:
        ...
        intent (CheckoutPaymentIntentEnum): The intent to either capture
            payment immediately or authorize a payment for an order after
            order creation.
        ...
        status (OrderStatusEnum): The order status.
