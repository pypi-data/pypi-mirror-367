...
class VenmoWalletVaultAttributes(object):
    ...
    Attributes:
        ...
        usage_pattern (VenmoPaymentTokenUsagePatternEnum): Expected
            business/pricing model for the billing agreement.
        usage_type (VenmoPaymentTokenUsageTypeEnum): The usage type associated
            with the Venmo payment token.
        customer_type (VenmoPaymentTokenCustomerTypeEnum): The customer type
