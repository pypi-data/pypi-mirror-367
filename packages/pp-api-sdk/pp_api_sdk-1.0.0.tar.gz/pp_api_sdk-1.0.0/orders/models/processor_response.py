...
class ProcessorResponse(object):
    ...
    Attributes:
        avs_code (AVSCodeEnum): The address verification code for Visa,
            Discover, Mastercard, or American Express transactions.
        cvv_code (CVVCodeEnum): The card verification value code for for Visa,
            Discover, Mastercard, or American Express.
        response_code (ProcessorResponseCodeEnum): Processor response code for
            the non-PayPal payment processor errors.
        payment_advice_code (PaymentAdviceCodeEnum): The declined payment
