...
from orders.models.name import Name
from orders.models.pay_pal_wallet_attributes_response import PayPalWalletAttributesResponse
from orders.models.pay_pal_wallet_stored_credential import PayPalWalletStoredCredential
from orders.models.phone_number import PhoneNumber
from orders.models.tax_info import TaxInfo
...
class PayPalWalletResponse(object):
    ...
    Attributes:
        ...
        account_status (PayPalWalletAccountVerificationStatusEnum): The
            account status indicates whether the buyer has verified the
            financial details associated with their PayPal account.
        name (Name): The name of the party.
        phone_type (PhoneTypeEnum): The phone type.
