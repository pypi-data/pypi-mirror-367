...
class CardStoredCredential(object):
    ...
    Attributes:
        payment_initiator (PaymentInitiatorEnum): The person or party who
            initiated or triggered the payment.
        payment_type (StoredPaymentSourcePaymentTypeEnum): Indicates the type
            of the stored payment_source payment.
        usage (StoredPaymentSourceUsageTypeEnum): Indicates if this is a
            `first` or `subsequent` payment using a stored payment source
