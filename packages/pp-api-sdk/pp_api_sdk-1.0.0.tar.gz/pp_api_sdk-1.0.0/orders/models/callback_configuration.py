...
class CallbackConfiguration(object):
    ...
    Attributes:
        callback_events (List[CallbackEventsEnum]): An array of callback
            events merchant can subscribe to for the corresponding callback
            url. The SHIPPING_ADDRESS callback event is required.
