...
def get_country_match_df():
    df_country = pd.read_excel(r'Data input/input_files/regionalization_setup/Country.xlsx', engine='openpyxl', sheet_name='Sheet1')
...
def get_lca_db_locations():
    df_loc = pd.read_csv(r'Data input/input_files/regionalization_setup/Locations_in_lca_db_new.csv', encoding="latin1",sep=";")
