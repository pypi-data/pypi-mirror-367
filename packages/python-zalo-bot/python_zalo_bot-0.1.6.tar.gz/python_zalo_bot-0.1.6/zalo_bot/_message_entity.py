"""This module contains an object that represents a Zalo Bot MessageEntity."""
...
class MessageEntity(ZaloObject):
    """
    ...
    Args:
        type (:obj:`str`): Type of the entity. Can be :attr:`MENTION` (@username),
            ...
            (/start@jobs_bot), :attr:`URL`
            :attr:`EMAIL` (test_email@gmail.com), :attr:`PHONE_NUMBER` (0909090909),
        ...
        user (:class:`zalo_bot.User`, optional): For :attr:`TEXT_MENTION` only, the mentioned
             user.
        ...
        custom_emoji_id (:obj:`str`, optional): For :attr:`CUSTOM_EMOJI` only, unique identifier
            of the custom emoji. Use :meth:`zalo_bot.Bot.get_custom_emoji_stickers` to get full
    ...
    Attributes:
        type (:obj:`str`): Type of the entity. Can be :attr:`MENTION` (@username),
            :attr:`HASHTAG` (#hashtag), :attr:`CASHTAG` ($USD), :attr:`BOT_COMMAND`
            (/start@jobs_bot), :attr:`URL` (https://zalo_bot.org),
            :attr:`EMAIL` (do-not-reply@zalo_bot.org), :attr:`PHONE_NUMBER` (+1-212-555-0123),
            :attr:`BOLD` (**bold text**), :attr:`ITALIC` (*italic text*), :attr:`UNDERLINE`
            (underlined text), :attr:`STRIKETHROUGH`, :attr:`SPOILER` (spoiler message),
            :attr:`BLOCKQUOTE` (block quotation), :attr:`CODE` (monowidth string), :attr:`PRE`
            (monowidth block), :attr:`TEXT_LINK` (for clickable text URLs), :attr:`TEXT_MENTION`
    ...
    def adjust_message_entities_to_utf_16(text: str, entities: _SEM) -> _SEM:
        ...
        Tip:
            Only the offsets and lengths calulated in UTF-16 is acceptable by the Zalo Bot API.
        ...
        Args:
            ...
            entities (Sequence[:class:`zalo_bot.MessageEntity`]): Sequence of entities
                with offset and length calculated in Unicode

        Returns:
            Sequence[:class:`zalo_bot.MessageEntity`]: Sequence of entities
    ...
    def shift_entities(by: Union[str, int], entities: _SEM) -> _SEM:
        ...
        Returns:
            Sequence[:class:`zalo_bot.MessageEntity`]: Sequence of entities with the offset shifted
        """
    ...
    def concatenate(
        ...
        *args: Union[Tuple[str, _SEM], Tuple[str, _SEM, bool]],
        ...
        Examples:
            ...
            the message in a :class:`~zalo_bot.ext.CallbackQueryHandler`:
        ...
        Args:
            *args (Tuple[:obj:`str`, Sequence[:class:`zalo_bot.MessageEntity`]] | \
                Tuple[:obj:`str`, Sequence[:class:`zalo_bot.MessageEntity`], :obj:`bool`]):
        ...
        Returns:
            Tuple[:obj:`str`, Sequence[:class:`zalo_bot.MessageEntity`]]: The concatenated text
            and its entities
        """
        output_text = ""
