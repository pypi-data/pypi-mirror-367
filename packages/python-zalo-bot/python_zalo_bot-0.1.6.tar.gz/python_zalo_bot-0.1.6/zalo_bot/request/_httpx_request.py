...
from zalo_bot._utils.types import HTTPVersion, ODVInput, SocketOpt
from zalo_bot._utils.warnings import warn
from zalo_bot.error import NetworkError, TimedOut
...
class HTTPXRequest(BaseRequest):
    """Implementation of :class:`~zalo_bot.request.BaseRequest` using the library
    ...
    Args:
        ...
        read_timeout (:obj:`float` | :obj:`None`, optional): If passed, specifies the maximum
            amount of time (in seconds) to wait for a response from Zalo Bot's server.
        ...
        pool_timeout (:obj:`float` | :obj:`None`, optional): If passed, specifies the maximum
            ...
            Warning:
                With a finite pool timeout, you must expect :exc:`zalo_bot.error.TimedOut`
        ...
        proxy (:obj:`str` | ``httpx.Proxy`` | ``httpx.URL``, optional): The URL to a proxy server,
            ...
            Note:
                ...
                * For Socks5 support, additional dependencies are required. Make sure to install
                  PTB via :command:`pip install "zalo-bot[socks]"` in this case.
        ...
        httpx_kwargs (Dict[:obj:`str`, Any], optional): Additional keyword arguments to be passed
            ...
            Warning:
                ...
                defaults set by ``zalo-bot`` and all other parameters passed to
    ...
    def __init__(
        ...
        pool_timeout: Optional[float] = 5.0,
            ...
            if isinstance(err, httpx.PoolTimeout):
                raise TimedOut(
                    message=(
                        ...
                        "Request was *not* sent to Zalo Bot. Consider adjusting the connection "
