"""This module contains an object that represents a Zalo Bot File."""
import shutil
...
from zalo_bot._utils.files import is_local_file
from zalo_bot._utils.types import FilePathInput, JSONDict, ODVInput

if TYPE_CHECKING:
    from zalo_bot import FileCredentials


class File(ZaloObject):
    """
    ...
    When the link expires, a new one can be requested by calling :meth:`zalo_bot.Bot.get_file`.
    ...
    Note:
        * Maximum file size to download is
          :tg-const:`zalo_bot.constants.FileSizeLimit.FILESIZE_DOWNLOAD`.
        * If you obtain an instance of this class from :attr:`zalo_bot.PassportFile.get_file`,
        ...
        *,
        ...
        Keyword Args:
            read_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to
                :paramref:`zalo_bot.request.BaseRequest.post.read_timeout`. Defaults to
                :attr:`~zalo_bot.request.BaseRequest.DEFAULT_NONE`.
            write_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to
                :paramref:`zalo_bot.request.BaseRequest.post.write_timeout`. Defaults to
                :attr:`~zalo_bot.request.BaseRequest.DEFAULT_NONE`.
            connect_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to
                :paramref:`zalo_bot.request.BaseRequest.post.connect_timeout`. Defaults to
                :attr:`~zalo_bot.request.BaseRequest.DEFAULT_NONE`.
            pool_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to
                :paramref:`zalo_bot.request.BaseRequest.post.pool_timeout`. Defaults to
                :attr:`~zalo_bot.request.BaseRequest.DEFAULT_NONE`.
    ...
    def set_credentials(self, credentials: "FileCredentials") -> None:
        ...
        Args:
            credentials (:class:`zalo_bot.FileCredentials`): The credentials.
        """
