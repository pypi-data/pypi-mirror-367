...
async def load_product_series_map():
    ...
    await load_map("/options/productseries/", product_series_map, "product series")
...
async def load_media_map():
    global media_map
    await load_map("/options/media/", media_map, "media")
...
async def handle_call_tool(name: str, arguments: dict | None):
    ...
    if name == "get-user":
        ...
        if arguments is not None:
            ...
            if "product_series" in search:
                search["product_series"] = [normalize_product_series(x) for x in search["product_series"]]
