...
class Grok_2_Vision(BaseAPIModel):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.api_key = api_key or config.grok_2_vision_api_key
        self.base_url = base_url or config.grok_2_vision_base_url
        self.model_name = model_name or config.grok_2_vision_model_name

        # Validate that we have required configuration
        if not self.api_key:
            raise ValueError(
                "Grok-2-Vision API key not found. Please set GROK_2_VISION_API_KEY in your .env file "
    ...
    def generate(
        ...
        try:
            ...
            raise RuntimeError(f"Grok-2-Vision API call failed: {e}")
