...
class RuleManager:
    ...
    def set_batch_id(self, rule: Dict[str, Any]) -> Dict[str, Any]:
        self.init_other_variables()
        hash_string = f"{rule['TEAM_NAME']}{rule['DOMAIN_NAME']}{rule['RULE_CATEGORY_NAME']}"
        batch_id = self.run_exe(hash_string)
