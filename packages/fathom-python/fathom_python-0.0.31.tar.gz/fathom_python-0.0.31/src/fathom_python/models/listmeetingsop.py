...
class ListMeetingsMeetingType(str, Enum):
...
class ListMeetingsRequestTypedDict(TypedDict):
    ...
    meeting_type: NotRequired[ListMeetingsMeetingType]
    r"""Filter by meeting type."""
    recorded_by: NotRequired[List[str]]
    r"""Email addresses of meeting owners.
...
class ListMeetingsRequest(BaseModel):
    ...
    meeting_type: Annotated[
        Optional[ListMeetingsMeetingType],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = ListMeetingsMeetingType.ALL
    r"""Filter by meeting type."""
