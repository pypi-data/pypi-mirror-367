    ...
    def _clean_actions(self, actions: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for action_name, action_config in actions.items():
            ...
            if action_config.get('actionId') in no_duration_actions:
                if 'parameters' in cleaned_config and 'duration' in cleaned_config['parameters']:
                    logger.warning(f"Removing unsupported 'duration' parameter from action {action_config.get('actionId')}")
