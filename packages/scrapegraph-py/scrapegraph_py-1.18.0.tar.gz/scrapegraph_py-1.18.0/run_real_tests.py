...
def main():
    parser = argparse.ArgumentParser(description="Run ScrapeGraph Python SDK real API tests")
    parser.add_argument("--api-key", help="API key to use for testing")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    parser.add_argument("--test-file", default="tests/test_real_apis.py", help="Test file to run")
    ...
    if args.api_key:
        ...
        print("❌ No API key provided. Set SGAI_API_KEY environment variable or use --api-key")
