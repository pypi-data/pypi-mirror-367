...
def poll_for_result(client: Client, crawl_id: str, max_attempts: int = 20) -> Dict[str, Any]:
    """
...
def main():
    ...
    if not api_key:
        ...
        print("   Option 2: Set environment variable: export SGAI_API_KEY=your_api_key_here")
        print()
