...
from zone.IDL.thrift.CanParserNode import CanDbInfo
from zone.IDL.thrift.CanStackNode.ttypes import *
from zone.IDL.thrift.CommonNode import Result, Version
...
class App(metaclass=SingletonMeta):
    ...
    def getVersion(self) -> Version:
        ...
        :return: 版本信息
        :rtype: :class:`~zone.IDL.thrift.CommonNode.Version`
        """
    ...
    def setCanChannelConfig(self, req: List[CanChannelConfig]) -> Result:
        """
        设置CAN通道的配置

        :param req: CAN通道配置的列表
        :type req: List[CanChannelConfig]
    ...
    def getCanDbPath(self) -> dbPath:
        ...
        :return: 路径类型
        :rtype: :class:`~zone.IDL.thrift.CanParserNode.ttypes.dbPath`
        """
    ...
    def getCanDbInfo(self) -> CanDbInfo:
        ...
        :return: 数据库信息
        :rtype: :class:`~zone.IDL.thrift.CanParserNode.CanDbInfo`
        """
