...
class TestMetadataInferenceEngine:
    ...
    def setup_method(self):
        ...
        self.comprehensive_data = pd.DataFrame({
            ...
            'timestamp': pd.to_datetime(['2024-01-01 10:00', '2024-01-02 11:00', '2024-01-03 12:00', '2024-01-04 13:00', '2024-01-05 14:00']),
            'age': [25, 30, 35, 40, 45],
    ...
    def test_infer_column_metadata_datetime(self):
        ...
        df = pd.DataFrame({'date_col': pd.to_datetime(['2024-01-01', '2024-01-02', '2024-01-03'])})
    ...
    def test_infer_dependent_column_none(self):
        ...
        df = pd.DataFrame({
            'x': [1, 2, 3, 4, 5],
            'y': [10, 25, 30, 15, 40]  # Random, low correlation
        })
    ...
    def test_infer_group_by_name_based(self):
        ...
        group_by = self.engine._infer_group_by('customer_segment', 'categorical', series)
...
class TestEdgeCases:
    ...
    def test_unicode_data(self):
        ...
        assert metadata_list[0].data_type in ['string', 'categorical']  # Could be either
    ...
    def test_inference_with_warnings(self, mock_logger):
        ...
        data = pd.DataFrame({
            'problematic_col': ['valid', None, '', 'another']
        })
        
        self.engine.infer_dataframe_metadata(data, warn_user=True)
        
        # Should have generated some log messages
        assert mock_logger.warning.called or mock_logger.info.called or mock_logger.debug.called
