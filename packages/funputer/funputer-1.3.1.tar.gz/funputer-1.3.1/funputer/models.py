...
class ColumnMetadata:
    ...
    allowed_values: Optional[str] = None  # JSON string or comma-separated values for categorical validation
    ...
    meaning_of_missing: Optional[str] = None  # Business context: "refused", "not_applicable", etc.
    ...
    fallback_method: Optional[str] = None  # Guaranteed imputation method: "mean", "median", "mode"
...
class AnalysisConfig(BaseModel):
    ...
    outlier_threshold: float = Field(default=0.05, ge=0.001, le=0.5, alias='outlier_percentage_threshold')
    ...
    missing_threshold: float = Field(default=0.8, ge=0.1, le=0.95, alias='missing_percentage_threshold')
