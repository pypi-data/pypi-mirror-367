...
from funputer.models import (
    ...
    ImputationMethod, MissingnessType, DataType
)
...
class TestBasicCoverage:
    ...
    def test_metadata_inference_basic(self):
        ...
        try:
            ...
            result = funputer.metadata_inference.infer_column_metadata('numeric', data['numeric'])
    ...
    def test_adaptive_thresholds_basic(self):
        ...
        try:
            ...
            result = funputer.adaptive_thresholds.get_adaptive_threshold(data, 'outlier')
            assert isinstance(result, (int, float))
