...
from funimpute.exceptions import (
    ConfigurationError, MetadataValidationError, ImputationException,
    check_skip_column, check_metadata_validation_failure, check_no_missing_values,
    check_unique_identifier, check_all_values_missing, check_mnar_without_business_rule,
    check_nullable_violation, check_allowed_values_violation, check_max_length_violation,
    apply_exception_handling, should_skip_column
)
from funimpute.models import (
    ColumnMetadata, AnalysisConfig, ImputationMethod, MissingnessAnalysis,
    MissingnessMechanism, OutlierAnalysis, OutlierHandling
)
...
class TestImputationException:
    ...
    def test_imputation_exception_creation_default_confidence(self):
        ...
        exception = ImputationException(
            ...
            rationale="Test with default confidence"
        )
...
class TestMetadataValidationFailure:
    ...
    def test_invalid_min_max_constraints(self):
        ...
        metadata = ColumnMetadata('col1', 'integer', min_value=10, max_value=5)  # min > max
        data_series = pd.Series([1, 2, 3])
...
class TestNoMissingValues:
    ...
    def test_no_missing_values_detected(self):
        ...
        missingness_analysis = create_missingness_analysis(0, 0.0, MissingnessMechanism.MCAR)
    ...
    def test_missing_values_present(self):
        ...
        missingness_analysis = create_missingness_analysis(5, 0.25, MissingnessMechanism.MCAR)
...
class TestUniqueIdentifier:
    ...
    def test_unique_identifier_none(self):
        ...
        metadata = ColumnMetadata('age', 'integer')  # unique_flag defaults to None/False
...
class TestAllValuesMissing:
    ...
    def test_all_values_missing(self):
        ...
        missingness_analysis = create_missingness_analysis(4, 1.0, MissingnessMechanism.UNKNOWN)
    ...
    def test_partial_values_missing(self):
        ...
        missingness_analysis = create_missingness_analysis(2, 0.5, MissingnessMechanism.MCAR)
...
class TestMNARWithoutBusinessRule:
    ...
    def test_mnar_without_business_rule(self):
        ...
        missingness_analysis = create_missingness_analysis(5, 0.3, MissingnessMechanism.MNAR)
    ...
    def test_unknown_without_business_rule(self):
        ...
        missingness_analysis = create_missingness_analysis(3, 0.2, MissingnessMechanism.UNKNOWN)
    ...
    def test_other_mechanisms(self):
        ...
        missingness_analysis = create_missingness_analysis(3, 0.2, MissingnessMechanism.MCAR)
        metadata = ColumnMetadata('col1', 'integer')
...
class TestNullableViolation:
    ...
    def test_nullable_false_with_missing_values(self):
        ...
        missingness_analysis = create_missingness_analysis(3, 0.3, MissingnessMechanism.MCAR)
...
class TestAllowedValuesViolation:
    ...
    def test_allowed_values_whitespace_handling(self):
        ...
        data_series = pd.Series(['A', 'B', 'C'])
        metadata = ColumnMetadata('col1', 'string', allowed_values='A, B , C,')  # Extra spaces
...
class TestMaxLengthViolation:
    ...
    def test_max_length_violation(self):
        ...
        data_series = pd.Series(['short', 'this_is_too_long', 'ok'])  # 'this_is_too_long' = 16 chars
        ...
        assert result is not None
        assert result.method == ImputationMethod.ERROR_INVALID_METADATA
        assert "max_length=10 but contains values up to 16 characters" in result.rationale
        assert result.confidence == 0.0
    ...
    def test_max_length_non_string_type(self):
        ...
        metadata = ColumnMetadata('col1', 'integer', max_length=3)  # Should not apply to integers
...
class TestApplyExceptionHandling:
    ...
    def test_apply_exception_handling_priority_order(self):
        ...
        missingness_analysis = create_missingness_analysis(3, 1.0, MissingnessMechanism.UNKNOWN)
        ...
        result = apply_exception_handling(
            'col1', data_series, metadata, missingness_analysis, outlier_analysis, config
        )
    ...
    def test_apply_exception_handling_skip_column(self):
        ...
        missingness_analysis = create_missingness_analysis(1, 0.33, MissingnessMechanism.MCAR)
        outlier_analysis = OutlierAnalysis(
            outlier_count=0,
            outlier_percentage=0.0,
            handling_strategy=OutlierHandling.LEAVE_AS_IS,
        ...
        result = apply_exception_handling(
            'skip_me', data_series, metadata, missingness_analysis, outlier_analysis, config
        )
    ...
    def test_apply_exception_handling_no_exceptions(self):
        ...
        missingness_analysis = create_missingness_analysis(1, 0.2, MissingnessMechanism.MCAR)
        outlier_analysis = OutlierAnalysis(
            outlier_count=0,
            outlier_percentage=0.0,
            handling_strategy=OutlierHandling.LEAVE_AS_IS,
        ...
        result = apply_exception_handling(
            'normal_col', data_series, metadata, missingness_analysis, outlier_analysis, config
        )
