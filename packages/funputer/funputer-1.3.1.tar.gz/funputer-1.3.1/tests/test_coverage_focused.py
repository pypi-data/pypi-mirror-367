...
class TestMetadataInferenceWorking:
    ...
    def test_infer_metadata_data_types(self):
        ...
        assert metadata_dict['string_col'].data_type == 'string'
    ...
    def test_infer_metadata_with_nulls(self):
        ...
        # Both should be nullable=True (default behavior)
        assert metadata_dict['col_with_nulls'].nullable == True
        assert metadata_dict['col_without_nulls'].nullable == True
    ...
    def test_infer_metadata_unique_detection(self):
        ...
        assert metadata_dict['unique_col'].unique_flag == True
        assert metadata_dict['non_unique_col'].unique_flag == False
    ...
    def test_infer_metadata_role_detection(self):
        ...
        df = pd.DataFrame({
            ...
            'created_timestamp': pd.to_datetime(['2024-01-01', '2024-01-02', '2024-01-03']),  # Should be time_index
    ...
    def test_infer_metadata_do_not_impute_logic(self):
        ...
        df = pd.DataFrame({
            'user_id': ['USER001', 'USER002', 'USER003'],  # Identifier - should not impute
    ...
    def test_infer_metadata_group_by_flag(self):
        ...
        df = pd.DataFrame({
            ...
            'user_type': ['premium', 'basic', 'premium', 'basic', 'premium'],  # Should be group_by
...
class TestEdgeCasesWorking:
    ...
    def test_mixed_data_types(self):
        ...
        assert metadata_dict['float_col'].data_type == 'float'
        assert metadata_dict['str_col'].data_type == 'string'
        assert metadata_dict['bool_col'].data_type == 'boolean'
        # Mixed column should default to string/object
        assert metadata_dict['mixed_col'].data_type in ['string', 'object']
