...
category,categorical,,,10,FALSE,,,,"User category" """
    ...
    def test_cli_missing_required_args(self):
        ...
        result = self.runner.invoke(cli, ['analyze', '-d', 'data.csv'])
        assert result.exit_code != 0
...
id,integer"""
    ...
    def test_cli_short_and_long_options(self):
        ...
        try:
            with self.runner.isolated_filesystem():
                # Test short options
                result_short = self.runner.invoke(cli, [
                    'analyze',
                    '-m', metadata_path,
                    '-d', data_path,
                    '-o', 'short_output.csv',
                ...
                # Test long options
                result_long = self.runner.invoke(cli, [
                    'analyze',
    ...
    def test_cli_examples_in_help(self):
        ...
        assert 'funimputer analyze -m' in result.output
