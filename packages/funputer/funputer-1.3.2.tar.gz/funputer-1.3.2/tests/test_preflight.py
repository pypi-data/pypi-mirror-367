...
class TestPreflightBasics:
    ...
    def test_read_sample_csv_with_bad_lines(self):
        ...
        result = _read_sample(filepath, "csv", "none", "utf-8", {"delimiter": ",", "has_header": True}, 100)
    ...
    def test_collect_sample_warnings_mixed_types(self):
        ...
        columns_info = [{"name": "mixed_col", "inferred_type": "string", "missing_pct_sample": 0.2}]
    ...
    def test_decide_recommendation_structure_issues(self):
        ...
        structure_info = {"num_columns": 3, "column_names": ["", "col2", "col3"], "issues": ["blank_names: columns [0]"]}
        columns_info = [{"name": "col1", "inferred_type": "integer", "missing_pct_sample": 0.0}]
        csv_dialect = {"delimiter": ",", "has_header": True}
        
        recommendation, hints = _decide_recommendation(structure_info, columns_info, csv_dialect)
    ...
    def test_decide_recommendation_no_header(self):
        ...
        structure_info = {"num_columns": 3, "column_names": ["col1", "col2", "col3"], "issues": []}
        columns_info = [{"name": "col1", "inferred_type": "integer", "missing_pct_sample": 0.0}]
    ...
    def test_decide_recommendation_ambiguous_types(self):
        ...
        structure_info = {"num_columns": 4, "column_names": ["col1", "col2", "col3", "col4"], "issues": []}
        columns_info = [
    ...
    def test_decide_recommendation_high_missing_data(self):
        ...
        structure_info = {"num_columns": 2, "column_names": ["col1", "col2"], "issues": []}
        columns_info = [
    ...
    def test_format_preflight_report_with_warnings(self):
        ...
        report = {
            ...
            "file": {"path": "/test/file.csv", "size_bytes": 1024, "format": "csv", "compression": "none"},
    ...
    def test_format_preflight_report_with_compression(self):
        ...
        report = {
            "status": "ok",
            "file": {"path": "/test/file.csv.gz", "size_bytes": 1024, "format": "csv", "compression": "gz"},
    ...
    def test_preflight_with_json_output(self):
        ...
        result = self.runner.invoke(cli, ["preflight", "-d", filepath, "--json-out", json_output])
    ...
    def test_exception_handling_in_run_preflight(self):
        ...
        with patch("funimpute.preflight._read_sample", side_effect=pd.errors.EmptyDataError("No data")):
            content = "name,age\nAlice,25"
            filepath = self.create_test_csv(content)
    ...
    def test_exception_handling_parser_error(self):
        ...
        with patch("funimpute.preflight._read_sample", side_effect=pd.errors.ParserError("Parse failed")):
            content = "name,age\nAlice,25"
            filepath = self.create_test_csv(content)
    ...
    def test_preflight_with_custom_sample_size(self):
        ...
        result = self.runner.invoke(cli, ["preflight", "-d", filepath, "--sample-rows", "100"])
    ...
    def test_preflight_with_encoding_hint(self):
        ...
        result = self.runner.invoke(cli, ["preflight", "-d", filepath, "--encoding", "utf-8"])
