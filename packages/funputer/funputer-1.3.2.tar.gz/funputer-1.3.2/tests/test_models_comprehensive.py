...
from funputer.models import (
    DataType, MissingnessType, ImputationMethod, OutlierHandling,
    ExceptionRule, ColumnMetadata, AnalysisConfig, OutlierAnalysis,
    MissingnessAnalysis, ImputationProposal, ColumnAnalysis,
    ImputationSuggestion, DataQualityMetrics, MissingnessMechanism
)
...
class TestEnums:
    ...
    def test_imputation_method_enum(self):
        ...
        assert ImputationMethod.ERROR_INVALID_METADATA.value == "Error: Invalid metadata"
    ...
    def test_exception_rule_enum(self):
        ...
        assert ExceptionRule.METADATA_VALIDATION_FAILURE.value == "metadata_validation_failure"
...
class TestAnalysisConfig:
    ...
    def test_analysis_config_alias_fields(self):
        ...
        config = AnalysisConfig(
            ...
            missing_percentage_threshold=0.7
        )
...
class TestModelIntegration:
    ...
    def test_nested_model_structure(self):
        ...
        assert full_analysis.outlier_analysis.handling_strategy == OutlierHandling.LEAVE_AS_IS
