...
```
pip install breeze-connect==1.0.14rc58
```
<hr>
...
<p><ol><li>Order Type should be either "limit" or "market". </li>
       <li>The validity_date parameter has no impact on the order execution and if you include it while placing the order, it will be excluded from order processing.</li></ol></p>
<a href="#index">Back to Index</a>
...
<h4> NOTE: </h4>
<p><ol><li>The validity_date parameter has no impact on the order modification and if you include it while modifying the order, it will be excluded from order processing.</li></ol></p>
...
<h4> NOTE: </h4>
<p><ol><li>The validity_date parameter has no impact on square off and if you include it while squaring off, it will be excluded from order processing.</li></ol></p>
