...
def test_function_builder(simple_design):
    ...
    builder.build(hfss=simple_design, parameters={'name_value_dict': {VARIABLE_TO_CHANGE: '5mm'}})
...
def test_module_builder_success(simple_design, fake_build_module):
    ...
    builder.build(simple_design, parameters={'name_to_value': {VARIABLE_TO_CHANGE: '4mm'}})
