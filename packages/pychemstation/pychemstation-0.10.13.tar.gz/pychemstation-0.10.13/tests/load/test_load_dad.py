...
class TestDAD(unittest.TestCase):
    ...
    def test_load_all_wavelengthes(self):
        channels = self.hplc_controller.method_controller.dad.load_wavelengths()
        self.assertEqual(channels.A, 210)
        self.assertTrue(channels.A_ON)
        self.assertTrue(channels.E_ON)
        print(channels)
