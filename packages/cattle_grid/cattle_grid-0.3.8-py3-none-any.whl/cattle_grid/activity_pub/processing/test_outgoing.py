...
async def test_outgoing_message_follower(broker, mock_subscriber, actor_for_test):
...
async def test_outgoing_follow_request(broker, mock_subscriber, actor_for_test):
    ...
    await actor_for_test.fetch_related("following")
...
async def test_outgoing_accept_request(broker, mock_subscriber, actor_for_test):
    ...
    await actor_for_test.fetch_related("followers")
...
async def test_outgoing_no_message_for_public(actor_for_test):
    activity_factory, _ = factories_for_actor_object(actor_to_object(actor_for_test))
...
async def test_outgoing_reject(actor_for_test):
    activity_factory, _ = factories_for_actor_object(actor_to_object(actor_for_test))
...
async def test_outgoing_block(actor_for_test):
    activity_factory, _ = factories_for_actor_object(actor_to_object(actor_for_test))
...
async def test_outgoing_block_then_undo(actor_for_test):
    activity_factory, _ = factories_for_actor_object(actor_to_object(actor_for_test))
