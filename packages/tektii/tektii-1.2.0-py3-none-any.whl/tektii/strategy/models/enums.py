...
class TimeInForce(ProtoEnum):
    ...
    @classmethod
    def _aliases(cls) -> Dict[str, "TimeInForce"]:
        """Return string aliases for TimeInForce values.

        Returns:
            Dictionary mapping aliases to enum values
        """
        return {
            "GTD": cls.GTC,  # Map GTD to GTC as a reasonable default
        }
