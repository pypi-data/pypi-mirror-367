...
class VoiceControlledJarvis:
    ...
    def extract_city_from_weather_command(self, command):
        ...
        patterns = [
            ...
            r'weather.*?(\w+)(?!.*(?:in|for|of|at))',              # "weather [city]" without prepositions
        ]
        ...
        for pattern in patterns:
            ...
            if match:
                ...
                print(f"🏙️ Extracted city from '{command}': {city}")
                return city
        
        print(f"🏙️ No city found in '{command}', using default: New York")
        return "New York"
